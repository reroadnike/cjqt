...
class tb_serviceprojectallocationModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_serviceprojectallocation";

    public $table_column_all = "ID,serviceTypeId,roleGroup,type,projectId,status,orderNo,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['serviceTypeId'] = '';// 服务ID | YES | int(11) | 
    $insert_data['roleGroup'] = '';// 用户权限集合(已认证,未认证,企业运营者) | YES | varchar(40) | 
    $insert_data['type'] = '';// 类型（0-项目，1-企业） | YES | varchar(10) | 
    $insert_data['projectId'] = '';// 类型为0代表项目ID,类型为1代表企业ID | YES | int(11) | 
    $insert_data['status'] = '';// 状态（0-下线，1-上线） | YES | varchar(40) | 
    $insert_data['orderNo'] = '';// 序号 | YES | varchar(10) | 
