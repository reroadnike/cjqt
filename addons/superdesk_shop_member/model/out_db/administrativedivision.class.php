...
class administrativedivisionModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "administrativedivision";

    public $table_column_all = "id,code,name,parent_code,state";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['code'] = '';//  | YES | varchar(255) | 
    $insert_data['name'] = '';//  | YES | varchar(255) | 
    $insert_data['parent_code'] = '';//  | YES | varchar(255) | 
    $insert_data['state'] = '0';// 0:是1:否 | YES | int(11) | 0
