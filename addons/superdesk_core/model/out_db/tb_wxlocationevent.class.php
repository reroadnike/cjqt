...
class tb_wxlocationeventModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxlocationevent";

    public $table_column_all = "ID,developId,openId,eventType,createTime,latitude,longitude,precision";
    ...
    $insert_data['eventType'] = '';// 事件类型 | YES | char(1) | 
    $insert_data['createTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['latitude'] = '';// 纬度 | YES | varchar(45) | 
    $insert_data['longitude'] = '';// 经度 | YES | varchar(45) | 
    $insert_data['precision'] = '';// 精度 | YES | varchar(45) | 
