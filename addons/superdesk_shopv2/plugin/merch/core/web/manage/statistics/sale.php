...
class Sale_SuperdeskShopV2Page extends MerchWebPage
{
			...
			while ($hour < 24) {
				...
				$dr = array(
					...
					'count' => pdo_fetchcolumn(
						...
						' WHERE uniacid=:uniacid and merchid=:merchid and status>=1 and createtime >=:starttime and createtime <=:endtime',
						array(
							':uniacid' => $_W['uniacid'],
							':merchid' => $_W['merchid'],
