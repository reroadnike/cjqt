...
class tb_product_signModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_product_sign";

    public $table_column_all = "id,signContractId,servicePackDetailsId";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['signContractId'] = '';// 签约表id | YES | int(11) | 
    $insert_data['servicePackDetailsId'] = '';// 商品id | YES | int(11) | 
