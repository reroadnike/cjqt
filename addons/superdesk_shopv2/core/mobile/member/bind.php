...
class Bind_SuperdeskShopV2Page extends MobileLoginPage
{
    protected $member;
    private   $_orderModel;
    ...
    protected function update($mid = 0, $arr = array())
    {
        ...
        pdo_update('superdesk_shop_member', // TODO 标志 楼宇之窗 openid shop_member 不处理
            $arr,
            array(
                'id'      => $mid,
                'uniacid' => $_W['uniacid']
