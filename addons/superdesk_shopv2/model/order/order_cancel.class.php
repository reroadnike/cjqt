...
class order_cancelModel
{

    public $table_name = "superdesk_shop_order_cancel";

    public $table_column_all = "id,uniacid,orderid,cancelno,reason,content,createtime,status,canceltime,message,merchid,third_status,third_message";
