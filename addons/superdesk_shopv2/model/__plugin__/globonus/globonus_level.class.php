...
class globonus_levelModel
{

    public $table_name = "superdesk_shop_globonus_level";

    public $table_column_all = "id,uniacid,levelname,bonus,ordermoney,ordercount,commissionmoney,bonusmoney,downcount";
