...
class sys_roleModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sys_role";

    public $table_column_all = "role_id,role_name,role_orderTag,role_stat,role_inserttime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['role_id'] = '';//  | NO | int(11) | 
    $insert_data['role_name'] = '';// 名称 | YES | varchar(255) | 
    $insert_data['role_orderTag'] = '';// 排序 | YES | varchar(255) | 
    $insert_data['role_stat'] = '';// 状态 | YES | varchar(255) | 
    $insert_data['role_inserttime'] = '';// 创建时间 | YES | datetime | 
