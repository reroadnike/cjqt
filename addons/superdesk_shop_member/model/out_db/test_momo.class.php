...
class test_momoModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "test_momo";

    public $table_column_all = "id,xlh,zt";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['xlh'] = '';//  | YES | varchar(255) | 
    $insert_data['zt'] = '';//  | YES | varchar(255) | 
