...
class goods_spec_itemModel
{

    public $table_name = "superdesk_shop_goods_spec_item";

    public $table_column_all = "id,uniacid,specid,title,thumb,show,displayorder,valueId,virtual";
