define(['jquery', 'bootstrap'], function ($, bs) {
    ...
    mbiz.url = function(routes,params) {
        ...
        var url = './superdesk_shopv2_enterpriseant.php?c=site&a=entry&m=superdesk_shopv2&do=web&r=' + routes.replace(/\//ig,'.');
        if(params ){
    ...
    $(document).on('click', '[data-toggle="selectUrlenterprise"]', function () {
        $("#selectUrl").remove();
