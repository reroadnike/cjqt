...
class Index_SuperdeskShopV2Page extends PluginMobilePage
{
    public function main()
    {
        ...
        if (!empty($set)) {
            ...
            $_W['shopshare'] = array(
                ...
                'desc'   => $set['desc'],
                'link'   => mobileUrl('merch', array('merchid' => $merchid), true)
            );
    ...
    public function getpage($merchid)
    {
        ...
        $advs = pdo_fetchall(
            ...
            ' from ' . tablename('superdesk_shop_merch_adv') .
            ' where ' .
            '       uniacid=:uniacid ' .
            '       and merchid=:merchid ' .
            '       and enabled=1 ' .
        ...
        $navs = pdo_fetchall(
            ...
            ' from ' . tablename('superdesk_shop_merch_nav') .
            ' where ' .
            '       uniacid=:uniacid ' .
            '       and merchid=:merchid ' .
            '       and status=1 ' .
        ...
        $banners = pdo_fetchall(
            ...
            ' from ' . tablename('superdesk_shop_merch_banner') .
            ' where ' .
            '       uniacid=:uniacid ' .
            '       and merchid=:merchid ' .
            '       and enabled=1 ' .
        ...
        if (!empty($shop['indexrecommands'])) {
            ...
            if (!empty($goodids)) {
                ...
                $indexrecommands = pdo_fetchall(
                    'select id, title, thumb, marketprice, productprice, minprice, total ' .
