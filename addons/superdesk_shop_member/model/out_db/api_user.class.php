...
class api_userModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "api_user";

    public $table_column_all = "api_user_id,api_user_pkcode,api_username,api_password,api_roleid,api_email,api_linkman,api_tel,api_token,api_token_endtime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['api_user_id'] = '';//  | NO | int(11) | 
    $insert_data['api_user_pkcode'] = '';//  | YES | varchar(255) | 
    $insert_data['api_username'] = '';//  | YES | varchar(255) | 
    $insert_data['api_password'] = '';//  | YES | varchar(255) | 
    $insert_data['api_roleid'] = '';//  | YES | int(11) | 
    $insert_data['api_email'] = '';//  | YES | varchar(255) | 
    $insert_data['api_linkman'] = '';//  | YES | varchar(255) | 
    $insert_data['api_tel'] = '';//  | YES | varchar(255) | 
    $insert_data['api_token'] = '';//  | YES | varchar(255) | 
    $insert_data['api_token_endtime'] = '';//  | YES | datetime | 
