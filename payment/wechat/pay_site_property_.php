...
$havePay = pdo_get('property_order',array('ordernum'=>$params['out_trade_no'],'type'=>1));
if(!empty($havePay)){
...
WeUtility::logging('见到我就开心2222', $input->ToXml());

// 此处要与微信通讯了, 记录发起地址
$order = WxPayApi::unifiedOrder($input);

//WeUtility::logging('见到我就开心3333', json_encode($order));
...
$time = time();
$orderData = array(
    'payMan'        =>$params['payMan'],
    'IpItemName'    =>$params['IpItemName'],
    'projectid'     =>$params['projectid'],
    'resName'       =>$params['resName'],
    'ordernum'      =>$params['out_trade_no'],
    'date'          =>date('Y-m-d H:i:s',$time),
    'RevMoney'      =>$params['RevMoney'],
    'LFMoney'       =>$params['LFMoney'],
...
pdo_insert('property_order',$orderData);
