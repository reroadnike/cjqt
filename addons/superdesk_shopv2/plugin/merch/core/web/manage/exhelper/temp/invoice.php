...
class Invoice_SuperdeskShopV2Page extends MerchWebPage
{
    ...
    protected function post()
    {
        ...
        if (!empty($id)) {
            ...
            $item = pdo_fetch(
                'select * from ' . tablename('superdesk_shop_exhelper_express') .
                ' where id=:id and type=:type and uniacid=:uniacid and merchid=:merchid limit 1',
                array(
                    ':id'      => $id,
                    ':type'    => $type,
                    ':uniacid' => $_W['uniacid'],
        ...
        if ($_W['ispost']) {
            ...
            if (!empty($data['isdefault'])) {
                ...
                pdo_update('superdesk_shop_exhelper_express', array('isdefault' => 0), array('type' => 2, 'uniacid' => $_W['uniacid'], 'merchid' => $merchid));
                pdo_update('superdesk_shop_exhelper_express', array('isdefault' => 1), array('type' => 2, 'id' => $id, 'merchid' => $merchid));
            }
