...
class advertisementModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "advertisement";

    public $table_column_all = "id,name,url,imgUrl,status,ctime,user_id";
    ...
    $insert_data['imgUrl'] = '';//  | YES | varchar(255) | 
    $insert_data['status'] = '';// 1:有效 0：失效 | YES | int(11) | 
