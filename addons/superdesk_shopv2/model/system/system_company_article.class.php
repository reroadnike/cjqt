...
class system_company_articleModel
{

    public $table_name = "superdesk_shop_system_company_article";

    public $table_column_all = "id,title,author,thumb,content,createtime,displayorder,cate,status";
