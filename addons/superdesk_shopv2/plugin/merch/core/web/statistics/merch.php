...
class Merch_SuperdeskShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        $sql =
            'select u.*,sum(o.price) price,sum(o.goodsprice) goodsprice,sum(o.dispatchprice) dispatchprice,sum(o.discountprice) discountprice,' .
            '       sum(o.deductprice) deductprice,sum(o.deductcredit2) deductcredit2,sum(o.isdiscountprice) isdiscountprice ' .
        ...
        $total  = pdo_fetchcolumn(
            ...
            ' left join ' . tablename('superdesk_shop_order') . ' o on u.id=o.merchid' . // TODO 标志 楼宇之窗 openid shop_order 不处理
            ' where 1 ' . $condition . ' GROUP BY u.id', $params);
    ...
    public function ajax_user_data()
    {
        ...
        $merch     = pdo_fetch('select * from ' . tablename('superdesk_shop_merch_user') . ' where id = :id', array(':id' => $merchid));
        ...
        $sql                   =
            'select u.id,u.merchname,u.payrate,sum(o.price) price,sum(o.goodsprice) goodsprice,sum(o.dispatchprice) dispatchprice,' .
            '       sum(o.discountprice) discountprice,sum(o.deductprice) deductprice,sum(o.deductcredit2) deductcredit2,' .
            '       sum(o.isdiscountprice) isdiscountprice,sum(o.deductenough) deductenough,sum(o.merchdeductenough) merchdeductenough ' .
            ' from ' . tablename('superdesk_shop_merch_user') . ' u ' .
            ' left join ' . tablename('superdesk_shop_order') . ' o on u.id=o.merchid' . // TODO 标志 楼宇之窗 openid shop_order 不处理
