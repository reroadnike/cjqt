...
class wx_invitationModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_invitation";

    public $table_column_all = "id,picurl,title,ctime,visitcount,visitcode,token,sharepic,sharemusic,sharetitle,sharecontext";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['picurl'] = '';// 图片地址，用逗号隔开 | YES | varchar(1000) | 
    $insert_data['title'] = '';// 统一标题，多个标题用逗号隔开 | YES | varchar(500) | 
    $insert_data['ctime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['visitcount'] = '';// 浏览次数 | YES | int(11) unsigned zerofill | 
    $insert_data['visitcode'] = '';// 访问ID | YES | varchar(20) | 
    $insert_data['token'] = '';//  | YES | varchar(50) | 
    $insert_data['sharepic'] = '';// 分享图片 | YES | varchar(255) | 
    $insert_data['sharemusic'] = '';// 分享音乐 | YES | varchar(255) | 
    $insert_data['sharetitle'] = '';// 分享标题 | YES | varchar(100) | 
    $insert_data['sharecontext'] = '';// 分享内容 | YES | varchar(255) | 
