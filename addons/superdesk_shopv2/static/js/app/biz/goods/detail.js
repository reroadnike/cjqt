define(['core', 'tpl', 'biz/goods/picker', 'biz/member/favorite', 'biz/member/cart', 'biz/plugin/diyform'],
    function(core, tpl, picker, favorite, cart, diyform) {
        ...
        modal.init = function(params) {
            if(window.goodsdetail_need_reload){
                window.goodsdetail_need_reload = false;
                location.reload();
            }
