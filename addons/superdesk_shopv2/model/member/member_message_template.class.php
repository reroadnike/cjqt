...
class member_message_templateModel
{

    public $table_name = "superdesk_shop_member_message_template";

    public $table_column_all = "id,uniacid,title,template_id,first,firstcolor,data,remark,remarkcolor,url,createtime,sendtimes,sendcount";
