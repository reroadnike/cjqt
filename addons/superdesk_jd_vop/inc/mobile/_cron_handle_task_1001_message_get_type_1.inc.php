 ...
 * Time: 9:15 PM
 *
 * http://192.168.1.124/superdesk/app/index.php?i=16&c=entry&m=superdesk_jd_vop&do=_cron_handle_task_1001_message_get_type_1
 */
...
$_is_ignore = $task_cron->isIgnore(task_cronModel::_cron_handle_task_1001_message_get_type_1);

if ($_is_ignore) {
    die("ignore task" . PHP_EOL);
} else {
    $task_cron->updateLastdo(task_cronModel::_cron_handle_task_1001_message_get_type_1);
}
