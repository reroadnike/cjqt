...
class customer_guestbookModel
{

    public $table_name = "superdesk_shop_customer_guestbook";

    public $table_column_all = "id,uniacid,openid,realname,mobile,weixin,images,content,remark,status,createtime,deleted";
