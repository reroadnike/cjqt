...
class tb_product_categoriesModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_product_categories";

    public $table_column_all = "id,name,code,parentCode,serviceCode,iconUrl,description,orderNo,serviceId,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['name'] = '';// 分类名称 | YES | varchar(100) | 
    $insert_data['code'] = '';// 当前节点编码 | YES | varchar(100) | 
    $insert_data['parentCode'] = '';// 父类编码（如果一级分类，则编码为0） | YES | varchar(100) | 
    $insert_data['serviceCode'] = '';// 业务编码 | YES | varchar(40) | 
    $insert_data['iconUrl'] = '';// 分类图标 | YES | varchar(200) | 
    $insert_data['description'] = '';// 描述 | YES | varchar(100) | 
    $insert_data['orderNo'] = '';// 排序序号 | YES | varchar(10) | 
    $insert_data['serviceId'] = '';// 服务项ID | YES | int(11) | 
    ...
    $insert_data['isEnabled'] = '';// 是否可用或删除：0 禁用，1 可用 | YES | char(1) | 
