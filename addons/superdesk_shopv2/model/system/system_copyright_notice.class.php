...
class system_copyright_noticeModel
{

    public $table_name = "superdesk_shop_system_copyright_notice";

    public $table_column_all = "id,title,author,content,createtime,displayorder,status";
