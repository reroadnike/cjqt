...
class ms_integral_labelModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_integral_label";

    public $table_column_all = "integral_label_id,integral_label_name,integral_label_number,e_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['integral_label_id'] = '';//  | NO | int(11) | 
    $insert_data['integral_label_name'] = '';// 积分标签名字 | YES | varchar(255) | 
    $insert_data['integral_label_number'] = '';// 积分标签数量 | YES | int(11) | 
    $insert_data['e_id'] = '';// 企业ID | YES | int(22) | 
