...
class abonus_billModel
{

    public $table_name = "superdesk_shop_abonus_bill";

    public $table_column_all = "id,uniacid,billno,paytype,year,month,week,ordercount,ordermoney,paytime,aagentcount1,aagentcount2,aagentcount3,bonusmoney1,bonusmoney_send1,bonusmoney_pay1,bonusmoney2,bonusmoney_send2,bonusmoney_pay2,bonusmoney3,bonusmoney_send3,bonusmoney_pay3,createtime,status,starttime,endtime,confirmtime";
