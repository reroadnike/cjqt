...
class multi_shopModel
{

    public $table_name = "superdesk_shop_multi_shop";

    public $table_column_all = "id,uniacid,uid,name,company,sales,starttime,endtime,applytime,jointime,status,refusecontent";
