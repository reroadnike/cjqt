...
class creditshop_categoryModel
{

    public $table_name = "superdesk_shop_creditshop_category";

    public $table_column_all = "id,uniacid,name,thumb,displayorder,enabled,advimg,advurl,isrecommand";
