...
class groups_setModel
{

    public $table_name = "superdesk_shop_groups_set";

    public $table_column_all = "id,uniacid,groups,followurl,followqrcode,groupsurl,share_title,share_icon,share_desc,share_url,groups_description,description,creditdeduct,groupsdeduct,credit,groupsmoney,refund,refundday,goodsid,rules,receive,discount,headstype,headsmoney,headsdiscount";
