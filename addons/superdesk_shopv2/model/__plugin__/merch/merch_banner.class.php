...
class merch_bannerModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_banner";

    public $table_column_all = "id,uniacid,bannername,link,thumb,displayorder,enabled,merchid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['bannername'] = '';// 广告名字 | YES | varchar(50) | 
    $insert_data['link'] = '';// 广告链接 | YES | varchar(255) | 
    $insert_data['thumb'] = '';// 广告图片 | YES | varchar(255) | 
    $insert_data['displayorder'] = '0';// 显示顺序 | YES | int(11) | 0
    $insert_data['enabled'] = '0';// 广告是否显示 | YES | int(11) | 0
