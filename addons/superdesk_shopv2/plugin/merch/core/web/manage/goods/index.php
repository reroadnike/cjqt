...
//            $groupcondition;
        ...
        // TODO 这个转换老办法啦 pdo_fetchall(参数1,参数2,参数3($keyfield))
        $category = array();
    ...
    public function query()
    {
        ...
        $ds = pdo_fetchall(
            ' SELECT id,title,thumb,marketprice,productprice,share_title,share_icon,description ' .
            ' FROM ' . tablename('superdesk_shop_goods') .
            ' WHERE 1 ' .
            $condition .
