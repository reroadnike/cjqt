...
class merch_salerModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_saler";

    public $table_column_all = "id,storeid,uniacid,openid,status,salername,merchid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['storeid'] = '0';// 商户门店ID | YES | int(11) | 0
    $insert_data['openid'] = '';// 店员openid | YES | varchar(255) | 
    $insert_data['status'] = '0';// 工作状态 1 启用 0 禁用 | YES | tinyint(3) | 0
    $insert_data['salername'] = '';// 店员姓名 | YES | varchar(255) | 
