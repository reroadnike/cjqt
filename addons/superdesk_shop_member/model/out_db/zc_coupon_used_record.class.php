...
class zc_coupon_used_recordModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "zc_coupon_used_record";

    public $table_column_all = "r_id,r_coupon_id,r_coupon_type,r_coupon_price,r_goods_id,r_user_id,r_orderid,r_ctime,r_type,r_m_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['r_id'] = '';//  | NO | int(10) | 
    $insert_data['r_coupon_id'] = '';// 优惠券id | YES | int(10) | 
    $insert_data['r_coupon_type'] = '';// 优惠券类型 0：抵扣券  1：满减券 | YES | int(10) | 
    $insert_data['r_coupon_price'] = '';// 优惠金额 | YES | float(11,2) | 
    $insert_data['r_goods_id'] = '';// 商品id | YES | int(10) | 
    $insert_data['r_user_id'] = '';// 供应商id | YES | int(10) | 
    $insert_data['r_orderid'] = '';// 订单号 | YES | varchar(255) | 
    $insert_data['r_ctime'] = '';// 记录时间 | YES | datetime | 
    $insert_data['r_type'] = '';// 记录类型 1：使用   2：退还 | YES | int(10) | 
    $insert_data['r_m_id'] = '';// 会员id | YES | int(10) | 
