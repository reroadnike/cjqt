...
class postera_logModel
{

    public $table_name = "superdesk_shop_postera_log";

    public $table_column_all = "id,uniacid,openid,posterid,from_openid,subcredit,submoney,reccredit,recmoney,createtime,reccouponid,reccouponnum,subcouponid,subcouponnum";
