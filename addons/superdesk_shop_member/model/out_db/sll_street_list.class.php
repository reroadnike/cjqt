...
class sll_street_listModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_street_list";

    public $table_column_all = "street_list_id,store_id,street_id,pk_code,pk1,pk2,administrativeDivision_id,community_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['street_list_id'] = '';//  | NO | int(11) | 
    $insert_data['store_id'] = '';// 水店id | YES | int(11) | 
    $insert_data['street_id'] = '';// 街道id | YES | int(11) | 
    $insert_data['pk_code'] = '';//  | YES | varchar(255) | 
    $insert_data['pk1'] = '';//  | YES | varchar(255) | 
    $insert_data['pk2'] = '';//  | YES | varchar(255) | 
    $insert_data['administrativeDivision_id'] = '';// 区id | YES | int(11) | 
    $insert_data['community_id'] = '';// 社区id | YES | int(11) | 
