...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_abonus_bill` (
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_abonus_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_abonus_billp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_abonus_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_article_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_article_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_article_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_article_share` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `aid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_article_sys` (
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_author_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billno` varchar(100) DEFAULT '',
  `paytype` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_author_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_author_billp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_author_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `levelname` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_author_team` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_author_team_pay` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_bargain_account` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_bargain_actor` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_bargain_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `account_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_bargain_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_carrier` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_clickcount` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `levelname` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_repurchase` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_commission_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `mid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_coupon_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_coupon_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_coupon_guess` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `couponid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_coupon_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_creditshop_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_creditshop_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_creditshop_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_creditshop_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `logno` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_customer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_customer_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_customer_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_customer_robot` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cate` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_designer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_designer_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_dispatch` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diyform_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diyform_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diyform_temp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diyform_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
  `title` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diypage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diypage_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  `data` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diypage_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_diypage_template_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_exhelper_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_exhelper_senduser` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_exhelper_sys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_feedback` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_form` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_form_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_gift` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_globonus_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billno` varchar(100) DEFAULT '',
  `paytype` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_globonus_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_globonus_billp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `billid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_globonus_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `levelname` varchar(50) DEFAULT '',
  `bonus` decimal(10,4) DEFAULT '0.0000',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_label` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_labelstyle` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_param` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_spec` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_goods_spec_item` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_goods_atlas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_order_refund` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_paylog` (
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_groups_verify` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_mc_merchant` (
  `id` int(11) NOT NULL,
  `uniacid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_favorite` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `goodsid` int(10) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `level` int(11) DEFAULT '0',
  `levelname` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_printer` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_printer_template` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_member_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_account` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `merchid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `bannername` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_bill` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_billo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_category_swipe` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
  `createtime` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_clearing` (
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `groupname` varchar(255) DEFAULT '',
  `createtime` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_perm_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_perm_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `merchid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_reg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_saler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_merch_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_multi_shop` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_nav` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `navname` varchar(255) DEFAULT '',
  `icon` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `displayorder` int(11) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '',
  `agentid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_order_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
  `goodsid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_order_refund` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `orderid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `price` decimal(10,2) NOT NULL DEFAULT '0.00',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_package_goods` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
  `pid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_package_goods_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `goodsid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_perm_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_perm_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_perm_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `rolename` varchar(255) DEFAULT '',
  `status` tinyint(3) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_perm_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `uid` int(11) DEFAULT '0',
  `username` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_plugin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `displayorder` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_poster` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0',
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_postera` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `type` tinyint(3) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_postera_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_postera_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_poster_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `posterid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_poster_qr` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `acid` int(10) unsigned NOT NULL,
  `openid` varchar(100) NOT NULL DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_poster_scan` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `posterid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_qa_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_qa_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_qa_question` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_qa_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_refund_address` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(50) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_saler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeid` int(11) DEFAULT '0',
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sale_coupon` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(255) DEFAULT '',
  `type` tinyint(3) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sale_coupon_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
  `couponid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sign_records` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sign_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sign_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `openid` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sms` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sms_set` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `advname` varchar(50) DEFAULT '',
  `link` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_board` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `cid` int(11) DEFAULT '0',
  `title` varchar(50) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_board_follow` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `thumb` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_complain` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_complaincate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_level` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_like` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_manage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `bid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `openid` varchar(255) DEFAULT NULL,
  `level` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sns_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `bid` int(11) DEFAULT '0',
  `pid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_store` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `storename` varchar(255) DEFAULT '',
  `address` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_sysset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `sets` longtext,
  `plugins` longtext,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_adv` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
  `url` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_banner` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
  `url` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_case` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_casecategory` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
  `status` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
  `status` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_company_article` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `author` varchar(255) DEFAULT '',
  `thumb` varchar(255) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_company_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) DEFAULT '',
  `displayorder` int(11) DEFAULT '0',
  `status` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_copyright` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_copyright_notice` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) DEFAULT '',
  `author` varchar(255) DEFAULT '',
  `content` text,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL DEFAULT '',
  `content` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_system_site` (
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_virtual_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) DEFAULT '0',
  `name` varchar(50) DEFAULT NULL,
  `merchid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_virtual_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `typeid` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_superdesk_shop_virtual_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uniacid` int(11) NOT NULL DEFAULT '0',
  `cate` int(11) DEFAULT '0',
  `title` varchar(255) NOT NULL DEFAULT '',
...
(1, 1, 'qiniu', '七牛存储', '1.0', '官方', 1, 'tool', 0, '../addons/superdesk_shopv2/static/images/qiniu.jpg', NULL, 1, 0),
(2, 2, 'taobao', '商品助手', '1.0', '官方', 1, 'tool', 0, '../addons/superdesk_shopv2/static/images/taobao.jpg', '', 0, 0),
(3, 3, 'commission', '超级营销', '1.0', '官方', 1, 'biz', 0, '../addons/superdesk_shopv2/static/images/commission.jpg', '', 0, 0),
(4, 4, 'poster', '超级海报', '1.2', '官方', 1, 'sale', 0, '../addons/superdesk_shopv2/static/images/poster.jpg', '', 0, 0),
(5, 5, 'verify', 'O2O核销', '1.0', '官方', 1, 'biz', 0, '../addons/superdesk_shopv2/static/images/verify.jpg', NULL, 1, 0),
(6, 6, 'tmessage', '会员群发', '1.0', '官方', 1, 'tool', 0, '../addons/superdesk_shopv2/static/images/tmessage.jpg', NULL, 1, 0),
(7, 7, 'perm', '分权系统', '1.0', '官方', 1, 'help', 0, '../addons/superdesk_shopv2/static/images/perm.jpg', NULL, 1, 0),
(8, 8, 'sale', '营销宝', '1.0', '官方', 1, 'sale', 0, '../addons/superdesk_shopv2/static/images/sale.jpg', NULL, 1, 0),
(9, 9, 'designer', '店铺装修V1', '1.0', '官方', 1, 'help', 0, '../addons/superdesk_shopv2/static/images/designer.jpg', NULL, 0, 1),
(10, 10, 'creditshop', '积分商城', '1.0', '官方', 1, 'biz', 0, '../addons/superdesk_shopv2/static/images/creditshop.jpg', '', 0, 0),
(11, 11, 'virtual', '虚拟物品', '1.0', '官方', 1, 'biz', 0, '../addons/superdesk_shopv2/static/images/virtual.jpg', NULL, 1, 0),
(12, 11, 'article', '文章营销', '1.0', '官方', 1, 'help', 0, '../addons/superdesk_shopv2/static/images/article.jpg', '', 0, 0),
(13, 13, 'coupon', '超级券', '1.0', '官方', 1, 'sale', 0, '../addons/superdesk_shopv2/static/images/coupon.jpg', NULL, 1, 0),
(14, 14, 'postera', '活动海报', '1.0', '官方', 1, 'sale', 0, '../addons/superdesk_shopv2/static/images/postera.jpg', '', 0, 0),
(15, 16, 'system', '系统工具', '1.0', '官方', 0, 'help', 0, '../addons/superdesk_shopv2/static/images/system.jpg', NULL, 0, 1),
(16, 15, 'diyform', '自定表单', '1.0', '官方', 1, 'help', 0, '../addons/superdesk_shopv2/static/images/diyform.jpg', '', 0, 0),
(17, 16, 'exhelper', '快递助手', '1.0', '官方', 1, 'help', 0, '../addons/superdesk_shopv2/static/images/exhelper.jpg', '', 0, 0),
(18, 19, 'groups', '超级拼团', '1.0', '官方', 1, 'biz', 0, '../addons/superdesk_shopv2/static/images/groups.jpg', '', 0, 0),
(19, 20, 'diypage', '店铺装修', '2.0', '官方', 1, 'help', 0, '../addons/superdesk_shopv2/static/images/designer.jpg', '', 0, 0),
(20, 22, 'globonus', '全民股东', '1.0', '官方', 1, 'biz', 0, '../addons/superdesk_shopv2/static/images/globonus.jpg', '', 0, 0),
(21, 23, 'merch', '多商户', '1.0', '官方', 1, 'biz', 1, '../addons/superdesk_shopv2/static/images/merch.jpg', '', 0, 0),
(22, 26, 'qa', '帮助中心', '1.0', '官方', 1, 'help', 1, '../addons/superdesk_shopv2/static/images/qa.jpg', '', 0, 0),
(24, 27, 'sms', '短信提醒', '1.0', '官方', 1, 'tool', 1, '../addons/superdesk_shopv2/static/images/sms.jpg', '', 1, 0),
(25, 29, 'sign', '积分签到', '1.0', '官方', 1, 'tool', 1, '../addons/superdesk_shopv2/static/images/sign.jpg', '', 0, 0),
(26, 30, 'sns', '全民社区', '1.0', '官方', 1, 'sale', 1, '../addons/superdesk_shopv2/static/images/sns.jpg', '', 0, 0),
(27, 33, 'wap', '全网通', '1.0', '官方', 1, 'tool', 1, '', '', 1, 0),
(28, 34, 'h5app', 'H5APP', '1.0', '官方', 1, 'tool', 1, '', '', 1, 0),
(29, 26, 'abonus', '区域代理', '1.0', '官方', 1, 'biz', 1, '../addons/superdesk_shopv2/static/images/abonus.jpg', '', 0, 0),
(30, 33, 'printer', '小票打印机', '1.0', '官方', 1, 'tool', 1, '', '', 1, 0),
(31, 33, 'bargain', '砍价活动', '1.0', '官方', 1, 'tool', 1, '../addons/superdesk_shopv2/static/images/bargain.jpg', '', 0, 0);
ALTER TABLE `ims_superdesk_shop_abonus_billo` ROW_FORMAT=Dynamic;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_title`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文章标题' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `resp_desc`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '回复介绍' AFTER `article_title`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `resp_img`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '回复图片' AFTER `resp_desc`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_category`  int(11) NOT NULL DEFAULT 0 COMMENT '文章分类' AFTER `article_content`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_date_v`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '虚拟发布时间' AFTER `article_category`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_date`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '文章发布时间' AFTER `article_date_v`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_mp`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '公众号' AFTER `article_date`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_author`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '发布作者' AFTER `article_mp`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_readnum_v`  int(11) NOT NULL DEFAULT 0 COMMENT '虚拟阅读量' AFTER `article_author`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_readnum`  int(11) NOT NULL DEFAULT 0 COMMENT '真实阅读量' AFTER `article_readnum_v`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_likenum_v`  int(11) NOT NULL DEFAULT 0 COMMENT '虚拟点赞数' AFTER `article_readnum`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_likenum`  int(11) NOT NULL DEFAULT 0 COMMENT '真实点赞数' AFTER `article_likenum_v`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_linkurl`  varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '阅读原文链接' AFTER `article_likenum`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_rule_daynum`  int(11) NOT NULL DEFAULT 0 COMMENT '每人每天参与次数' AFTER `article_linkurl`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_rule_allnum`  int(11) NOT NULL DEFAULT 0 COMMENT '所有参与次数' AFTER `article_rule_daynum`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_rule_credit`  int(11) NOT NULL DEFAULT 0 COMMENT '增加y积分' AFTER `article_rule_allnum`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_rule_money`  decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '增加z余额' AFTER `article_rule_credit`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `page_set_option_nocopy`  int(1) NOT NULL DEFAULT 0 COMMENT '页面禁止复制url' AFTER `article_rule_money`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `page_set_option_noshare_tl`  int(1) NOT NULL DEFAULT 0 COMMENT '页面禁止分享至朋友圈' AFTER `page_set_option_nocopy`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `page_set_option_noshare_msg`  int(1) NOT NULL DEFAULT 0 COMMENT '页面禁止发送给好友' AFTER `page_set_option_noshare_tl`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_keyword`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '页面关键字' AFTER `page_set_option_noshare_msg`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `article_report`  int(1) NOT NULL DEFAULT 0 COMMENT '举报按钮' AFTER `article_keyword`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `product_advs_type`  int(1) NOT NULL DEFAULT 0 COMMENT '营销显示产品' AFTER `article_report`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `product_advs_title`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '营销产品标题' AFTER `product_advs_type`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `product_advs_more`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '推广产品底部标题' AFTER `product_advs_title`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `product_advs_link`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '推广产品底部链接' AFTER `product_advs_more`;
ALTER TABLE `ims_superdesk_shop_article` MODIFY COLUMN `product_advs`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '营销商品' AFTER `product_advs_link`;
ALTER TABLE `ims_superdesk_shop_article_category` MODIFY COLUMN `category_name`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类名称' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_article_category` MODIFY COLUMN `uniacid`  int(11) NOT NULL DEFAULT 0 AFTER `category_name`;
ALTER TABLE `ims_superdesk_shop_article_log` MODIFY COLUMN `aid`  int(11) NOT NULL DEFAULT 0 COMMENT '文章id' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_article_log` MODIFY COLUMN `openid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户openid' AFTER `like`;
ALTER TABLE `ims_superdesk_shop_article_share` MODIFY COLUMN `share_user`  int(11) NOT NULL DEFAULT 0 COMMENT '分享人' AFTER `aid`;
ALTER TABLE `ims_superdesk_shop_article_share` MODIFY COLUMN `click_user`  int(11) NOT NULL DEFAULT 0 COMMENT '点击人' AFTER `share_user`;
ALTER TABLE `ims_superdesk_shop_article_share` MODIFY COLUMN `click_date`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '执行时间' AFTER `click_user`;
ALTER TABLE `ims_superdesk_shop_article_share` MODIFY COLUMN `add_credit`  int(11) NOT NULL DEFAULT 0 COMMENT '添加的积分' AFTER `click_date`;
ALTER TABLE `ims_superdesk_shop_article_share` MODIFY COLUMN `add_money`  decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '添加的余额' AFTER `add_credit`;
ALTER TABLE `ims_superdesk_shop_article_sys` MODIFY COLUMN `article_title`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标题' AFTER `article_message`;
ALTER TABLE `ims_superdesk_shop_article_sys` MODIFY COLUMN `article_image`  varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '图片' AFTER `article_title`;
ALTER TABLE `ims_superdesk_shop_article_sys` MODIFY COLUMN `article_shownum`  int(11) NOT NULL DEFAULT 0 COMMENT '每页数量' AFTER `article_image`;
ALTER TABLE `ims_superdesk_shop_article_sys` MODIFY COLUMN `article_keyword`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '关键字' AFTER `article_shownum`;
ALTER TABLE `ims_superdesk_shop_article_sys` MODIFY COLUMN `article_temp`  int(11) NOT NULL DEFAULT 0 AFTER `article_keyword`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `uniacid`  int(11) NULL DEFAULT 0 COMMENT '所属帐号' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `name`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类名称' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `thumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类图片' AFTER `name`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `parentid`  int(11) NULL DEFAULT 0 COMMENT '上级分类ID,0为第一级' AFTER `thumb`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `description`  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类介绍' AFTER `isrecommand`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `displayorder`  tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '排序' AFTER `description`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `enabled`  tinyint(1) NULL DEFAULT 1 COMMENT '是否开启' AFTER `displayorder`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `advimg`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `ishome`;
ALTER TABLE `ims_superdesk_shop_category` MODIFY COLUMN `advurl`  varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `advimg`;
ALTER TABLE `ims_superdesk_shop_commission_apply` MODIFY COLUMN `mid`  int(11) NULL DEFAULT 0 COMMENT '会员ID' AFTER `applyno`;
ALTER TABLE `ims_superdesk_shop_commission_apply` MODIFY COLUMN `type`  tinyint(3) NULL DEFAULT 0 COMMENT '0 余额 1 微信' AFTER `mid`;
ALTER TABLE `ims_superdesk_shop_commission_apply` MODIFY COLUMN `status`  tinyint(3) NULL DEFAULT 0 COMMENT '-1 无效 0 未知 1 正在申请 2 审核通过 3 已经打款' AFTER `content`;
ALTER TABLE `ims_superdesk_shop_commission_level` MODIFY COLUMN `commissionmoney`  decimal(10,2) NULL DEFAULT 0.00 AFTER `commission3`;
ALTER TABLE `ims_superdesk_shop_commission_level` MODIFY COLUMN `downcount`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `ordermoney`;
ALTER TABLE `ims_superdesk_shop_commission_log` ROW_FORMAT=Dynamic;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `usetype`  tinyint(3) NULL DEFAULT 0 COMMENT '消费方式 0 付款使用 1 下单使用' AFTER `getmax`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `returntype`  tinyint(3) NULL DEFAULT 0 COMMENT '退回方式 0 不可退回 1 取消订单(未付款) 2.退款可以退回' AFTER `usetype`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `timelimit`  tinyint(3) NULL DEFAULT 0 COMMENT '0 领取后几天有效 1 时间范围' AFTER `enough`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `coupontype`  tinyint(3) NULL DEFAULT 0 COMMENT '0 优惠券 1 充值券' AFTER `timelimit`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `discount`  decimal(10,2) NULL DEFAULT 0.00 COMMENT '折扣' AFTER `timeend`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `deduct`  decimal(10,2) NULL DEFAULT 0.00 COMMENT '抵扣' AFTER `discount`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `backmoney`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '返现' AFTER `backtype`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `backcredit`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '返积分' AFTER `backmoney`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `total`  int(11) NULL DEFAULT 0 COMMENT '数量 -1 不限制' AFTER `createtime`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `status`  tinyint(3) NULL DEFAULT 0 COMMENT '可用' AFTER `total`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `money`  decimal(10,2) NULL DEFAULT 0.00 COMMENT '购买价格' AFTER `status`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `respdesc`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '推送描述' AFTER `money`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `respthumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '推送图片' AFTER `respdesc`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `resptitle`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '推送标题' AFTER `respthumb`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdsuc`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdkey`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdfail`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdsuc`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `pwdfail`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdask`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdurl`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdstatus`  tinyint(3) NULL DEFAULT 0 AFTER `pwdask`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdtimes`  int(11) NULL DEFAULT 0 AFTER `pwdstatus`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdfull`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdtimes`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdwords`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdfull`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdopen`  tinyint(3) NULL DEFAULT 0 AFTER `pwdwords`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdown`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdopen`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdexit`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `pwdown`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `pwdexitstr`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `pwdexit`;
ALTER TABLE `ims_superdesk_shop_coupon` MODIFY COLUMN `displayorder`  int(11) NULL DEFAULT 0 AFTER `pwdexitstr`;
ALTER TABLE `ims_superdesk_shop_coupon_data` MODIFY COLUMN `gettype`  tinyint(3) NULL DEFAULT 0 COMMENT '获取方式 0 发放 1 领取 2 积分商城' AFTER `couponid`;
ALTER TABLE `ims_superdesk_shop_coupon_data` MODIFY COLUMN `gettime`  int(11) NULL DEFAULT 0 COMMENT '获取时间' AFTER `usetime`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_superdesk_shop_coupon_log` MODIFY COLUMN `getfrom`  tinyint(3) NULL DEFAULT 0 COMMENT '0 发放 1 中心 2 积分兑换' AFTER `paytype`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_superdesk_shop_creditshop_category` MODIFY COLUMN `uniacid`  int(11) NULL DEFAULT 0 COMMENT '所属帐号' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_creditshop_category` MODIFY COLUMN `name`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类名称' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_creditshop_category` MODIFY COLUMN `thumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类图片' AFTER `name`;
ALTER TABLE `ims_superdesk_shop_creditshop_category` MODIFY COLUMN `displayorder`  tinyint(3) UNSIGNED NULL DEFAULT 0 COMMENT '排序' AFTER `thumb`;
ALTER TABLE `ims_superdesk_shop_creditshop_category` MODIFY COLUMN `enabled`  tinyint(1) NULL DEFAULT 1 COMMENT '是否开启' AFTER `displayorder`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `eno`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '兑换码' AFTER `logno`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `status`  tinyint(3) NULL DEFAULT 0 COMMENT '0 只生成记录未参加 1 未中奖 2 已中奖 3 已发奖' AFTER `createtime`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `paystatus`  tinyint(3) NULL DEFAULT 0 COMMENT '支付状态 -1 不需要支付 0 未支付 1 已支付' AFTER `status`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `paytype`  tinyint(3) NULL DEFAULT '-1' COMMENT '支付类型 -1 不需要支付 0 余额 1 微信' AFTER `paystatus`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `dispatchstatus`  tinyint(3) NULL DEFAULT 0 COMMENT '运费状态 -1 不需要运费 0 未支付 1 已支付' AFTER `paytype`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `creditpay`  tinyint(3) NULL DEFAULT 0 COMMENT '积分支付 0 未支付 1 已支付' AFTER `dispatchstatus`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `addressid`  int(11) NULL DEFAULT 0 COMMENT '收货地址' AFTER `creditpay`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `dispatchno`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '运费支付单号' AFTER `addressid`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `storeid`  int(11) NULL DEFAULT 0 AFTER `verifyopenid`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `realname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `storeid`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `mobile`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `realname`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `couponid`  int(11) NULL DEFAULT 0 AFTER `mobile`;
ALTER TABLE `ims_superdesk_shop_creditshop_log` MODIFY COLUMN `dupdate1`  tinyint(3) NULL DEFAULT 0 AFTER `couponid`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `uniacid`  int(11) NOT NULL DEFAULT 0 COMMENT '公众号' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `pagename`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '页面名称' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `pagetype`  tinyint(3) NOT NULL DEFAULT 0 COMMENT '页面类型' AFTER `pagename`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `createtime`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '页面创建时间' AFTER `pageinfo`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `savetime`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '页面最后保存时间' AFTER `keyword`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `setdefault`  tinyint(3) NOT NULL DEFAULT 0 COMMENT '默认页面' AFTER `savetime`;
ALTER TABLE `ims_superdesk_shop_designer` MODIFY COLUMN `datas`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '数据' AFTER `setdefault`;
ALTER TABLE `ims_superdesk_shop_diyform_category` MODIFY COLUMN `uniacid`  int(11) NULL DEFAULT 0 COMMENT '所属帐号' AFTER `id`;
ALTER TABLE `ims_superdesk_shop_diyform_category` MODIFY COLUMN `name`  varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类名称' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_diyform_data` MODIFY COLUMN `typeid`  int(11) NOT NULL DEFAULT 0 COMMENT '类型id' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_diyform_data` MODIFY COLUMN `cid`  int(11) NULL DEFAULT 0 COMMENT '关联id' AFTER `typeid`;
ALTER TABLE `ims_superdesk_shop_diyform_data` MODIFY COLUMN `fields`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字符集' AFTER `diyformfields`;
ALTER TABLE `ims_superdesk_shop_diyform_data` MODIFY COLUMN `openid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '使用者openid' AFTER `fields`;
ALTER TABLE `ims_superdesk_shop_diyform_data` MODIFY COLUMN `type`  tinyint(2) NULL DEFAULT 0 COMMENT '该数据所属模块' AFTER `openid`;
ALTER TABLE `ims_superdesk_shop_diyform_temp` MODIFY COLUMN `cid`  int(11) NOT NULL DEFAULT 0 COMMENT '关联id' AFTER `typeid`;
ALTER TABLE `ims_superdesk_shop_diyform_temp` MODIFY COLUMN `fields`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字符集' AFTER `diyformfields`;
ALTER TABLE `ims_superdesk_shop_diyform_temp` MODIFY COLUMN `openid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '使用者openid' AFTER `fields`;
ALTER TABLE `ims_superdesk_shop_diyform_temp` MODIFY COLUMN `type`  tinyint(1) NULL DEFAULT 0 COMMENT '类型' AFTER `openid`;
ALTER TABLE `ims_superdesk_shop_diyform_type` MODIFY COLUMN `title`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '分类名称' AFTER `cate`;
ALTER TABLE `ims_superdesk_shop_diyform_type` MODIFY COLUMN `fields`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字段集' AFTER `title`;
ALTER TABLE `ims_superdesk_shop_diyform_type` MODIFY COLUMN `usedata`  int(11) NOT NULL DEFAULT 0 COMMENT '已用数据' AFTER `fields`;
ALTER TABLE `ims_superdesk_shop_diyform_type` MODIFY COLUMN `alldata`  int(11) NOT NULL DEFAULT 0 COMMENT '全部数据' AFTER `usedata`;
ALTER TABLE `ims_superdesk_shop_diyform_type` MODIFY COLUMN `status`  tinyint(1) NULL DEFAULT 1 COMMENT '状态' AFTER `alldata`;
ALTER TABLE `ims_superdesk_shop_diypage` ADD COLUMN `merch`  int(11) NOT NULL DEFAULT 0 AFTER `diymenu`;
ALTER TABLE `ims_superdesk_shop_diypage_menu` ADD COLUMN `merch`  int(11) NOT NULL DEFAULT 0 AFTER `lastedittime`;
ALTER TABLE `ims_superdesk_shop_diypage_template` ADD COLUMN `merch`  int(11) NOT NULL DEFAULT 0 AFTER `deleted`;
ALTER TABLE `ims_superdesk_shop_diypage_template_category` ADD COLUMN `merch`  int(11) NOT NULL DEFAULT 0 AFTER `name`;
ALTER TABLE `ims_superdesk_shop_exhelper_express` MODIFY COLUMN `type`  int(1) NOT NULL DEFAULT 1 COMMENT '单据分类 1为快递单 2为发货单' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_exhelper_senduser` MODIFY COLUMN `sendername`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件人' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_exhelper_senduser` MODIFY COLUMN `sendertel`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件人联系电话' AFTER `sendername`;
ALTER TABLE `ims_superdesk_shop_exhelper_senduser` MODIFY COLUMN `sendersign`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件人签名' AFTER `sendertel`;
ALTER TABLE `ims_superdesk_shop_exhelper_senduser` MODIFY COLUMN `sendercode`  int(11) NULL DEFAULT NULL COMMENT '发件地址邮编' AFTER `sendersign`;
ALTER TABLE `ims_superdesk_shop_exhelper_senduser` MODIFY COLUMN `senderaddress`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '发件地址' AFTER `sendercode`;
ALTER TABLE `ims_superdesk_shop_exhelper_senduser` MODIFY COLUMN `sendercity`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发件城市' AFTER `senderaddress`;
ALTER TABLE `ims_superdesk_shop_exhelper_sys` MODIFY COLUMN `port`  int(11) NOT NULL DEFAULT 8000 AFTER `ip`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `type`  tinyint(1) NULL DEFAULT 1 COMMENT '1为维权，2为投诉' AFTER `openid`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `status`  tinyint(1) NULL DEFAULT 0 COMMENT '状态 0 未解决，1用户同意，2用户拒绝' AFTER `type`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `feedbackid`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '投诉单号' AFTER `status`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `transid`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '订单号' AFTER `feedbackid`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `reason`  varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '理由' AFTER `transid`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `solution`  varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '期待解决方案' AFTER `reason`;
ALTER TABLE `ims_superdesk_shop_feedback` MODIFY COLUMN `remark`  varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注' AFTER `solution`;
ALTER TABLE `ims_superdesk_shop_globonus_billo` ROW_FORMAT=Dynamic;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `type`  tinyint(1) NULL DEFAULT 1 COMMENT '1为实体，2为虚拟' AFTER `ccate`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `description`  varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `unit`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `originalprice`  decimal(10,2) NULL DEFAULT 0.00 COMMENT '原价' AFTER `costprice`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `totalcnf`  int(11) NULL DEFAULT 0 COMMENT '0 拍下减库存 1 付款减库存 2 永久不减' AFTER `total`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `artid`  int(11) NULL DEFAULT 0 AFTER `hidecommission`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `cates`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `tcates`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `saleupdate33219`  tinyint(3) NULL DEFAULT 0 AFTER `detail_totaltitle`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `merchsale`  tinyint(1) NULL DEFAULT 0 AFTER `thumb_first`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `labelname`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `catch_source`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `autoreceive`  int(11) NULL DEFAULT 0 AFTER `labelname`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `cannotrefund`  tinyint(3) NULL DEFAULT 0 AFTER `autoreceive`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `bargain`  int(11) NULL DEFAULT 0 AFTER `cannotrefund`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `buyagain`  decimal(10,2) NULL DEFAULT 0.00 AFTER `bargain`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `buyagain_islong`  tinyint(1) NULL DEFAULT 0 AFTER `buyagain`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `buyagain_condition`  tinyint(1) NULL DEFAULT 0 AFTER `buyagain_islong`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `buyagain_sale`  tinyint(1) NULL DEFAULT 0 AFTER `buyagain_condition`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `buyagain_commission`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `buyagain_sale`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `saleupdate32484`  tinyint(3) NULL DEFAULT 0 AFTER `buyagain_commission`;
ALTER TABLE `ims_superdesk_shop_goods` MODIFY COLUMN `diypage`  int(11) NULL DEFAULT NULL AFTER `saleupdate36586`;
ALTER TABLE `ims_superdesk_shop_goods` DROP COLUMN `saleupdate40170`;
ALTER TABLE `ims_superdesk_shop_goods` DROP COLUMN `saleupdate35843`;
ALTER TABLE `ims_superdesk_shop_goods_labelstyle` ROW_FORMAT=Dynamic;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `inviter`  int(11) NULL DEFAULT 0 AFTER `childtime`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `fixagentid`  tinyint(3) NULL DEFAULT 0 AFTER `agentblack`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diymemberid`  int(11) NULL DEFAULT 0 AFTER `fixagentid`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diymemberfields`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `diymemberid`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diymemberdata`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `diymemberfields`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diymemberdataid`  int(11) NULL DEFAULT 0 AFTER `diymemberdata`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diycommissionid`  int(11) NULL DEFAULT 0 AFTER `diymemberdataid`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diycommissionfields`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `diycommissionid`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diycommissiondata`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `diycommissionfields`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `diycommissiondataid`  int(11) NULL DEFAULT 0 AFTER `diycommissiondata`;
ALTER TABLE `ims_superdesk_shop_member` MODIFY COLUMN `isblack`  int(11) NULL DEFAULT 0 AFTER `diycommissiondataid`;
ALTER TABLE `ims_superdesk_shop_member_log` MODIFY COLUMN `type`  tinyint(3) NULL DEFAULT NULL COMMENT '0 充值 1 提现' AFTER `openid`;
ALTER TABLE `ims_superdesk_shop_member_log` MODIFY COLUMN `status`  int(11) NULL DEFAULT 0 COMMENT '0 生成 1 成功 2 失败' AFTER `createtime`;
ALTER TABLE `ims_superdesk_shop_member_log` MODIFY COLUMN `rechargetype`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '充值类型' AFTER `money`;
ALTER TABLE `ims_superdesk_shop_member_log` MODIFY COLUMN `gives`  decimal(10,2) NULL DEFAULT NULL AFTER `rechargetype`;
ALTER TABLE `ims_superdesk_shop_member_log` MODIFY COLUMN `couponid`  int(11) NULL DEFAULT 0 AFTER `gives`;
ALTER TABLE `ims_superdesk_shop_member_message_template` MODIFY COLUMN `first`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '键名' AFTER `template_id`;
ALTER TABLE `ims_superdesk_shop_member_message_template` MODIFY COLUMN `data`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '颜色' AFTER `firstcolor`;
ALTER TABLE `ims_superdesk_shop_member_message_template` MODIFY COLUMN `remark`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '键值' AFTER `data`;
ALTER TABLE `ims_superdesk_shop_member_rank` ROW_FORMAT=Dynamic;
ALTER TABLE `ims_superdesk_shop_merch_billo` ROW_FORMAT=Dynamic;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `paytype`  tinyint(1) NULL DEFAULT 0 COMMENT '1为余额，2为在线，3为到付' AFTER `status`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `transid`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '微信支付单号' AFTER `paytype`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `verifycode`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `verifyopenid`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `printstate`  tinyint(1) NULL DEFAULT 0 AFTER `storeid`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `printstate2`  tinyint(1) NULL DEFAULT 0 AFTER `printstate`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `address_send`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `printstate2`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `refundstate`  tinyint(3) NULL DEFAULT 0 AFTER `address_send`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `coupongoodprice`  decimal(10,2) NULL DEFAULT 1.00 AFTER `apppay`;
ALTER TABLE `ims_superdesk_shop_order` MODIFY COLUMN `buyagainprice`  decimal(10,2) NULL DEFAULT 0.00 AFTER `coupongoodprice`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `commission1`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '0' AFTER `optionname`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `status1`  tinyint(3) NULL DEFAULT 0 COMMENT '申请状态，-2删除，-1无效，0未申请，1申请，2审核通过 3已打款' AFTER `deletetime1`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `status2`  tinyint(3) NULL DEFAULT 0 COMMENT '申请状态，-2删除，-1无效，0未申请，1申请，2审核通过 3已打款' AFTER `deletetime2`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `status3`  tinyint(3) NULL DEFAULT 0 COMMENT '申请状态，-2删除，-1无效，0未申请，1申请，2审核通过 3已打款' AFTER `deletetime3`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `diyformid`  int(11) NULL DEFAULT 0 AFTER `commissions`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `diyformdataid`  int(11) NULL DEFAULT 0 AFTER `diyformid`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `openid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `diyformfields`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `printstate`  int(11) NOT NULL DEFAULT 0 AFTER `openid`;
ALTER TABLE `ims_superdesk_shop_order_goods` MODIFY COLUMN `printstate2`  int(11) NOT NULL DEFAULT 0 AFTER `printstate`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `status`  tinyint(3) NULL DEFAULT 0 COMMENT '0申请 1 通过 2 驳回' AFTER `createtime`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `orderprice`  decimal(10,2) NULL DEFAULT 0.00 AFTER `refundtype`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `applyprice`  decimal(10,2) NULL DEFAULT 0.00 AFTER `orderprice`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `imgs`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `applyprice`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `rtype`  tinyint(3) NULL DEFAULT 0 AFTER `imgs`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `refundaddress`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `rtype`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `message`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `refundaddress`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `express`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `message`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `expresscom`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `express`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `expresssn`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `expresscom`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `operatetime`  int(11) NULL DEFAULT 0 AFTER `expresssn`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `sendtime`  int(11) NULL DEFAULT 0 AFTER `operatetime`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `returntime`  int(11) NULL DEFAULT 0 AFTER `sendtime`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `refundtime`  int(11) NULL DEFAULT 0 AFTER `returntime`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `rexpress`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `refundtime`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `rexpresscom`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `rexpress`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `rexpresssn`  varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `rexpresscom`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `refundaddressid`  int(11) NULL DEFAULT 0 AFTER `rexpresssn`;
ALTER TABLE `ims_superdesk_shop_order_refund` MODIFY COLUMN `endtime`  int(11) NULL DEFAULT 0 AFTER `refundaddressid`;
ALTER TABLE `ims_superdesk_shop_perm_role` MODIFY COLUMN `deleted`  tinyint(3) NULL DEFAULT 0 AFTER `perms`;
ALTER TABLE `ims_superdesk_shop_perm_user` MODIFY COLUMN `deleted`  tinyint(3) NULL DEFAULT 0 AFTER `perms`;
ALTER TABLE `ims_superdesk_shop_perm_user` MODIFY COLUMN `realname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `deleted`;
ALTER TABLE `ims_superdesk_shop_perm_user` MODIFY COLUMN `mobile`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `realname`;
ALTER TABLE `ims_superdesk_shop_plugin` MODIFY COLUMN `thumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `category`;
ALTER TABLE `ims_superdesk_shop_plugin` MODIFY COLUMN `desc`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `thumb`;
ALTER TABLE `ims_superdesk_shop_plugin` MODIFY COLUMN `iscom`  tinyint(3) NULL DEFAULT 0 AFTER `desc`;
ALTER TABLE `ims_superdesk_shop_plugin` MODIFY COLUMN `deprecated`  tinyint(3) NULL DEFAULT 0 AFTER `iscom`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `type`  tinyint(3) NULL DEFAULT 0 COMMENT '1 首页 2 小店 3 商城 4 自定义' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `times`  int(11) NULL DEFAULT 0 AFTER `keyword`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `follows`  int(11) NULL DEFAULT 0 AFTER `times`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `isdefault`  tinyint(3) NULL DEFAULT 0 AFTER `follows`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `resptitle`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `isdefault`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `respthumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `resptitle`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `createtime`  int(11) NULL DEFAULT 0 AFTER `respthumb`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `respdesc`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `createtime`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `respurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `respdesc`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `waittext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `respurl`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `oktext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `waittext`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `subcredit`  int(11) NULL DEFAULT 0 AFTER `oktext`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `submoney`  decimal(10,2) NULL DEFAULT 0.00 AFTER `subcredit`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `reccredit`  int(11) NULL DEFAULT 0 AFTER `submoney`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `recmoney`  decimal(10,2) NULL DEFAULT 0.00 AFTER `reccredit`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `scantext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `recmoney`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `subtext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `scantext`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `beagent`  tinyint(3) NULL DEFAULT 0 AFTER `subtext`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `bedown`  tinyint(3) NULL DEFAULT 0 AFTER `beagent`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `isopen`  tinyint(3) NULL DEFAULT 0 AFTER `bedown`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `opentext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `isopen`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `openurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `opentext`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `paytype`  tinyint(1) NOT NULL DEFAULT 0 AFTER `openurl`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `templateid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `paytype`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `subpaycontent`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `templateid`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `recpaycontent`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `subpaycontent`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `entrytext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `recpaycontent`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `reccouponid`  int(11) NULL DEFAULT 0 AFTER `entrytext`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `reccouponnum`  int(11) NULL DEFAULT 0 AFTER `reccouponid`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `subcouponid`  int(11) NULL DEFAULT 0 AFTER `reccouponnum`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `subcouponnum`  int(11) NULL DEFAULT 0 AFTER `subcouponid`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `resptype`  tinyint(3) NULL DEFAULT 0 AFTER `subcouponnum`;
ALTER TABLE `ims_superdesk_shop_poster` MODIFY COLUMN `resptext`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `resptype`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `type`  tinyint(3) NULL DEFAULT 0 COMMENT '1 首页 2 小店 3 商城 4 自定义' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `isdefault`  tinyint(3) NULL DEFAULT 0 AFTER `keyword`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `resptitle`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `isdefault`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `respthumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `resptitle`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `createtime`  int(11) NULL DEFAULT 0 AFTER `respthumb`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `respdesc`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `createtime`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `respurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `respdesc`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `waittext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `respurl`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `oktext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `waittext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `subcredit`  int(11) NULL DEFAULT 0 AFTER `oktext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `submoney`  decimal(10,2) NULL DEFAULT 0.00 AFTER `subcredit`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `reccredit`  int(11) NULL DEFAULT 0 AFTER `submoney`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `recmoney`  decimal(10,2) NULL DEFAULT 0.00 AFTER `reccredit`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `scantext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `recmoney`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `subtext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `scantext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `beagent`  tinyint(3) NULL DEFAULT 0 AFTER `subtext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `bedown`  tinyint(3) NULL DEFAULT 0 AFTER `beagent`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `isopen`  tinyint(3) NULL DEFAULT 0 AFTER `bedown`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `opentext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `isopen`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `openurl`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `opentext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `paytype`  tinyint(1) NOT NULL DEFAULT 0 AFTER `openurl`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `subpaycontent`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `paytype`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `recpaycontent`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `subpaycontent`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `templateid`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `recpaycontent`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `entrytext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `templateid`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `reccouponid`  int(11) NULL DEFAULT 0 AFTER `entrytext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `reccouponnum`  int(11) NULL DEFAULT 0 AFTER `reccouponid`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `subcouponid`  int(11) NULL DEFAULT 0 AFTER `reccouponnum`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `subcouponnum`  int(11) NULL DEFAULT 0 AFTER `subcouponid`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `timestart`  int(11) NULL DEFAULT 0 AFTER `subcouponnum`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `timeend`  int(11) NULL DEFAULT 0 AFTER `timestart`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `status`  tinyint(3) NULL DEFAULT 0 AFTER `timeend`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `goodsid`  int(11) NULL DEFAULT 0 AFTER `status`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `starttext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `goodsid`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `endtext`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `starttext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `resptype`  tinyint(3) NULL DEFAULT 0 AFTER `endtext`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `resptext`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `resptype`;
ALTER TABLE `ims_superdesk_shop_postera` MODIFY COLUMN `testflag`  tinyint(1) NULL DEFAULT 0 AFTER `resptext`;

ALTER TABLE `ims_superdesk_shop_poster_qr` MODIFY COLUMN `scenestr`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `qrimg`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `title`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `uniacid`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `name`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `title`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `tel`  varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `name`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `mobile`  varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `tel`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `province`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `mobile`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `city`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `province`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `area`  varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `city`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `address`  varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `area`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `isdefault`  tinyint(1) NULL DEFAULT 0 AFTER `address`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `zipcode`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `isdefault`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `content`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `zipcode`;
ALTER TABLE `ims_superdesk_shop_refund_address` MODIFY COLUMN `deleted`  tinyint(1) NULL DEFAULT 0 AFTER `content`;
ALTER TABLE `ims_superdesk_shop_store` MODIFY COLUMN `realname`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `status`;
ALTER TABLE `ims_superdesk_shop_store` MODIFY COLUMN `mobile`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `realname`;
ALTER TABLE `ims_superdesk_shop_store` MODIFY COLUMN `fetchtime`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `mobile`;
...
DELAY_KEY_WRITE=0
;
INSERT INTO `ims_superdesk_shop_plugin` (`id`, `displayorder`, `identity`, `name`, `version`, `author`, `status`, `category`, `thumb`, `desc`, `iscom`, `deprecated`, `isv2`) VALUES ('62', '35', 'task', '任务中心', '1.0', '官方', '1', 'sale', '../addons/superdesk_shopv2/static/images/task.jpg', '', '0', '0', '1');
");