...
class ms_integral_temporary_memberModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_integral_temporary_member";

    public $table_column_all = "temporary_member_id,phone,ctime,pk_code,state,mid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['temporary_member_id'] = '';//  | NO | int(255) | 
    $insert_data['phone'] = '';//  | YES | varchar(255) | 
    $insert_data['ctime'] = '';//  | YES | datetime | 
    $insert_data['pk_code'] = '';//  | YES | varchar(255) | 
    $insert_data['state'] = '';//  | YES | int(20) | 
    $insert_data['mid'] = '';// 会员id | YES | varchar(20) | 
