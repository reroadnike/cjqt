...
class jd_product_duplicateModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "jd_product_duplicate";

    public $table_column_all = "id,classify_id,sku,ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['classify_id'] = '';//  | YES | int(10) | 
    $insert_data['sku'] = '';//  | YES | varchar(255) | 
