 ...
 *
 * 企业采购
 * view-source:http://192.168.1.124/superdesk/app/index.php?i=16&c=entry&m=superdesk_jd_vop&do=patch_build_window_superdesk_shop_setup_04_insert_shop_member_uuid
 * view-source:https://wxm.avic-s.com/app/index.php?i=16&c=entry&m=superdesk_jd_vop&do=patch_build_window_superdesk_shop_setup_04_insert_shop_member_uuid
 * view-source:https://bmt.superdesk.cn/app/index.php?i=16&c=entry&m=superdesk_jd_vop&do=patch_build_window_superdesk_shop_setup_04_insert_shop_member_uuid
 */
    ...
    foreach ($memberList as $mv) {
        ...
        foreach($table_array as &$tv){
            ...
            pdo_update($table_name,
                array(
                    'shop_member_uuid' => $mv['shop_member_uuid']
                ),
                array(
                    'openid' => $mv['openid']
                )
