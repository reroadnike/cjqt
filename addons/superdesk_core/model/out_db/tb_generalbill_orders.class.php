...
class tb_generalbill_ordersModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_generalbill_orders";

    public $table_column_all = "ID,serviceName,serviceCode,orderNum,goodId,goodName,amount,price,totalFee,orderTime,billId,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['serviceName'] = '';// 服务类型名称 | YES | varchar(100) | 
    $insert_data['serviceCode'] = '';// 服务分类编码 | YES | varchar(20) | 
    $insert_data['orderNum'] = '';// 订单号 | YES | varchar(200) | 
    $insert_data['goodId'] = '';// 商品ID | YES | int(11) | 
    $insert_data['goodName'] = '';// 商品名称 | YES | varchar(100) | 
    $insert_data['amount'] = '';// 订购数量 | YES | int(11) | 
    $insert_data['price'] = '';// 单价 | YES | decimal(11,2) | 
    $insert_data['totalFee'] = '';// 总额 | YES | decimal(11,2) | 
    $insert_data['orderTime'] = '';// 订单创建日期 | YES | datetime | 
    $insert_data['billId'] = '';// 账单ID | YES | int(11) | 
    ...
    $insert_data['isEnabled'] = '';// 是否可用（1-可用，0-删除） | YES | char(1) | 
