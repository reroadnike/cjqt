...
echo "<br/>";echo "<br/>";echo "<br/>";echo "检查am result";echo "<br/>";echo "<br/>";echo "<br/>";
foreach ($result_am as $index => $_time){
    echo json_encode($_time);
    echo "<br/>";
}
echo "<br/>";echo "<br/>";echo "<br/>";echo "检查pm result";echo "<br/>";echo "<br/>";echo "<br/>";
...
//
//echo $_redis->ishExists($key, $hkey);
//echo "<br/>";

//$tmp_value = 0;
//if ($_redis->ishExists($key, $hkey) == 1) {
//    $tmp_value = $_redis->hget($key, $hkey);
////    $tmp_value = intval($tmp_value) + 1;
////    $_redis->hset($key, $hkey, $tmp_value);
//} else {
//    $_redis->hset($key, $hkey, $tmp_value);
//}
