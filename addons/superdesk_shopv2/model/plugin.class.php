...
class pluginModel
{
    ...
    public $table_name = "superdesk_shop_plugin";

    public $table_column_all = "id,displayorder,identity,name,version,author,status,category,isv2,thumb,desc,iscom,deprecated";
