...
class groups_orderModel
{

    public $table_name = "superdesk_shop_groups_order";

    public $table_column_all = "id,uniacid,openid,orderno,groupnum,paytime,credit,creditmoney,price,freight,status,pay_type,dispatchid,addressid,address,goodid,teamid,is_team,heads,discount,starttime,canceltime,endtime,createtime,finishtime,refundid,refundstate,refundtime,express,expresscom,expresssn,sendtime,remark,remarkclose,remarksend,message,success,deleted,realname,mobile,isverify,verifytype,verifycode,verifynum,printstate,printstate2,apppay,delete,isborrow,borrowopenid";
