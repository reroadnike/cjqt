...
class tr_app_role_functionModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_app_role_function";

    public $table_column_all = "ID,ROLEID,FUNCTION_ID,OPERATE_STR";
    ...
    $insert_data['ROLEID'] = '';//  | YES | int(11) | 
    $insert_data['FUNCTION_ID'] = '';//  | YES | int(11) | 
    $insert_data['OPERATE_STR'] = '';// 1-新增，2-修改，3-删除，多个用;隔开 | YES | varchar(50) | 
