...
class sys_user_roleModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sys_user_role";

    public $table_column_all = "user_role_id,role_id,user_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['user_role_id'] = '';//  | NO | int(11) | 
    $insert_data['role_id'] = '';//  | YES | int(11) | 
