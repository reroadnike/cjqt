...
$key     = 'superdesk_jd_vop_' . 'web_jd_vop_product_manage' . ':' . $_W['uniacid'];
...
if ($_redis->isExists($key) == 1) {
    ...
    $zNodes = $_categoryModel->zTreeV3Data(array('enabled'=>1));
    $_redis->set($key, $zNodes);
}



include $this->template('jd_vop_product_manage');