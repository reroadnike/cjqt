...
class enterprise_perm_roleModel
{

    public $table_name = "superdesk_shop_enterprise_perm_role";

    public $table_column_all = "id,uniacid,enterpriseid,rolename,status,perms,deleted";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['enterpriseid'] = '0';//  | YES | int(11) | 0
