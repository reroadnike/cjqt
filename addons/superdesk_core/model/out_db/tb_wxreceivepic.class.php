...
class tb_wxreceivepicModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceivepic";

    public $table_column_all = "ID,developId,openId,createTime,picUrl,mediaId,msgId";
    ...
    $insert_data['picUrl'] = '';// 图片链接 | YES | varchar(200) | 
