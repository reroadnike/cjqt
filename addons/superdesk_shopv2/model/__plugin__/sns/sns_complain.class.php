...
class sns_complainModel
{

    public $table_name = "superdesk_shop_sns_complain";

    public $table_column_all = "id,uniacid,type,postsid,defendant,complainant,complaint_type,complaint_text,images,createtime,checkedtime,checked,checked_note,deleted";
