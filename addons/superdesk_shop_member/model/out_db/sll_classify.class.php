...
class sll_classifyModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_classify";

    public $table_column_all = "classify_id,classify_name,classify_status,classify_pic,classify_sort,classify_ctime,classify_pid,page_num,classify_isshow,classify_main_pic";
    ...
    public function saveOrUpdateByJdVop($params, $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
            $insert_data['classify_id']       = '';//  | NO | int(11) |
            $insert_data['classify_name']     = '';// 分类名称 | YES | varchar(100) |
            $insert_data['classify_status']   = '';// 0：废弃 1：使用  | YES | int(10) |
            $insert_data['classify_pic']      = '';// 图片 | YES | varchar(255) |
            $insert_data['classify_sort']     = '';// 排序 | YES | int(11) | 
            $insert_data['classify_ctime']    = '';//  | YES | datetime |
            $insert_data['classify_pid']      = '';// 父类id | YES | int(11) |
            $insert_data['page_num']          = '';//  | YES | varchar(255) |
            $insert_data['classify_isshow']   = '0';// 是否显示，1显示0不显示 | YES | int(1) | 0
            $insert_data['classify_main_pic'] = '';// 主图片 | YES | varchar(255) |
...
//        );
        ...
        $list  = $this->pdo_fetchall(
            ...
            " ORDER BY classify_pid ASC ,classify_id ASC LIMIT " . ($page - 1) * $page_size . ',' . $page_size,
            $params,
            'classify_id');
