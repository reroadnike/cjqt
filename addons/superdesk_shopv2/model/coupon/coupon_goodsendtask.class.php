...
class coupon_goodsendtaskModel
{

    public $table_name = "superdesk_shop_coupon_goodsendtask";

    public $table_column_all = "id,uniacid,goodsid,couponid,starttime,endtime,sendnum,num,sendpoint,status";
