...
class wx_areplyModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_areply";

    public $table_column_all = "id,keyword,content,uid,uname,createtime,updatetime,token,home,check_box";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['keyword'] = '';// 关键字 | YES | varchar(100) | 
    $insert_data['content'] = '';// 回复内容 | NO | text | 
    $insert_data['uid'] = '';//  | NO | int(11) | 
    $insert_data['uname'] = '';//  | NO | varchar(90) | 
    $insert_data['token'] = '';//  | NO | char(30) | 
    $insert_data['home'] = '0';//  | NO | varchar(1) | 0
    $insert_data['check_box'] = '0';// 图文回复是否选中0 1 | YES | int(1) | 0
