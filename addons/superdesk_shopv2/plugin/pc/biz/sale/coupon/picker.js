define(['core', 'tpl'], function (core, tpl) {
    ...
    var CouponPicker = function (params) {
        ...
        self.show = function () {
            ...
            modal.picker.show();
            $('.coupon-picker').find('.coupon-item.selected').removeClass('selected');
            $('.coupon-picker').find(".coupon-item[data-couponid='" + self.params.couponid + "']").addClass('selected');
            ...
            $('.coupon-picker').find('.btn-confirm').click(function () {
                var item = $('.coupon-picker').find('.coupon-item.selected');
                if (item.length <= 0) {
