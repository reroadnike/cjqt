...
class wx_wechat_groupModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_wechat_group";

    public $table_column_all = "id,wechatgroupid,name,intro,token,fanscount";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['wechatgroupid'] = '';//  | NO | varchar(20) | 
    $insert_data['name'] = '';//  | NO | varchar(60) | 
    $insert_data['intro'] = '';//  | NO | varchar(200) | 
    $insert_data['token'] = '';//  | NO | varchar(30) | 
    $insert_data['fanscount'] = '0';//  | NO | int(10) | 0
