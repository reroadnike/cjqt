...
class diypage_templateModel
{

    public $table_name = "superdesk_shop_diypage_template";

    public $table_column_all = "id,uniacid,type,name,data,preview,tplid,cate,deleted";
