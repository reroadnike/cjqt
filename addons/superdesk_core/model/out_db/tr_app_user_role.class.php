...
class tr_app_user_roleModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_app_user_role";

    public $table_column_all = "USER_ID,ROLE_ID";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['USER_ID'] = '';// 用户ID | NO | int(11) | 
    $insert_data['ROLE_ID'] = '';// 角色ID | NO | int(11) | 
