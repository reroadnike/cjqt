...
class boardroom_s_dispatchModel
{

    public $table_name = "superdesk_boardroom_4school_s_dispatch";

    public $table_column_all = "id,uniacid,dispatchname,dispatchtype,displayorder,firstprice,secondprice,firstweight,secondweight,express,description,enabled,";
