...
class task_poster_qrModel
{

    public $table_name = "superdesk_shop_task_poster_qr";

    public $table_column_all = "id,acid,openid,posterid,type,sceneid,mediaid,ticket,url,createtime,qrimg,expire,endtime";
