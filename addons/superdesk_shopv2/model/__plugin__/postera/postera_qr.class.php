...
class postera_qrModel
{

    public $table_name = "superdesk_shop_postera_qr";

    public $table_column_all = "id,acid,openid,posterid,type,sceneid,mediaid,ticket,url,createtime,goodsid,qrimg,expire,endtime,qrtime";
