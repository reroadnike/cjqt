...
class article_shareModel
{

    public $table_name = "superdesk_shop_article_share";

    public $table_column_all = "id,aid,share_user,click_user,click_date,add_credit,add_money,uniacid";
