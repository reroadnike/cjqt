...
class tb_wxreceiverecordModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceiverecord";

    public $table_column_all = "ID,developId,openId,infoType,msgType,msgId,eventType,eventId,createTime";
    ...
    $insert_data['developId'] = '';// 开发者微信号 | YES | varchar(40) | 
    $insert_data['openId'] = '';// 发送方帐号 | YES | varchar(40) | 
    $insert_data['infoType'] = '';// 消息类型(1普通、2事件) | YES | char(1) | 
    $insert_data['msgType'] = '';// 普通信息类型 | YES | varchar(20) | 
    $insert_data['msgId'] = '';// 普通信息ID | YES | int(11) | 
    $insert_data['eventType'] = '';// 1关注、2二维码、3下拉菜单 | YES | char(1) | 
    $insert_data['eventId'] = '';// 事件Id | YES | int(11) | 
