...
class tb_wxtwoeventModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxtwoevent";

    public $table_column_all = "ID,developId,openId,eventType,createTime,eventKey,ticket";
    ...
    $insert_data['eventKey'] = '';// 事件KEY值 | YES | varchar(45) | 
    $insert_data['ticket'] = '';// 二维码的ticket | YES | varchar(128) | 
