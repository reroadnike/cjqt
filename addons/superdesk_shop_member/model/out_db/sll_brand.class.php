...
class sll_brandModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_brand";

    public $table_column_all = "brand_id,brand_name,status";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['brand_id'] = '';//  | NO | int(11) | 
    $insert_data['brand_name'] = '';// 品牌名称 | YES | varchar(100) | 
