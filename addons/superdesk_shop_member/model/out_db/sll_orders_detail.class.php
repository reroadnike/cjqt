...
class sll_orders_detailModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_orders_detail";

    public $table_column_all = "orders_detail_id,goodsid,pro_price,total_price,number,ctime,orderid,jdcOrder,agreementprice";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['orders_detail_id'] = '';//  | NO | int(11) | 
    $insert_data['goodsid'] = '';//  | YES | int(11) | 
    $insert_data['pro_price'] = '';// 单价 | YES | float(10,2) | 
    $insert_data['total_price'] = '';//  | YES | float(10,2) | 
    $insert_data['number'] = '';//  | YES | int(11) | 
    $insert_data['ctime'] = '';//  | YES | datetime | 
    $insert_data['orderid'] = '';//  | YES | varchar(100) | 
    $insert_data['jdcOrder'] = '';//  | YES | varchar(100) | 
    $insert_data['agreementprice'] = '0.00';// 协议价 | YES | float(10,2) | 0.00
