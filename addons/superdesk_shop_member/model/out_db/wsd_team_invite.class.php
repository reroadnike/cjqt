...
class wsd_team_inviteModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wsd_team_invite";

    public $table_column_all = "team_invite_id,team_invite_ctime,team_invite_etime,team_invite_state,team_invite_openid,team_invite_code,team_invite_tel,team_invite_token,team_invite_relation";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['team_invite_id'] = '';//  | NO | int(11) | 
    $insert_data['team_invite_ctime'] = '';//  | YES | datetime | 
    $insert_data['team_invite_etime'] = '';//  | YES | datetime | 
    $insert_data['team_invite_state'] = '';//  | YES | int(11) | 
    $insert_data['team_invite_openid'] = '';//  | YES | varchar(255) | 
    $insert_data['team_invite_code'] = '';//  | YES | varchar(255) | 
    $insert_data['team_invite_tel'] = '';//  | YES | varchar(255) | 
    $insert_data['team_invite_token'] = '';//  | YES | varchar(255) | 
    $insert_data['team_invite_relation'] = '';//  | YES | varchar(11) | 
