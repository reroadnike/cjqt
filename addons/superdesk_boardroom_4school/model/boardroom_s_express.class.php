...
class boardroom_s_expressModel
{

    public $table_name = "superdesk_boardroom_4school_s_express";

    public $table_column_all = "id,uniacid,express_name,displayorder,express_price,express_area,express_url,";
