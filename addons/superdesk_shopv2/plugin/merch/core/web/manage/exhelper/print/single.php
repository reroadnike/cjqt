...
class Single_SuperdeskShopV2Page extends MerchWebPage
{
    private $_orderModel;
    ...
    public function getorder()
    {
        ...
        if ($_W['ispost']) {
            ...
            $sql =
                ' select o.* , a.realname,a.mobile,a.province,a.city,a.area, d.dispatchname,m.nickname,r.status as refundstatus ' .
                ' from ' . tablename('superdesk_shop_order') . ' o' .// TODO 标志 楼宇之窗 openid shop_order 已处理
                '       left join ' . tablename('superdesk_shop_order_refund') . ' r on r.orderid=o.id and ifnull(r.status,-1)<>-1' .
                '       left join ' . tablename('superdesk_shop_member') . ' m on m.openid=o.openid and m.core_user=o.core_user ' .
                '       left join ' . tablename('superdesk_shop_member_address') . ' a on o.addressid = a.id ' . // TODO 标志 楼宇之窗 openid superdesk_shop_member_address 不处理
            ...
            foreach ($list as &$value) {
                ...
                $order_goods = pdo_fetchall(
                    ' select g.id,g.title,g.shorttitle,g.thumb,g.goodssn,og.optionid,g.unit,og.goodssn as option_goodssn, g.productsn, ' .
                    '        og.productsn as option_productsn, g.weight, og.total,og.price,og.optionname as optiontitle, og.realprice, ' .
                    '        og.id as ordergoodid,og.printstate,og.printstate2 ' .
    ...
    public function changestate()
    {
        ...
        if ($_W['ispost']) {
            ...
            foreach ($arr as $i => $data) {
                ...
                $ordergood = pdo_fetch(
                    'SELECT id,goodsid,printstate,printstate2 ' .
    ...
    public function getorderinfo()
    {
        ...
        if ($_W['ispost']) {
            ...
            $printTemp = pdo_fetch(
                'SELECT id,type,expressname,express,expresscom ' .
            ...
            $orders = pdo_fetchall(
                ...
                ' WHERE ' .
                '       id in( ' . $in . ' ) ' .
                '       and (status=1 or (paytype=3 and status=0)) ' .
                '       and uniacid=:uniacid ' .
                '       and merchid=:merchid ' .
                '       and isparent=0 ' .
