...
class wx_otherModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_other";

    public $table_column_all = "id,token,keyword,info";
    ...
    $insert_data['keyword'] = '';// 回复图文关键词 | YES | varchar(60) | 
    $insert_data['info'] = '';// 回复文字内容 | YES | varchar(200) | 
