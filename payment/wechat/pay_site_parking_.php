...
$havePay = pdo_get('parking_order',array('ordernum'=>$params['out_trade_no'],'type'=>1));
if(!empty($havePay) || empty($params['openid'])){
...
pdo_insert('parking_order',$orderData);
