...
class coupon_dataModel
{

    public $table_name = "superdesk_shop_coupon_data";

    public $table_column_all = "id,uniacid,openid,couponid,gettype,used,usetime,gettime,senduid,ordersn,back,backtime,merchid,isnew,nocount";
