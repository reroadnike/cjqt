...
class abonus_levelModel
{

    public $table_name = "superdesk_shop_abonus_level";

    public $table_column_all = "id,uniacid,levelname,bonus1,bonus2,bonus3,ordermoney,ordercount,bonusmoney,downcount";
