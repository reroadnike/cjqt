...
class tb_userimageinfoModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_userimageinfo";

    public $table_column_all = "imageId,imageUrl,userId,imageFacePlusId,imageType,imageFaceUrl";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['imageId'] = '';//  | NO | int(11) | 
    $insert_data['imageUrl'] = '';//  | YES | varchar(80) | 
    $insert_data['userId'] = '';//  | YES | int(11) | 
    $insert_data['imageFacePlusId'] = '';//  | YES | int(11) | 
    $insert_data['imageType'] = '';// 1-员工,2访客 | YES | varchar(40) | 
    $insert_data['imageFaceUrl'] = '';// face图片地址 | YES | varchar(400) | 
