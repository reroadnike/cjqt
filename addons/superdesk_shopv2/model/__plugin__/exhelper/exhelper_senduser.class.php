...
class exhelper_senduserModel
{

    public $table_name = "superdesk_shop_exhelper_senduser";

    public $table_column_all = "id,uniacid,sendername,sendertel,sendersign,sendercode,senderaddress,sendercity,isdefault,merchid";
