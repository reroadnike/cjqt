...
class wx_wechat_group_listModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_wechat_group_list";

    public $table_column_all = "id,g_id,nickname,sex,province,city,headimgurl,subscribe_time,token,openid,status";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['g_id'] = '';//  | NO | varchar(20) | 
    $insert_data['nickname'] = '';//  | NO | varchar(60) | 
    $insert_data['sex'] = '';//  | NO | tinyint(1) | 
    $insert_data['province'] = '';//  | NO | varchar(20) | 
    $insert_data['city'] = '';//  | NO | varchar(30) | 
    $insert_data['headimgurl'] = '';//  | NO | varchar(200) | 
    $insert_data['subscribe_time'] = '';//  | NO | int(11) | 
    $insert_data['token'] = '';//  | NO | varchar(30) | 
    $insert_data['openid'] = '';//  | NO | varchar(60) | 
    $insert_data['status'] = '';//  | NO | tinyint(1) | 
