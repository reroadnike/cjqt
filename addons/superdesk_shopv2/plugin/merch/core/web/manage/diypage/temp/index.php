...
class Index_SuperdeskShopV2Page extends MerchWebPage
{
    public function main()
    {
        ...
        $list = pdo_fetchall(
            ...
            ' where (uniacid=:uniacid or uniacid=0) and deleted=0 ' .
            $condition .
        ...
        $category = pdo_fetchall(
            'SELECT id, name ' .
            ' FROM ' . tablename('superdesk_shop_diypage_template_category') .
            ' WHERE ' .
            '       uniacid=:uniacid ' .
            '       and merch=:merch ' .
            ' order by id desc ',
        ...
        if ($_W['ispost']) {
            ...
            if (!empty($item)) {
                ...
                if (empty($item['uniacid'])) {
                    ...
                    pdo_update(
                        'superdesk_shop_diypage_template',
                        array(
                            'deleted' => 1
                        ),
                        array(
