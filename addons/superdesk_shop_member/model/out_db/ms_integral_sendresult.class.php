...
class ms_integral_sendresultModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_integral_sendresult";

    public $table_column_all = "integral_sendresult_id,integral_sendresult_ctime,e_id,integral_sendresult_type,integral_standard_pkcode,integral_sendresult_state,integral_send_id,m_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['integral_sendresult_id'] = '';//  | NO | int(11) | 
    $insert_data['integral_sendresult_ctime'] = '';// 发送时间 | YES | datetime | 
    $insert_data['e_id'] = '';// 企业ID | YES | varchar(255) | 
    $insert_data['integral_sendresult_type'] = '';// 发送方式，0：自动，1：手动 | YES | int(11) | 
    $insert_data['integral_standard_pkcode'] = '';// 优惠券唯一ID | YES | varchar(255) | 
    $insert_data['integral_sendresult_state'] = '';// 1:完成，2：失败 | YES | int(11) | 
    $insert_data['integral_send_id'] = '';// 发送id | YES | varchar(255) | 
    $insert_data['m_id'] = '';// 用户id | YES | int(11) | 
