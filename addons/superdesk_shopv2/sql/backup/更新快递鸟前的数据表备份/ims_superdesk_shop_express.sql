...
--
-- Host: localhost
-- Generation Time: 2018-09-20 13:25:29
-- 服务器版本： 5.7.20-log
-- PHP Version: 7.2.0
...
--
-- 表的结构 `ims_superdesk_shop_express`
--
...
--
-- 转存表中的数据 `ims_superdesk_shop_express`
--
...
--
-- Indexes for table `ims_superdesk_shop_express`
--
ALTER TABLE `ims_superdesk_shop_express`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ims_superdesk_shop_express`
--
ALTER TABLE `ims_superdesk_shop_express`
