...
class bargain_accountModel
{

    public $table_name = "superdesk_shop_bargain_account";

    public $table_column_all = "id,mall_name,banner,mall_title,mall_content,mall_logo,message,partin,rule,end_message";
