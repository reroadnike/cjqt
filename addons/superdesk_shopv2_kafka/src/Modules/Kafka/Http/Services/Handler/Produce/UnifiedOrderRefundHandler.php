...
class UnifiedOrderRefundHandler
{
...
//    }
    ...
    // TODO java那边的统一订单中心   退款完成
    // 内部传入 转发到 青章银服务器的 kafka服务
    public function handle(KafkaService $kafka, array $value, $key = 'refund')
    {
        global $_W;
...
//        $topic = 'orderdev'; //配置在env中
//        $url   = '120.79.80.138:9092'; //配置在env中   统一订单中心
