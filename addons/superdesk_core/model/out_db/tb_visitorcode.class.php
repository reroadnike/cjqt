...
class tb_visitorcodeModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_visitorcode";

    public $table_column_all = "codeId,codeNumber,codeCreateTime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['codeId'] = '';//  | NO | int(11) | 
    $insert_data['codeNumber'] = '';//  | YES | int(11) | 
    $insert_data['codeCreateTime'] = '';//  | YES | datetime | 
