...
class tb_dictionary_itemModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_dictionary_item";

    public $table_column_all = "id,itemcode,itemname,groupid,isenabled,oprateversion,opratetype,createby,createtime,lastupdateby,orderno,lastupdatetime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['itemcode'] = '';//  | NO | varchar(30) | 
    $insert_data['itemname'] = '';//  | NO | varchar(30) | 
    $insert_data['groupid'] = '';//  | NO | bigint(11) | 
    $insert_data['isenabled'] = '';//  | YES | char(1) | 
    $insert_data['oprateversion'] = '';//  | YES | bigint(20) | 
    $insert_data['opratetype'] = '';//  | YES | char(1) | 
    $insert_data['createby'] = '';//  | YES | varchar(30) | 
    $insert_data['lastupdateby'] = '';//  | YES | varchar(30) | 
    $insert_data['orderno'] = '';//  | YES | int(11) | 
    $insert_data['lastupdatetime'] = '';//  | YES | datetime | 
