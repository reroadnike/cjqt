...
class wx_textModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_text";

    public $table_column_all = "id,uid,uname,keyword,precisions_type,precisions,usorts,text,createtime,updatetime,click,token,stauts,keyworduuid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['uid'] = '';//  | NO | int(11) | 
    $insert_data['uname'] = '';//  | NO | varchar(90) | 
    $insert_data['keyword'] = '';//  | NO | char(255) | 
    $insert_data['precisions_type'] = '';// 匹配类型 | NO | varchar(255) | 
    $insert_data['precisions'] = '0';//  | NO | tinyint(1) | 0
    $insert_data['usorts'] = '';// 排序 | NO | int(11) | 
    $insert_data['text'] = '';//  | NO | text | 
    $insert_data['click'] = '';//  | YES | int(11) | 
    $insert_data['token'] = '';//  | NO | char(30) | 
    $insert_data['stauts'] = '';// 0:关闭，1：开启 | YES | varchar(5) | 
