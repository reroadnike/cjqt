...
class diyform_tempModel
{

    public $table_name = "superdesk_shop_diyform_temp";

    public $table_column_all = "id,uniacid,typeid,cid,diyformfields,fields,openid,type,diyformid,diyformdata,carrier_realname,carrier_mobile";
