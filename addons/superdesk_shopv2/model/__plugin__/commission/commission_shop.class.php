...
class commission_shopModel
{

    public $table_name = "superdesk_shop_commission_shop";

    public $table_column_all = "id,uniacid,mid,name,logo,img,desc,selectgoods,selectcategory,goodsids";
