...
class member_historyModel
{

    public $table_name = "superdesk_shop_member_history";

    public $table_column_all = "id,uniacid,goodsid,openid,deleted,createtime,times,merchid";
