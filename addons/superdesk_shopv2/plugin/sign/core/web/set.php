    ...
    public function main()
    {
        ...
        if ($_W['ispost']) {
            ...
            if (empty($sys)) {
                ...
                pdo_insert('superdesk_shop_sign_set', $arr);
            } else {
                pdo_update('superdesk_shop_sign_set', $arr, array('uniacid' => $_W['uniacid']));
            }
