...
class Invoiceexport_SuperdeskShopV2Page extends WebPage
{
    ...
    protected function defaultColumns()
    {
        return array(
            ...
            //2019年5月7日 10:07:13 zjh 应宇迪要求添加
            array('title' => '运费', 'field' => 'goodsid', 'width' => 12),
        );
    }


    /**
     * view-source:http://192.168.1.124/superdesk/web/index.php?c=site&a=entry&m=superdesk_shopv2&do=web&r=finance.invoiceexport&export=1
     */
...
//            die();
            ...
            foreach ($list as $r) {
                foreach ($r['goods'] as $g) {
                    ...
                    $part_arr['realprice']             = $g['realprice'];
    ...
    public function save()
    {
        ...
        $data     = array(
            'invoice_export_templates' => $_S['shop']['invoice_export_templates']
        );
    ...
    public function gettemplate()
    {
        ...
        if (empty($tempname)) {
            ...
            $columns = $_S['shop']['invoice_export_templates'][$tempname];
        }
