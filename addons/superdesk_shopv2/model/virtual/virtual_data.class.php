...
class virtual_dataModel
{

    public $table_name = "superdesk_shop_virtual_data";

    public $table_column_all = "id,uniacid,typeid,pvalue,fields,openid,usetime,orderid,ordersn,price,merchid";
