...
class category_enterprise_discountModel
{

    public $table_name = "superdesk_shop_category_enterprise_discount";

    public $table_column_all = "id,category_id,core_enterprise,discount,createtime,updatetime";
    ...
    public function deleteByColumn($column)
    {
        ...
        pdo_delete($this->table_name, $column);
    }
