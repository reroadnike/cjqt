...
class jd_access_tokenModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "jd_access_token";

    public $table_column_all = "id,UID,Access_token,Refresh_token,time,expires_in,refresh_token_expires,client_id,client_secret,update_time";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['UID'] = '';//  | YES | varchar(225) | 
    $insert_data['Access_token'] = '';//  | YES | varchar(255) | 
    $insert_data['Refresh_token'] = '';//  | YES | varchar(255) | 
    $insert_data['time'] = '';// time 为当前时间 expire_in  为 access_token 的过期时间，秒级别，代表 86400 秒后过期，即 24 小时有效期 | YES | varchar(255) | 
    $insert_data['expires_in'] = '';// Access_token 的过期时间，秒级别,有效期 24 小时 | YES | varchar(255) | 
    $insert_data['refresh_token_expires'] = '';// refresh_token 的过期时间，毫秒级别 | YES | varchar(255) | 
    $insert_data['client_id'] = '';// 京东提供的 client_id | YES | varchar(255) | 
    $insert_data['client_secret'] = '';// 京东提供的 client_secret | YES | varchar(255) | 
    $insert_data['update_time'] = '';// 更新时间 | YES | datetime | 
