...
class creditshop_logModel
{

    public $table_name = "superdesk_shop_creditshop_log";

    public $table_column_all = "id,uniacid,logno,eno,openid,goodsid,createtime,status,paystatus,paytype,dispatchstatus,creditpay,addressid,dispatchno,usetime,express,expresssn,expresscom,verifyopenid,transid,dispatchtransid,storeid,realname,mobile,couponid,dupdate1,address";
