...
class boardroom_s_goods_optionModel
{

    public $table_name = "superdesk_boardroom_4school_s_goods_option";

    public $table_column_all = "id,goodsid,title,thumb,productprice,marketprice,costprice,stock,weight,displayorder,specs,";
