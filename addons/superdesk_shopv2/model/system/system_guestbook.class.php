...
class system_guestbookModel
{

    public $table_name = "superdesk_shop_system_guestbook";

    public $table_column_all = "id,title,content,nickname,createtime,email,clientip,mobile";
