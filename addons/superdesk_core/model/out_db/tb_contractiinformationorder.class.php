...
class tb_contractiinformationorderModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_contractiinformationorder";

    public $table_column_all = "ID,organizationId,virtualArchitectureId,orderType,userId,creator,createTime,modifier,modifyTime,isEnabled,status";
    ...
    $insert_data['organizationId'] = '';//  | YES | int(11) | 
    $insert_data['virtualArchitectureId'] = '';//  | YES | int(11) | 
    $insert_data['orderType'] = '';//  | YES | varchar(20) | 
    $insert_data['userId'] = '';//  | YES | int(11) | 
    $insert_data['creator'] = '';//  | YES | varchar(40) | 
    $insert_data['createTime'] = '';//  | YES | datetime | 
    $insert_data['modifier'] = '';//  | YES | varchar(40) | 
    $insert_data['modifyTime'] = '';//  | YES | datetime | 
    $insert_data['isEnabled'] = '';//  | YES | char(1) | 
    $insert_data['status'] = '';//  | YES | varchar(2) | 
