...
class Index_SuperdeskShopV2Page extends PcMobilePage
{
    public function main()
    {
        ...
        $advs = pdo_fetchall(
            ...
            ' from ' . tablename('superdesk_shop_creditshop_adv') .
            ' where ' .
            '       uniacid=:uniacid ' .
            '       and enabled=1 ' .
        ...
        $lotterydraws = pdo_fetchall(
            'select id, title, subtitle, credit, money, thumb,`type`,price ' .
        ...
        $exchanges = pdo_fetchall(
            'select id, title,goodstype, subtitle, credit, money, thumb,`type` ' .
            ' from ' . tablename('superdesk_shop_creditshop_goods') .
            ' where 1 ' .
            '       and uniacid=:uniacid ' .
            '       and isrecommand = 1 ' .
        ...
        $coupons = pdo_fetchall(
            'select id, title, subtitle, credit, money, thumb,`type` ' .
            ' from ' . tablename('superdesk_shop_creditshop_goods') .
            'where 1 ' .
            '       and uniacid=:uniacid ' .
            '       and isrecommand = 1 ' .
