...
class member_logModel
{

    public $table_name = "superdesk_shop_member_log";

    public $table_column_all = "id,uniacid,openid,type,logno,title,createtime,status,money,rechargetype,transid,gives,couponid,isborrow,borrowopenid,realmoney,charge,deductionmoney,remark,apppay,alipay,bankname,bankcard,realname,applytype";
