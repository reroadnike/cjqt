...
class bargain_actorModel
{

    public $table_name = "superdesk_shop_bargain_actor";

    public $table_column_all = "id,goods_id,now_price,created_time,update_time,bargain_times,openid,nickname,head_image,bargain_price,status,account_id,initiate,order";
