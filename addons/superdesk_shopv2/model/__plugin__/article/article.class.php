...
class articleModel
{
    ...
    public $table_name = "superdesk_shop_article";

    public $table_column_all = "id,article_title,resp_desc,resp_img,article_content,article_category,article_date_v,article_date,article_mp,article_author,article_readnum_v,article_readnum,article_likenum_v,article_likenum,article_linkurl,article_rule_daynum,article_rule_allnum,article_rule_credit,article_rule_money,page_set_option_nocopy,page_set_option_noshare_tl,page_set_option_noshare_msg,article_keyword,article_report,product_advs_type,product_advs_title,product_advs_more,product_advs_link,product_advs,article_state,network_attachment,uniacid,article_rule_credittotal,article_rule_moneytotal,article_rule_credit2,article_rule_money2,article_rule_creditm,article_rule_moneym,article_rule_creditm2,article_rule_moneym2,article_readtime,article_areas,article_endtime,article_hasendtime,displayorder,article_keyword2,article_advance,article_virtualadd,article_visit,article_visit_level,article_visit_tip";
