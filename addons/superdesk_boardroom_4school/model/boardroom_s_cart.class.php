...
class boardroom_s_cartModel
{

    public $table_name = "superdesk_boardroom_4school_s_cart";

    public $table_column_all = "id,uniacid,goodsid,goodstype,from_user,total,optionid,marketprice,";
