...
class tb_companyModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_company";

    public $table_column_all = "ID,code,name,shortName,logo,leaderName,leaderPhone,type,telePhone,belongGroup,address,remark,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['code'] = '';// 公司编号 | YES | varchar(50) | 
    $insert_data['name'] = '';// 公司名称 | YES | varchar(50) | 
    $insert_data['shortName'] = '';// 公司简称 | YES | varchar(50) | 
    $insert_data['logo'] = '';// 公司logo | YES | varchar(200) | 
    $insert_data['leaderName'] = '';// 负责人姓名 | YES | varchar(20) | 
    $insert_data['leaderPhone'] = '';// 负责人电话 | YES | varchar(11) | 
    $insert_data['type'] = '';// 组织服务项目类型（高校校园、小区住宅、CBD写字楼） | YES | varchar(2) | 
    $insert_data['telePhone'] = '';//  | YES | varchar(20) | 
    $insert_data['belongGroup'] = '';// 所属机构 | YES | varchar(20) | 
    $insert_data['address'] = '';// 详细地址 | YES | varchar(50) | 
    $insert_data['remark'] = '';//  | YES | varchar(50) | 
    ...
    $insert_data['isEnabled'] = '';// 是否可用，1-可用，0-不可用 | YES | char(1) | 
