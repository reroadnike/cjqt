...
class merch_category_swipeModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_category_swipe";

    public $table_column_all = "id,uniacid,title,createtime,status,displayorder,thumb";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['title'] = '';// 标题 | YES | varchar(255) | 
