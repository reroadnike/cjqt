...
class tr_staff_orgModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_staff_org";

    public $table_column_all = "ID,staffId,organizationId";
    ...
    $insert_data['staffId'] = '';// 员工ID | YES | varchar(11) | 
    $insert_data['organizationId'] = '';// 项目ID | YES | varchar(11) | 
