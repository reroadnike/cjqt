...
class groups_order_refundModel
{

    public $table_name = "superdesk_shop_groups_order_refund";

    public $table_column_all = "id,uniacid,openid,orderid,refundno,refundstatus,refundaddressid,refundaddress,content,reason,images,applytime,applycredit,applyprice,reply,refundtype,rtype,refundtime,endtime,message,operatetime,realcredit,realmoney,express,expresscom,expresssn,sendtime,returntime,rexpress,rexpresscom,rexpresssn";
