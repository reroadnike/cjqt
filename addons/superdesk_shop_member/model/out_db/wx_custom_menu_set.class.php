...
class wx_custom_menu_setModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_custom_menu_set";

    public $table_column_all = "id,token,appid,appsecret,access-token,access-time,jsapi-ticket,jsapi-time";
    ...
    $insert_data['appid'] = '';//  | NO | varchar(18) | 
    $insert_data['appsecret'] = '';//  | NO | varchar(32) | 
    $insert_data['access-token'] = '';//  | YES | varchar(255) | 
    $insert_data['access-time'] = '';//  | YES | int(11) | 
    $insert_data['jsapi-ticket'] = '';//  | YES | varchar(255) | 
    $insert_data['jsapi-time'] = '';//  | YES | int(11) | 
