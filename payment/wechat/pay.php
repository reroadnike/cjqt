...
//使用系统的 $this->pay($params) 调起支，$params['user']为用户的openid
$sl = $_GPC['ps'];
$params = @json_decode(base64_decode($sl), true);

//修正 第一次支付失败，第二次支付成功的bug  2017-04-15
//由于不是从index.php进入此文件
// bootstrap.app.inc.php 的session会丢失，导致openid和oauth_openid为空 ，
//然后会在bootstrap.app.inc.php里重新授权并sessioin保存openid
