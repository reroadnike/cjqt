...
class Role_SuperdeskShopV2Page extends WebPage
{
    public function main()
    {
        ...
        foreach ($list as &$row) {
            $row['usercount'] = pdo_fetchcolumn(
                ' select count(*) ' .
                ' from ' . tablename('superdesk_shop_perm_user') .
                ' where roleid=:roleid limit 1', array(':roleid' => $row['id']));
        }
