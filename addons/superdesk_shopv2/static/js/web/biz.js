define(['jquery'],
    function($) {
        ...
        biz.url = function(routes, params) {
            var url = './index.php?c=site&a=entry&m=superdesk_shopv2&do=web&r=' + routes.replace(/\//ig, '.');
            if (params) {
        ...
        biz.selector_new = {
            ...
            set: function(obj, data) {
                ...
                if (type == 'image') {
                    ...
                    // var url = "/web/index.php?c=site&a=entry&m=superdesk_shopv2&do=web&r=sale.package.hasoption&goodsid=" + data[key] + "";
                    var url = "./index.php?c=site&a=entry&m=superdesk_shopv2&do=web&r=sale.package.hasoption&goodsid=" + data[key] + "";
                    ...
                    html += "<td><a class='btn btn-default btn-sm' data-toggle='ajaxModal' href='" + url + "' id='optiontitle" + data[key] + "'>设置</a>" + "<input type='hidden' id='packagegoods" + data[key] + "' value='' name='packagegoods[" + data[key] + "]'></td>";
