...
class member_printer_templateModel
{

    public $table_name = "superdesk_shop_member_printer_template";

    public $table_column_all = "id,uniacid,title,type,print_title,print_style,print_data,code,qrcode,createtime";
