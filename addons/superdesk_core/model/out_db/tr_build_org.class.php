...
class tr_build_orgModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_build_org";

    public $table_column_all = "id,type,orgId,buildId,creator,createTime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['type'] = '';// 类型(1-物业、2-部门/团队) | YES | varchar(2) | 
    $insert_data['orgId'] = '';// 物业组织id | YES | int(11) | 
    $insert_data['buildId'] = '';// 楼栋地理位置id | YES | int(11) | 
