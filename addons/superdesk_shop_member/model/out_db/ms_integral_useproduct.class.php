...
class ms_integral_useproductModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_integral_useproduct";

    public $table_column_all = "integral_useproduct_id,integral_standard_pkcode,classify_id,integral_useproduct_state,classify_name,integral_useproduct_ctime,integral_useproduct_supplierID,integral_useproduct_supplierName";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['integral_useproduct_id'] = '';//  | NO | int(11) | 
    $insert_data['integral_standard_pkcode'] = '';//  | YES | varchar(255) | 
    $insert_data['classify_id'] = '';// 产品系列id | YES | int(11) | 
    $insert_data['integral_useproduct_state'] = '';// 0:表示无效，1：表示有效 | YES | int(2) | 
    $insert_data['classify_name'] = '';// 系列名 | YES | varchar(255) | 
    $insert_data['integral_useproduct_ctime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['integral_useproduct_supplierID'] = '';// 供应商ID | YES | int(10) | 
    $insert_data['integral_useproduct_supplierName'] = '';//  | YES | varchar(100) | 
