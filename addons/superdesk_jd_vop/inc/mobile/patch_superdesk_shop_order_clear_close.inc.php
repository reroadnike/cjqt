...
/**
 *
 * 删除 货到付款 与 为未支付 的 交易关闭 订单
 * Created by PhpStorm.
 * User: linjinyu
 * Date: 12/15/17
 * Time: 1:56 PM
 *
 * http://192.168.1.124/superdesk/app/index.php?i=16&c=entry&m=superdesk_jd_vop&do=patch_superdesk_shop_order_clear_close
 */
global $_GPC, $_W;
