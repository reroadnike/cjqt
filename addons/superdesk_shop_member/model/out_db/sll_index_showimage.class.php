...
class sll_index_showimageModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_index_showimage";

    public $table_column_all = "id,img_name,img_url,status,user_id,ctime,sort,fileUrl";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['img_name'] = '';//  | YES | varchar(255) | 
    $insert_data['img_url'] = '';//  | YES | varchar(255) | 
    $insert_data['status'] = '';// 0:停用  -1： 作废 1：使用 | YES | varchar(10) | 
    $insert_data['user_id'] = '0';// 创建者id | YES | int(10) | 0
    $insert_data['ctime'] = '';//  | YES | datetime | 
    $insert_data['sort'] = '';//  | YES | int(10) | 
    $insert_data['fileUrl'] = '';// 文件路径 | YES | varchar(255) | 
