...
class tb_deptModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_dept";

    public $table_column_all = "ID,name,compId,code,parentCode,leaderName,leaderPhone,remark,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['name'] = '';// 部门名称 | YES | varchar(50) | 
    $insert_data['compId'] = '';// 公司ID | YES | int(11) | 
    $insert_data['code'] = '';// 节点CODE | YES | varchar(50) | 
    $insert_data['parentCode'] = '';// 分类父CODE | YES | varchar(50) | 
