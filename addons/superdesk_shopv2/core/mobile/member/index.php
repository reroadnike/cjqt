        ...
        if ($merch_plugin && $merch_data['is_openmerch']) {
            $statics = array(
                ...
                'order_4'  => pdo_fetchcolumn(
                    'select count(*) ' .
                    ' from ' . tablename('superdesk_shop_order_goods') . // TODO 标志 楼宇之窗 openid shop_order 已处理
                    ' where ' .
                    '       openid=:openid ' .
                    '       and core_user=:core_user ' .
                    '       and rstate>0 ' .
//                    '       and refund_status=1 ' .
            ...
            $statics = array(
                ...
                'order_4'  => pdo_fetchcolumn(
                    'select count(*) from ' . tablename('superdesk_shop_order') .
                    ' where openid=:openid and core_user=:core_user and ismr=0 and refundstate=1 and isparent=0 and uniacid=:uniacid and isparent=0 limit 1', $params),// TODO 标志 楼宇之窗 openid shop_order 已处理
                'cart'     => pdo_fetchcolumn(
                    'select ' .
                    '       ifnull(sum(total),0) ' .
                    ' from ' . tablename('superdesk_shop_member_cart') . // TODO 标志 楼宇之窗 openid superdesk_shop_member_cart 已处理
        ...
        if ($plugin_coupon) {
            ...
            $sql =
                ...
                '               ))  ' .
                '           or ' .
                '               (c.timelimit =1 and c.timestart<=' . $time . ' && c.timeend>=' . $time . ')' .
                '           ) ' .
            ...
            $statics['newcoupon'] = pdo_fetchcolumn(
                'SELECT 1  ' .
                ' FROM ' . tablename('superdesk_shop_coupon_data') .// TODO 标志 楼宇之窗 openid shop_coupon_data 已处理
                ' where ' .
                '       openid=:openid ' .
                '       and core_user=:core_user ' .
                '       and uniacid=:uniacid ' .
