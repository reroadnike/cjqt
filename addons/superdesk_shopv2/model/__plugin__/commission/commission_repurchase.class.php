...
class commission_repurchaseModel
{

    public $table_name = "superdesk_shop_commission_repurchase";

    public $table_column_all = "id,uniacid,openid,year,month,repurchase,applyid";
