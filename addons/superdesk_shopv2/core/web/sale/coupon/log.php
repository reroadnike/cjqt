...
class Log_SuperdeskShopV2Page extends ComWebPage
{
    ...
    public function main()
    {
        ...
        $sql =
            ...
            ' left join ' . tablename('superdesk_shop_member') . ' m on m.openid = d.openid and m.core_user = d.core_user and m.uniacid = d.uniacid ' . // TODO 标志 楼宇之窗 openid shop_member 已处理
            ' where  1 ' .
            $condition .
        ...
        $total = pdo_fetchcolumn(
            'SELECT COUNT(*) ' .
            ' FROM ' . tablename('superdesk_shop_coupon_data') . ' d ' .
            ' left join ' . tablename('superdesk_shop_coupon') . ' c on d.couponid = c.id ' .
            ' left join ' . tablename('superdesk_shop_member') . ' m on m.openid = d.openid and m.core_user = d.core_user and m.uniacid = d.uniacid ' . // TODO 标志 楼宇之窗 openid shop_member 已处理
            'where 1 ' .
            $condition,
