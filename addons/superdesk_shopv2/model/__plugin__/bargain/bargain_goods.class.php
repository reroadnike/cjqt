...
class bargain_goodsModel
{

    public $table_name = "superdesk_shop_bargain_goods";

    public $table_column_all = "id,account_id,goods_id,end_price,start_time,end_time,status,type,user_set,rule,act_times,mode,total_time,each_time,time_limit,probability,custom,maximum,initiate,myself";
