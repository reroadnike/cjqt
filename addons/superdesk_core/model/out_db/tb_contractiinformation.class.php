...
class tb_contractiinformationModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_contractiinformation";

    public $table_column_all = "ID,organizationId,virtualArchitectureId,status,type,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['status'] = '';// 签约状态0-未签约，1-已签约 | YES | varchar(2) | 
    $insert_data['type'] = '';//  | YES | varchar(20) | 
    ...
    $insert_data['isEnabled'] = '';//  | YES | varchar(2) | 
