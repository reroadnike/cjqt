...
class refund_addressModel
{

    public $table_name = "superdesk_shop_refund_address";

    public $table_column_all = "id,uniacid,openid,title,name,tel,mobile,province,city,area,address,isdefault,zipcode,content,deleted,merchid";
