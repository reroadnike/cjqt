...
class tb_wxreceivevoiceModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceivevoice";

    public $table_column_all = "ID,developId,openId,createTime,mediaId,format,msgId";
    ...
    $insert_data['format'] = '';// 语音格式 | YES | varchar(45) | 
