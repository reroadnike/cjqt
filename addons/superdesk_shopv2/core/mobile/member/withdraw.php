...
/**
 * 提现
 * Class Withdraw_SuperdeskShopV2Page
 */
class Withdraw_SuperdeskShopV2Page extends MobileLoginPage
{
    public function main()
    {
        ...
        $credit = m('member')->getCredit($_W['openid'], $_W['core_user'], 'credit2');
    ...
    public function submit()
    {
        ...
        m('member')->setCredit($_W['openid'], $_W['core_user'],
            ...
            array(
                0,
                '超级前台商城余额提现预扣除: ' . $money . ',实际到账金额:' . $realmoney . ',手续费金额:' . $deductionmoney
            )
        );
        ...
        pdo_insert('superdesk_shop_member_log', $apply);// TODO 标志 楼宇之窗 openid superdesk_shop_member_log 已处理
        $logid = pdo_insertid();
    ...
    public function getLastApply($openid, $applytype = -1)
    {
        ...
        $sql    =
            'select ' .
            '       applytype,alipay,bankname,bankcard,realname ' .
