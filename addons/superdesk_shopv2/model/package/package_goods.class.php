...
class package_goodsModel
{

    public $table_name = "superdesk_shop_package_goods";

    public $table_column_all = "id,uniacid,pid,goodsid,title,thumb,price,option,goodssn,productsn,hasoption,marketprice,packageprice,commission1,commission2,commission3";
