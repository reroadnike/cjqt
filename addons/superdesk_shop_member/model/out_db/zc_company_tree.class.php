...
class zc_company_treeModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "zc_company_tree";

    public $table_column_all = "c_id,c_name,c_pid,c_point,c_e_id,c_ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['c_id'] = '';//  | NO | int(11) | 
    $insert_data['c_name'] = '';// 名称 | YES | varchar(255) | 
    $insert_data['c_pid'] = '';// 父类id | YES | int(11) | 
    $insert_data['c_point'] = '';// 节点，1：分公司；2：部门;3：小组;4：职务 | YES | int(11) | 
    $insert_data['c_e_id'] = '';// 企业id | YES | int(11) | 
    $insert_data['c_ctime'] = '';//  | YES | datetime | 
