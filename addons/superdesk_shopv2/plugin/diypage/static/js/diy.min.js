define(['jquery.ui'], function (ui) {
    ...
    modal.getNavs = function () {
        modal.navs = {
            notice: {
                name: '公告',
                params: {
                    'iconurl': '../addons/superdesk_shopv2/plugin/diypage/static/images/default/hotdot.jpg',
                    'noticedata': '0',
                    'speed': '4',
                    'noticenum': '5'
                },
            ...
            banner: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/banner-1.jpg',
                        linkurl: '',
                    },
                    C0123456789102: {
                        imgurl: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/banner-2.jpg',
                        linkurl: '',
                    }
                }
            },
            ...
            menu: {
                ...
                data: {
                    C0123456789101: {
                        imgurl: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/icon-1.png',
                        linkurl: '',
                        text: '按钮文字1',
                        color: '#666666'
                    },
                    C0123456789102: {
                        imgurl: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/icon-2.png',
                        linkurl: '',
                        text: '按钮文字2',
                        color: '#666666'
                    },
                    C0123456789103: {
                        imgurl: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/icon-3.png',
                        linkurl: '',
                        text: '按钮文字3',
                        color: '#666666'
                    },
                    C0123456789104: {
                        imgurl: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/icon-4.png',
                        linkurl: '',
                        text: '按钮文字4',
                        color: '#666666'
                    }
            ...
            goods: {
                ...
                data: {
                    C0123456789101: {
                        thumb: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/goods-1.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
                    ...
                    C0123456789102: {
                        thumb: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/goods-2.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
                    ...
                    C0123456789103: {
                        thumb: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/goods-3.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
                    ...
                    C0123456789104: {
                        thumb: '../addons/superdesk_shopv2/plugin/diypage/static/images/default/goods-4.jpg',
                        price: '20.00',
                        title: '这里是商品标题',
                        gid: '',
                        bargain: 0
            ...
            detail_shop: {
                ...
                max: 1,
                params: {
                    shoplogo: "../addons/superdesk_shopv2/static/images/designer.jpg",
                    shopname: "",
                    shopdesc: "",
                    hidenum: 0,
                    leftnavtext: "全部商品",
    ...
    modal.initEditor = function (scroll) {
        ...
        if (goodsSelector > 0) {
            ...
            _this.attr({
                ...
                'data-url': biz.url('category/query'),
    ...
    modal.initTpl = function () {
        tpl.helper("imgsrc", function (src) {
            ...
            if (src.indexOf('http://') == 0 || src.indexOf('https://') == 0 || src.indexOf('../addons/superdesk_shopv2/') == 0) {
                return src
    ...
    modal.save = function (preview) {
        ...
        // console.log('modal.items:',modal.items)

        // let _keys_ = Object.keys(modal.items)

        // console.log('modal.items:',_keys_.length)

        // _keys_.forEach((_key_)=>{
        //     console.log(modal.items[_key_].id,JSON.stringify(modal.items[_key_].params))
        // })
        ...
        // console.log({id: modal.id, data: modal.data})
