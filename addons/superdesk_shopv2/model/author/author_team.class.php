...
class author_teamModel
{

    public $table_name = "superdesk_shop_author_team";

    public $table_column_all = "id,uniacid,teamno,year,month,team_count,team_ids,status,createtime,paytime";
