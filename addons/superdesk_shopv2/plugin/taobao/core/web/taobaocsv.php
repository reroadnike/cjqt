...
class Taobaocsv_SuperdeskShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        $excelurl = $_W['siteroot'] . 'addons/superdesk_shopv2/plugin/taobao/data/test.xlsx';
        $zipurl   = $_W['siteroot'] . 'addons/superdesk_shopv2/plugin/taobao/data/test.zip';
