...
class merch_perm_logModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_perm_log";

    public $table_column_all = "id,uid,uniacid,name,type,op,ip,createtime,merchid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['uid'] = '0';//  | YES | int(11) | 0
    $insert_data['name'] = '';//  | YES | varchar(255) | 
    $insert_data['type'] = '';//  | YES | varchar(255) | 
    $insert_data['op'] = '';//  | YES | text | 
    $insert_data['ip'] = '';//  | YES | varchar(255) | 
    $insert_data['merchid'] = '0';//  | YES | int(11) | 0
