...
class member_addressModel
{

    public $table_name = "superdesk_shop_member_address";

    public $table_column_all = "id,uniacid,openid,core_user,realname,mobile,
    province,city,area,town,
    address,
    isdefault,zipcode,deleted,
    jd_vop_province_code,jd_vop_city_code,jd_vop_county_code,jd_vop_town_code,jd_vop_area";
    ...
    public function getById($addressid, $uniacid, $openid)
    {
        $address = pdo_fetch(
    ...
    {
        $address = pdo_fetch(
//            ' select id,realname,mobile,address,province,city,area ' .
            ' select ' . $this->table_column_all . ' ' .
            ' from ' . tablename($this->table_name) .
            ' where openid=:openid ' .
