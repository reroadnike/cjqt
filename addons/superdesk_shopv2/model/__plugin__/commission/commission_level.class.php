...
class commission_levelModel
{

    public $table_name = "superdesk_shop_commission_level";

    public $table_column_all = "id,uniacid,levelname,commission1,commission2,commission3,commissionmoney,ordermoney,downcount,ordercount,withdraw,repurchase";
