 ...
 * Time: 4:22 PM
 */
class SuperdeskCoreBaseOutDbModel
{
    function pdo()
    {
        global $_W;
        static $db_model_superdesk_core;
        if (empty($db_model_superdesk_core)) {
...
//            $database_config_superdesk_core = array(
...
//            );
            ...
            $db_model_superdesk_core = new \DB('superdesk_core');
        }
        return $db_model_superdesk_core;
    }
