...
class ms_integral_tem_import_member_noteModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_integral_tem_import_member_note";

    public $table_column_all = "n_import_id,n_import_time,n_import_status,n_import_fileName,n_import_file_downUrl,n_import_number,n_code,integral_standard_pkcode,status,n_import_num,num";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['n_import_id'] = '';//  | NO | int(11) | 
    $insert_data['n_import_time'] = '';// 导入时间 | YES | datetime | 
    $insert_data['n_import_status'] = '';// 导状态0:失败 1成功 | YES | int(11) | 
    $insert_data['n_import_fileName'] = '';// 导入数据文件的文件名 | YES | varchar(255) | 
    $insert_data['n_import_file_downUrl'] = '';// 导入数据文件下载地址 | YES | varchar(255) | 
    $insert_data['n_import_number'] = '';// 操作结果数 | YES | int(11) | 
    $insert_data['n_code'] = '';// 批量code | YES | varchar(255) | 
    $insert_data['integral_standard_pkcode'] = '';// 规则code | YES | varchar(255) | 
    $insert_data['status'] = '0';// 0:未发送1:已 | YES | int(11) | 0
    $insert_data['n_import_num'] = '';// 上传总数 | YES | int(11) | 
    $insert_data['num'] = '';// 发送数量 | YES | int(11) | 
