...
class merch_advModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_adv";

    public $table_column_all = "id,uniacid,advname,link,thumb,displayorder,enabled,merchid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['advname'] = '';// 幻灯片名称 | YES | varchar(50) | 
    $insert_data['link'] = '';// 幻灯片链接 | YES | varchar(255) | 
    $insert_data['thumb'] = '';// 幻灯片图片 | YES | varchar(255) | 
    $insert_data['displayorder'] = '';// 显示顺序 | YES | int(11) | 
    $insert_data['enabled'] = '';// 是否显示 | YES | int(11) | 
    $insert_data['merchid'] = '0';// 商户号ID | YES | int(11) | 0
