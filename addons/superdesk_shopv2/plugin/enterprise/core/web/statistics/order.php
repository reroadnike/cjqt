...
class Order_SuperdeskShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        $condition =
            ' and o.uniacid=:uniacid ' . // 特定公众号
            ' and o.enterprise_id>0 ' . // 非总企业
            ' and o.status>=1'; // 待收货 已完成
        ...
        if (!empty($searchfield) && !empty($_GPC['keyword'])) {
            if ($searchfield == 'ordersn') {
                ...
                $condition .= ' and u.enterprise_name like :keyword';
            }
        ...
        $sql =
            ' select o.*, a.realname as addressname,m.realname,u.enterprise_name ' .
