...
class order_commentModel
{

    public $table_name = "superdesk_shop_order_comment";

    public $table_column_all = "id,uniacid,orderid,goodsid,openid,nickname,headimgurl,level,content,images,createtime,deleted,append_content,append_images,reply_content,reply_images,append_reply_content,append_reply_images,istop,checked,replychecked";
