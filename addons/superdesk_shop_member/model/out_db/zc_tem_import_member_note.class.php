...
class zc_tem_import_member_noteModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "zc_tem_import_member_note";

    public $table_column_all = "n_import_id,n_import_time,n_import_status,n_import_fileName,n_import_file_downUrl,n_import_number,n_code,coupon_standard_pkcode,status,n_import_num,num";
    ...
    $insert_data['coupon_standard_pkcode'] = '';// 规则code | YES | varchar(255) | 
