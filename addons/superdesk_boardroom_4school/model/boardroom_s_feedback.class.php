...
class boardroom_s_feedbackModel
{

    public $table_name = "superdesk_boardroom_4school_s_feedback";

    public $table_column_all = "id,uniacid,openid,type,status,feedbackid,transid,reason,solution,remark,createtime,";
