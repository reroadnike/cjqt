...
class sys_role_submoduleModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sys_role_submodule";

    public $table_column_all = "id,role_id,sub_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['role_id'] = '';// 角色id | NO | int(9) | 
    $insert_data['sub_id'] = '';// 子模块id | NO | int(9) | 
