...
class task_posterModel
{

    public $table_name = "superdesk_shop_task_poster";

    public $table_column_all = "id,uniacid,days,title,bg,data,keyword,resptype,resptext,resptitle,respthumb,respdesc,respurl,createtime,waittext,oktext,scantext,beagent,bedown,timestart,timeend,is_repeat,getposter,status,starttext,endtext,reward_data,needcount,is_delete";
