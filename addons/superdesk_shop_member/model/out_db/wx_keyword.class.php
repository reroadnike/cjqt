...
class wx_keywordModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_keyword";

    public $table_column_all = "keywordid,keyword,token,module,ctime,state,keyworduuid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['keywordid'] = '';//  | NO | int(11) | 
    $insert_data['keyword'] = '';//  | YES | varchar(100) | 
    $insert_data['token'] = '';//  | YES | varchar(100) | 
    $insert_data['module'] = '';// keyword存在的表名 | YES | varchar(50) | 
    $insert_data['ctime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['state'] = '';// 1:表示启用，0表示停用 | YES | int(11) | 
    $insert_data['keyworduuid'] = '';//  | YES | varchar(100) | 
