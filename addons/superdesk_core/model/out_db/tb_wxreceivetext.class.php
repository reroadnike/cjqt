...
class tb_wxreceivetextModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceivetext";

    public $table_column_all = "ID,developId,openId,createTime,text,msgId";
    ...
    $insert_data['text'] = '';// 消息内容 | YES | text | 
