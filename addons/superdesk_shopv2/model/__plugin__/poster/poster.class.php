...
class posterModel
{
    ...
    public $table_name = "superdesk_shop_poster";

    public $table_column_all = "id,uniacid,type,title,bg,data,keyword,keyword2,times,follows,isdefault,resptype,resptext,resptitle,respthumb,createtime,respdesc,respurl,waittext,oktext,subcredit,submoney,reccredit,recmoney,scantext,subtext,beagent,bedown,isopen,opentext,openurl,paytype,subpaycontent,recpaycontent,templateid,entrytext,reccouponid,reccouponnum,subcouponid,subcouponnum,resptext11,reward_totle";
