...
class ms_coupon_useproductModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_coupon_useproduct";

    public $table_column_all = "coupon_useproduct_id,coupon_standard_pkcode,classify_id,coupon_useproduct_state,classify_name,coupon_useproduct_ctime,coupon_useproduct_supplierID,coupon_useproduct_supplierName";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['coupon_useproduct_id'] = '';//  | NO | int(11) | 
    $insert_data['coupon_standard_pkcode'] = '';//  | YES | varchar(255) | 
    $insert_data['classify_id'] = '';// 产品系列id | YES | int(11) | 
    $insert_data['coupon_useproduct_state'] = '';// 0:表示无效，1：表示有效 | YES | int(2) | 
    $insert_data['classify_name'] = '';// 系列名 | YES | varchar(255) | 
    $insert_data['coupon_useproduct_ctime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['coupon_useproduct_supplierID'] = '';// 供应商ID | YES | int(10) | 
    $insert_data['coupon_useproduct_supplierName'] = '';//  | YES | varchar(100) | 
