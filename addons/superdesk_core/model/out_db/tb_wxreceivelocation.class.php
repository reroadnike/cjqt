...
class tb_wxreceivelocationModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceivelocation";

    public $table_column_all = "ID,developId,openId,createTime,location_X,location_Y,scale,label,msgId";
    ...
    $insert_data['openId'] = '';// 微信帐号 | YES | varchar(40) | 
    $insert_data['createTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['location_X'] = '';// 维度 | YES | varchar(45) | 
    $insert_data['location_Y'] = '';// 经度 | YES | varchar(45) | 
    $insert_data['scale'] = '';// 大小 | YES | int(11) | 
    $insert_data['label'] = '';// 位置信息 | YES | varchar(45) | 
    $insert_data['msgId'] = '';// 消息id | YES | int(11) | 
