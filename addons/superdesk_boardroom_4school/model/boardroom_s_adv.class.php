...
class boardroom_s_advModel
{

    public $table_name = "superdesk_boardroom_4school_s_adv";

    public $table_column_all = "id,uniacid,advname,link,thumb,displayorder,enabled,";
