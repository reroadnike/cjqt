...
class abonus_billpModel
{

    public $table_name = "superdesk_shop_abonus_billp";

    public $table_column_all = "id,uniacid,billid,openid,payno,paytype,bonus1,bonus2,bonus3,money1,realmoney1,paymoney1,money2,realmoney2,paymoney2,money3,realmoney3,paymoney3,chargemoney1,chargemoney2,chargemoney3,charge,status,reason,paytime";
