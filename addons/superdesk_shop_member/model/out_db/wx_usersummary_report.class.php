...
class wx_usersummary_reportModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_usersummary_report";

    public $table_column_all = "id,subscribed,cancle,newadd,cumulate,days,token";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['subscribed'] = '';// 关注人数 | YES | int(11) | 
    $insert_data['cancle'] = '';// 取关人数 | YES | int(11) | 
    $insert_data['newadd'] = '';// 新增人数 | YES | int(11) | 
    $insert_data['cumulate'] = '';// 累积增长人数 | YES | int(11) | 
    $insert_data['days'] = '';//  | YES | varchar(20) | 
