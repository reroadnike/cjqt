...
class tb_app_business_logModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_app_business_log";

    public $table_column_all = "ID,TYPE,OPERATOR_ID,OPERATOR_NAME,OPERATOR_TIME,OPERATOR_OBJECT_KEY,OPERATOR_METHOD_KEY,OPERATOR_CONTENT,LOGINIP";
    ...
    $insert_data['TYPE'] = '';// 类型 | NO | int(11) | 
    $insert_data['OPERATOR_ID'] = '';// 操作人 | NO | int(11) | 
    $insert_data['OPERATOR_NAME'] = '';// 操作人名 | YES | varchar(20) | 
    $insert_data['OPERATOR_TIME'] = '';// 操作时间 | YES | datetime | 
    $insert_data['OPERATOR_OBJECT_KEY'] = '';// 操作业务 | YES | varchar(50) | 
    $insert_data['OPERATOR_METHOD_KEY'] = '';// 操作方法 | YES | varchar(50) | 
    $insert_data['OPERATOR_CONTENT'] = '';// 描述 | YES | varchar(255) | 
    $insert_data['LOGINIP'] = '';// 登录Ip | YES | varchar(32) | 
