...
class tb_visitororderModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_visitororder";

    public $table_column_all = "visitorOrderId,visitorOrderType,visitorOrderCreateTime,visitorOrderIsEnabled,visitorUserId,visitorOrderCount,visitorOrderStatus,visitorOrderStartTime,visitorOrderEndTime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['visitorOrderId'] = '';// 订单ID | NO | int(11) | 
    $insert_data['visitorOrderType'] = '';// 预约单类型（1 员工填写，2访客填写） | YES | varchar(40) | 
    $insert_data['visitorOrderCreateTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['visitorOrderIsEnabled'] = '';// 0-不可用,1-可用 | YES | varchar(40) | 
    $insert_data['visitorUserId'] = '';// 发起人ID | YES | int(11) | 
    $insert_data['visitorOrderCount'] = '';// 填写该订单的次数 | YES | int(11) | 
    $insert_data['visitorOrderStatus'] = '';// 预约单状态（0 未授权,1 审核通过，2审核不通过） | YES | int(11) | 
    $insert_data['visitorOrderStartTime'] = '';//  | YES | datetime | 
    $insert_data['visitorOrderEndTime'] = '';// 用户openId | YES | datetime | 
