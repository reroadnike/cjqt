...
class Express_SuperdeskShopV2Page extends PluginWebPage
{
    ...
    protected function post()
    {
        ...
        if ($_W['ispost']) {
            ...
            if (!empty($data['isdefault'])) {
                pdo_update('superdesk_shop_exhelper_express', array('isdefault' => 0), array('type' => 1, 'uniacid' => $_W['uniacid'], 'merchid' => 0));
                pdo_update('superdesk_shop_exhelper_express', array('isdefault' => 1), array('type' => 1, 'id' => $id, 'merchid' => 0));
            }
