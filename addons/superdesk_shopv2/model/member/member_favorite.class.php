...
class member_favoriteModel
{

    public $table_name = "superdesk_shop_member_favorite";

    public $table_column_all = "id,uniacid,goodsid,openid,deleted,createtime,merchid,type";
