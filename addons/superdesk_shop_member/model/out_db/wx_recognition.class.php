...
class wx_recognitionModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_recognition";

    public $table_column_all = "id,token,title,attention_num,keyword,code_url,scene_id,status,groupid,groupname";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['token'] = '';//  | NO | varchar(60) | 
    $insert_data['title'] = '';//  | NO | varchar(60) | 
    $insert_data['attention_num'] = '';//  | YES | int(5) | 
    $insert_data['keyword'] = '';//  | NO | varchar(60) | 
    $insert_data['code_url'] = '';//  | YES | varchar(200) | 
    $insert_data['scene_id'] = '';//  | YES | int(11) unsigned zerofill | 
    $insert_data['status'] = '';//  | YES | tinyint(1) | 
    $insert_data['groupid'] = '0';//  | YES | int(11) | 0
    $insert_data['groupname'] = '';//  | YES | varchar(255) | 
