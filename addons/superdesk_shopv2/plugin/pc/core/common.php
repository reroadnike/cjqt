...
function check_login()
{
    ...
    if (!empty($_W['openid']) && !empty($_W['core_user'])) {
    ...
    if (isset($_GPC[$key])) { // 先去cookie那查
        ...
        socket_log("common.php :: check_login :: " . base64_decode($_GPC[$key]));
...
function get_links()
{
    ...
    $links = pdo_fetchall(
        ' SELECT linkname,url ' .
        ' FROM ' . tablename('superdesk_shop_pc_link') .
