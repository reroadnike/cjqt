...
class ms_integral_used_recordModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_integral_used_record";

    public $table_column_all = "integral_used_record_id,integral_used_record_data_id,integral_used_record_orderid,integral_used_record_number,integral_used_record_ctime,integral_used_record_goodsid,integral_used_record_mid,integral_used_record_type";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['integral_used_record_id'] = '';// 使用记录id | NO | int(11) | 
    $insert_data['integral_used_record_data_id'] = '';// 积分数据id | YES | int(11) | 
    $insert_data['integral_used_record_orderid'] = '';// 订单id | YES | varchar(255) | 
    $insert_data['integral_used_record_number'] = '';// 使用积分数量 | YES | int(11) | 
    $insert_data['integral_used_record_ctime'] = '';// 使用积分时间 | YES | datetime | 
    $insert_data['integral_used_record_goodsid'] = '';// 商品id | YES | int(11) | 
    $insert_data['integral_used_record_mid'] = '';// 会员id | YES | int(11) | 
    $insert_data['integral_used_record_type'] = '';// 记录类型 1：使用    | YES | int(11) | 
