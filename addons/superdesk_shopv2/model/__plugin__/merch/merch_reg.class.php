...
class merch_regModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_reg";

    public $table_column_all = "id,uniacid,openid,merchname,salecate,desc,realname,mobile,status,diyformdata,diyformfields,applytime,reason";
    ...
    $insert_data['merchname'] = '';//  | YES | varchar(255) | 
    $insert_data['salecate'] = '';//  | YES | varchar(255) | 
    $insert_data['desc'] = '';//  | YES | varchar(500) | 
    $insert_data['realname'] = '';//  | YES | varchar(255) | 
    $insert_data['mobile'] = '';//  | YES | varchar(255) | 
    $insert_data['status'] = '0';//  | YES | tinyint(3) | 0
    $insert_data['diyformdata'] = '';//  | YES | text | 
    $insert_data['diyformfields'] = '';//  | YES | text | 
    $insert_data['applytime'] = '0';//  | YES | int(11) | 0
    $insert_data['reason'] = '';//  | YES | text | 
