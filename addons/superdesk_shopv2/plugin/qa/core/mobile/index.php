...
class Index_SuperdeskShopV2Page extends PluginMobilePage
{
    ...
    public function getlist()
    {
        ...
        $sql =
            'SELECT q.*, c.name as catename ' .
            ' FROM ' . tablename('superdesk_shop_qa_question') . ' q ' .
            ' left join' . tablename('superdesk_shop_qa_category') . ' c on c.id=q.cate ' .
            ' where  1 ' .
            $condition .
            ' ORDER BY q.displayorder DESC,q.id DESC ' .
    ...
    public function detail()
    {
        ...
        if (!empty($set['share'])) {
            ...
            $_W['shopshare'] = array(
                ...
                'link'   => mobileUrl('qa/detail', array('id' => $item['id']))
            );
