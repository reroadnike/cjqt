...
class coupon_sendtasksModel
{

    public $table_name = "superdesk_shop_coupon_sendtasks";

    public $table_column_all = "id,uniacid,enough,couponid,starttime,endtime,sendnum,num,sendpoint,status";
