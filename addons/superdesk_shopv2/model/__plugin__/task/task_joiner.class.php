...
class task_joinerModel
{

    public $table_name = "superdesk_shop_task_joiner";

    public $table_column_all = "complete_id,uniacid,task_user,joiner_id,join_id,task_id,task_type,join_status,addtime";
