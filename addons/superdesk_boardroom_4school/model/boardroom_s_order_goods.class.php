...
class boardroom_s_order_goodsModel
{

    public $table_name = "superdesk_boardroom_4school_s_order_goods";

    public $table_column_all = "id,uniacid,orderid,out_trade_no,goodsid,price,total,optionid,createtime,optionname,";
     ...
     * @return bool
     */
    public function getAllByColumn($column = array())
    {
        global $_GPC, $_W;
