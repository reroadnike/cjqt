...
class sms_setModel
{
    ...
    public $table_name = "superdesk_shop_sms_set";

    public $table_column_all = "id,uniacid,juhe,juhe_key,dayu,dayu_key,dayu_secret,emay,emay_url,emay_sn,emay_pw,emay_sk,emay_phost,emay_pport,emay_puser,emay_ppw,emay_out,emay_outresp,emay_warn,emay_mobile,emay_warn_time";
