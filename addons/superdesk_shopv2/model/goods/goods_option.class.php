...
class goods_optionModel
{

    public $table_name = "superdesk_shop_goods_option";

    public $table_column_all = "id,uniacid,goodsid,title,thumb,productprice,marketprice,costprice,stock,weight,displayorder,specs,skuId,goodssn,productsn,virtual";
