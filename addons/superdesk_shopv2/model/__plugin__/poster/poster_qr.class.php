...
class poster_qrModel
{

    public $table_name = "superdesk_shop_poster_qr";

    public $table_column_all = "id,acid,openid,type,sceneid,mediaid,ticket,url,createtime,goodsid,qrimg,posterid,scenestr";
