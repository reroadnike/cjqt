...
class Order_SuperdeskShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        $sql       =
            'select o.*, a.realname as addressname,m.realname,u.merchname ' .
            ' from ' . tablename('superdesk_shop_order') . ' o ' . // TODO 标志 楼宇之窗 openid shop_order 已处理
            ' left join ' . tablename('superdesk_shop_member') . ' m on o.openid = m.openid and o.core_user = m.core_user ' .// TODO 标志 楼宇之窗 openid superdesk_shop_member 已处理
