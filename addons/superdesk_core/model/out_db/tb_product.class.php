...
class tb_productModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_product";

    public $table_column_all = "id,province,productName,type,realPrice,carrieroperator,productPrice,upDiscount,discount,creator,createTime,modifier,modifyTime,isEnabled,checkPrice,code";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['province'] = '';// 省份 | YES | varchar(30) | 
    $insert_data['productName'] = '';// 产品名称 | YES | varchar(20) | 
    $insert_data['type'] = '';// 产品类型：0 流量，1 话费 | YES | varchar(40) | 
    $insert_data['realPrice'] = '';// 出售价格(实际卖出价格) | YES | decimal(20,2) | 
    $insert_data['carrieroperator'] = '';// 运营商 | YES | varchar(20) | 
    $insert_data['productPrice'] = '';// 产品价格 | YES | decimal(20,2) | 
    $insert_data['upDiscount'] = '';// 上浮折扣(实际出售折扣) | YES | decimal(20,4) | 
    $insert_data['discount'] = '';// 运营商折扣 | YES | decimal(20,4) | 
    ...
    $insert_data['checkPrice'] = '';// 运营商限价 | YES | decimal(20,4) | 
    $insert_data['code'] = '';// 编码 | YES | varchar(50) | 
