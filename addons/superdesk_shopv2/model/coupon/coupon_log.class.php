...
class coupon_logModel
{

    public $table_name = "superdesk_shop_coupon_log";

    public $table_column_all = "id,uniacid,logno,openid,couponid,status,paystatus,creditstatus,createtime,paytype,getfrom,merchid";
