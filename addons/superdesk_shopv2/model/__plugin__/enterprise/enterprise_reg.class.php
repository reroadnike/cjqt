...
class enterprise_regModel
{

    public $table_name = "superdesk_shop_enterprise_reg";

    public $table_column_all = "id,uniacid,openid,enterprisename,desc,realname,mobile,status,diyformdata,diyformfields,applytime,reason";
    ...
    $insert_data['enterprisename'] = '';//  | YES | varchar(255) | 
