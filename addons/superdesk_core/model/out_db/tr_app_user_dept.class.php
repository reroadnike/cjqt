...
class tr_app_user_deptModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_app_user_dept";

    public $table_column_all = "ID,DEPT_ID,USER_ID";
    ...
    $insert_data['DEPT_ID'] = '';//  | YES | int(11) | 
