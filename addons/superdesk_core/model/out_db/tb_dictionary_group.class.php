...
class tb_dictionary_groupModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_dictionary_group";

    public $table_column_all = "id,groupcode,groupname,isenabled,oprateversion,opratetype,createby,createtime,lastupdateby,lastupdatetime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['groupcode'] = '';//  | NO | varchar(30) | 
    $insert_data['groupname'] = '';//  | NO | varchar(30) | 
