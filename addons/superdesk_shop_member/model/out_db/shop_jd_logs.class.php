...
class shop_jd_logsModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "shop_jd_logs";

    public $table_column_all = "jd_logs_id,jd_logs_event,jd_logs_ctime,jd_logs_sendData,jd_logs_receiveData,jd_logs_url,jd_logs_jdorderid,jd_logs_orderid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['jd_logs_id'] = '';//  | NO | int(11) | 
    $insert_data['jd_logs_event'] = '';// camp-on : 表示预占事件，put-order :确认下单 ，cancle-order:取消订单 | YES | varchar(100) | 
    $insert_data['jd_logs_ctime'] = '';// 操作时间 | YES | datetime | 
    $insert_data['jd_logs_sendData'] = '';// 发送的报文 | YES | varchar(1000) | 
    $insert_data['jd_logs_receiveData'] = '';// 接收到的报文 | YES | varchar(1000) | 
    $insert_data['jd_logs_url'] = '';// 发送的地址 | YES | varchar(1000) | 
    $insert_data['jd_logs_jdorderid'] = '';// 京东订单号 | YES | varchar(100) | 
    $insert_data['jd_logs_orderid'] = '';// 本系统订单号 | YES | varchar(100) | 
