...
class tb_generalbill_serviceModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_generalbill_service";

    public $table_column_all = "ID,billId,serviceName,serviceCode,totalFee,freeFee,payFee,creator,createTime,modifier,modifyTime";
    ...
    $insert_data['serviceName'] = '';// 服务分类名称 | YES | varchar(100) | 
    $insert_data['serviceCode'] = '';// 服务分类编码 | YES | varchar(20) | 
    $insert_data['totalFee'] = '';// 总额 | YES | decimal(11,2) | 
    $insert_data['freeFee'] = '';// 优惠金额 | YES | decimal(11,2) | 
    $insert_data['payFee'] = '';// 应缴金额 | YES | decimal(11,2) | 
