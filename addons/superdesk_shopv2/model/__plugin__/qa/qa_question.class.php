...
class qa_questionModel
{

    public $table_name = "superdesk_shop_qa_question";

    public $table_column_all = "id,uniacid,cate,title,keywords,content,status,isrecommand,displayorder,createtime,lastedittime";
