...
class sns_postModel
{
    ...
    public $table_name = "superdesk_shop_sns_post";

    public $table_column_all = "id,uniacid,bid,pid,rpid,openid,avatar,nickname,title,content,images,voice,createtime,replytime,credit,views,islock,istop,isboardtop,isbest,isboardbest,deleted,deletedtime,checked,checktime,isadmin";
