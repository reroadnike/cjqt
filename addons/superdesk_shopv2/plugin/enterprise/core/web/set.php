...
class Set_SuperdeskShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        if ($_W['ispost']) {
            ...
            m('common')->updatePluginset(array('enterprise' => $data));
            m('cache')->set('template_' . $this->pluginname, $data['style']);
            plog('enterprise.set.edit', '修改基本设置');
            show_json(1, array('url' => webUrl('enterprise/set', array('tab' => str_replace('#tab_', '', $_GPC['tab'])))));
        }
        $styles = array();
