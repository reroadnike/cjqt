...
class tb_template_libraryModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_template_library";

    public $table_column_all = "ID,type,organizationId,templateId,templateContent,createTime,creator";
    ...
    $insert_data['type'] = '';// 关联的类型 | YES | varchar(2) | 
    $insert_data['organizationId'] = '';// 关联的项目 | YES | int(11) | 
    $insert_data['templateId'] = '';// 微信模板ID | YES | varchar(200) | 
    $insert_data['templateContent'] = '';// 模板内容结构 | YES | varchar(400) | 
