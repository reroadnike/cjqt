...
class sll_communityModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_community";

    public $table_column_all = "community_id,community_name,community_code,pcode,community_state";
