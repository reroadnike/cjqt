...
class mc_merchantModel
{

    public $table_name = "superdesk_shop_mc_merchant";

    public $table_column_all = "id,uniacid,merchant_no,username,password,salt,contact_name,contact_mobile,contact_address,type,status,createtime,validitytime,industry,remark";
