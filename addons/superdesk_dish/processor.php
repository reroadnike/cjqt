...
class superdesk_dishModuleProcessor extends WeModuleProcessor
{

    public $name = 'superdesk_dishModuleProcessor';
    ...
    public function respond()
    {
        global $_W;
        $rid = $this->rule;
        $sql = "SELECT * FROM " . tablename('superdesk_dish_reply') . " WHERE `rid`=:rid LIMIT 1";
