...
class exhelper_expressModel
{

    public $table_name = "superdesk_shop_exhelper_express";

    public $table_column_all = "id,uniacid,type,expressname,expresscom,express,width,datas,height,bg,isdefault,merchid";
