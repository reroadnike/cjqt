...
class merch_navModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_nav";

    public $table_column_all = "id,uniacid,navname,icon,url,displayorder,status,merchid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['navname'] = '';// 导航名称 | YES | varchar(255) | 
    $insert_data['icon'] = '';// 图标 | YES | varchar(255) | 
    $insert_data['url'] = '';// 链接地址 | YES | varchar(255) | 
    $insert_data['displayorder'] = '0';// 排序 | YES | int(11) | 0
    $insert_data['status'] = '0';// 状态 | YES | tinyint(3) | 0
