...
class perm_userModel
{

    public $table_name = "superdesk_shop_perm_user";

    public $table_column_all = "id,uniacid,uid,username,password,roleid,status,perms,perms2,deleted,realname,mobile";
