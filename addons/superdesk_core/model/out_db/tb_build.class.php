...
class tb_buildModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_build";

    public $table_column_all = "id,name,organizationId,vip,remark,address,lng,lat,createTime,creator,modifier,modifyTime,isEnabled";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['name'] = '';// 名称 | YES | varchar(20) | 
    $insert_data['organizationId'] = '';// 学校id | YES | int(11) | 
    $insert_data['vip'] = '';// vip标识：0 否，1 是 | YES | varchar(10) | 
    $insert_data['remark'] = '';// 备注信息 | YES | varchar(200) | 
    $insert_data['address'] = '';// 详细地址 | YES | varchar(200) | 
    $insert_data['lng'] = '';// 地图x坐标 | YES | decimal(20,4) | 
    $insert_data['lat'] = '';// 地图Y坐标 | YES | decimal(20,4) | 
