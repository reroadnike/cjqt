...
class sns_boardModel
{

    public $table_name = "superdesk_shop_sns_board";

    public $table_column_all = "id,uniacid,cid,title,logo,desc,displayorder,enabled,showgroups,showlevels,postgroups,postlevels,showagentlevels,postagentlevels,postcredit,replycredit,bestcredit,bestboardcredit,notagent,notagentpost,topcredit,topboardcredit,status,noimage,novoice,needfollow,needpostfollow,share_title,share_icon,share_desc,keyword,isrecommand,banner,needcheck,needcheckmanager,needcheckreply,needcheckreplymanager,showsnslevels,postsnslevels,showpartnerlevels,postpartnerlevels,notpartner,notpartnerpost";
