...
class sll_orders_recordModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_orders_record";

    public $table_column_all = "id,newOrdersCount,untreatedOrdersCount,completedOrdersCount,ordersPriceSum,callCount,transactionAmount,newGoodsCount,storeId,ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['newOrdersCount'] = '';// 新增订单数量 | YES | int(11) | 
    $insert_data['untreatedOrdersCount'] = '';// 未处理订单数量 | YES | int(11) | 
    $insert_data['completedOrdersCount'] = '';// 已完成订单数量（订单状态为3或5的） | YES | int(11) | 
    $insert_data['ordersPriceSum'] = '';// 订单总金额 | YES | float(11,2) | 
    $insert_data['callCount'] = '';// 来电总数 | YES | int(11) | 
    $insert_data['transactionAmount'] = '';// 交易金额 | YES | float(11,2) | 
    $insert_data['newGoodsCount'] = '';// 新增商品数 | YES | int(11) | 
    $insert_data['storeId'] = '';// 水店id | YES | int(11) | 
    $insert_data['ctime'] = '';// 日期 | YES | date | 
