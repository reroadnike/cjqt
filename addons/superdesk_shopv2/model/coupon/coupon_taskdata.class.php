...
class coupon_taskdataModel
{

    public $table_name = "superdesk_shop_coupon_taskdata";

    public $table_column_all = "id,uniacid,openid,taskid,couponid,sendnum,tasktype,orderid,parentorderid,createtime,status,sendpoint";
