...
class List_SuperdeskShopV2Page extends EnterpriseWebPage
{
    protected function orderData($status, $st)
    {
        ...
        $condition     = ' o.uniacid = :uniacid and m.core_enterprise = :core_enterprise and o.deleted=0 and o.isparent=0';
        $uniacid       = $_W['uniacid'];
        $enterprise_id = $_W['enterprise_id'];
        $paras         = $paras1 = array(':uniacid' => $uniacid, ':core_enterprise' => $enterprise_id);
...
//                array('title' => '核销员', 'field' => 'salerinfo', 'width' => 24),//2018年11月1日 11:58:47 zjh 陈康俊 #1801 要求删除
//                array('title' => '核销门店', 'field' => 'storeinfo', 'width' => 36),//2018年11月1日 11:58:47 zjh 陈康俊 #1801 要求删除
//                array('title' => '订单自定义信息', 'field' => 'order_diyformdata', 'width' => 36),//2018年11月1日 11:58:47 zjh 陈康俊 #1801 要求删除
            ...
            foreach ($list as &$r) {
                ...
                foreach ($ogoods as $k => $g) {
                    if (0 < $k) {
                        ...
                        $r['realname'] = '';
                        $r['mobile']   = '';
//                        $r['openid']              = '';//2018年11月1日 11:58:47 zjh 陈康俊 #1801 要求删除
                        $r['nickname']            = '';
                        $r['mrealname']           = '';
                        $r['mmobile']             = '';
                        $r['address']             = '';
                        ...
                        $r['price']               = '';
//                        $r['order_diyformdata']   = '';//2018年11月1日 11:58:47 zjh 陈康俊 #1801 要求删除
                    }
