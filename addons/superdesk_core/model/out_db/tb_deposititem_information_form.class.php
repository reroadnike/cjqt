...
class tb_deposititem_information_formModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_deposititem_information_form";

    public $table_column_all = "id,serviceTypeInfoId,deposName,price,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['serviceTypeInfoId'] = '';// 服务项ID | YES | int(11) | 
    $insert_data['deposName'] = '';// 押金信息名称 | YES | varchar(40) | 
    $insert_data['price'] = '';// 单个金额 | YES | decimal(11,2) | 
