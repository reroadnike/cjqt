...
class provincecityModel
{
    ...
    public $table_name = "superdesk_core_provincecity";

    //    对映:

    // createtime_,updatetime,enabled,
    public $table_column_all =
        "id,type,name,provinceCode,cityCode,description,creator,createTime,modifier,modifyTime,isEnabled,uniacid,";
//      "ID,type,name,provinceCode,cityCode,description,creator,createTime,modifier,modifyTime,isEnabled";
...
//            }
        ...
        $provinceCode = isset($where['provinceCode']) ? $where['provinceCode'] : "" ;
        if (!empty($provinceCode)) {
            $where_sql .= " AND `provinceCode` = :provinceCode";
