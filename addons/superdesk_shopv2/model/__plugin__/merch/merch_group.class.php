...
class merch_groupModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_group";

    public $table_column_all = "id,uniacid,groupname,createtime,status,isdefault,goodschecked,commissionchecked,changepricechecked,finishchecked";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['groupname'] = '';// 商户组名 | YES | varchar(255) | 
    $insert_data['status'] = '0';// 组状态 | YES | tinyint(3) | 0
    $insert_data['isdefault'] = '0';// 是否默认 | YES | tinyint(1) | 0
    $insert_data['goodschecked'] = '0';// 商户添加的商品是否免审核 | YES | tinyint(1) | 0
    $insert_data['commissionchecked'] = '0';// 商户添加的商品是否可以设置商品佣金 | YES | tinyint(1) | 0
    $insert_data['changepricechecked'] = '0';// 商户是否可以修改订单价格 | YES | tinyint(1) | 0
    $insert_data['finishchecked'] = '0';// 商户是否可以在后台点击确认收货 | YES | tinyint(1) | 0
