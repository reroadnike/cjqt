...
class article_sysModel
{

    public $table_name = "superdesk_shop_article_sys";

    public $table_column_all = "uniacid,article_message,article_title,article_image,article_shownum,article_keyword,article_temp,article_source";
