...
class boardroomModel
{
    ...
    public $table_name = "superdesk_boardroom";

    public $table_column_all = "id,name,address,floor,traffic,lat,lng,thumb,basic,carousel,price,equipment,max_num,appointment_num,remark,cancle_rule,createtime,updatetime,deleted,uniacid,";
