...
class t_base_districtModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "t_base_district";

    public $table_column_all = "ID,NAME,ENG_NAME,BRIEF_SPELL,DISTRICT_LEVEL,PARENT_ID,SEQ_NO,CODE,AREA_CODE";
    ...
    $insert_data['NAME'] = '';//  | YES | varchar(40) | 
    $insert_data['ENG_NAME'] = '';//  | YES | varchar(40) | 
    $insert_data['BRIEF_SPELL'] = '';//  | YES | varchar(10) | 
    $insert_data['DISTRICT_LEVEL'] = '';//  | YES | varchar(10) | 
    $insert_data['PARENT_ID'] = '';//  | YES | int(11) | 
    $insert_data['SEQ_NO'] = '';//  | YES | int(11) | 
    $insert_data['CODE'] = '';//  | YES | varchar(100) | 
    $insert_data['AREA_CODE'] = '';//  | YES | varchar(40) | 
