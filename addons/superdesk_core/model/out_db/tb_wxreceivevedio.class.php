...
class tb_wxreceivevedioModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceivevedio";

    public $table_column_all = "ID,developId,openId,createTime,mediaId,thumbMediaId,msgId";
    ...
    $insert_data['mediaId'] = '';// 媒体id | YES | varchar(80) | 
    $insert_data['thumbMediaId'] = '';// 缩略图的媒体id | YES | varchar(80) | 
    $insert_data['msgId'] = '';// 消息id | YES | int(40) | 
