...
class sll_shop_carModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_shop_car";

    public $table_column_all = "car_id,client_goods_id,price,number,total,user_id,fansid,ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['car_id'] = '';//  | NO | int(11) | 
    $insert_data['client_goods_id'] = '';// 水店商品id | YES | int(11) | 
    $insert_data['price'] = '';// 单价 | YES | float(11,2) | 
    $insert_data['number'] = '';// 数量 | YES | int(11) | 
    $insert_data['total'] = '';// 总价 | YES | float(11,2) | 
    $insert_data['user_id'] = '';//  | YES | int(11) | 
    $insert_data['fansid'] = '';//  | YES | int(11) | 
