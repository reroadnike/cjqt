...
class sll_client_goodsModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_client_goods";

    public $table_column_all = "client_goods_id,goods_id,brand_id,classify_id,referprice,trueprice,isHot,status,sort,stock,user_id,ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['client_goods_id'] = '';//  | NO | int(11) | 
    $insert_data['goods_id'] = '';// 商品ID | YES | int(11) | 
    $insert_data['brand_id'] = '';// 品牌ID | YES | int(11) | 
    $insert_data['classify_id'] = '';// 分类id | YES | int(11) | 
    $insert_data['referprice'] = '';// 参考价格 | YES | float(11,2) | 
    $insert_data['trueprice'] = '';// 交易价格 | YES | float(11,2) | 
    $insert_data['isHot'] = '';// 0 : 非热卖 1 : 热卖 | YES | int(11) | 
    $insert_data['status'] = '';// 0:下架，1:上架 400：删除 | YES | int(11) | 
    $insert_data['sort'] = '';// 排序 | YES | int(11) | 
    $insert_data['stock'] = '';// 库存 | YES | int(11) | 
    $insert_data['user_id'] = '';// 用户id | YES | int(11) | 
