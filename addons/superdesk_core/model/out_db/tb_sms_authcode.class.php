...
class tb_sms_authcodeModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_sms_authcode";

    public $table_column_all = "ID,type,code,userMobile,validateTime,createTime,isEnabled";
    ...
    $insert_data['type'] = '';// 验证码类型：1-注册验证 | YES | varchar(2) | 
    $insert_data['code'] = '';// 验证码 | YES | varchar(10) | 
    $insert_data['userMobile'] = '';// 手机号码 | YES | varchar(20) | 
    $insert_data['validateTime'] = '';// 验证时间 | YES | datetime | 
