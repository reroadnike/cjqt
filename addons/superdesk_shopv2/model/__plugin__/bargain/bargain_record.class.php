...
class bargain_recordModel
{

    public $table_name = "superdesk_shop_bargain_record";

    public $table_column_all = "id,actor_id,bargain_price,openid,nickname,head_image,bargain_time";
