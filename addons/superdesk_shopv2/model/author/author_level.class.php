...
class author_levelModel
{

    public $table_name = "superdesk_shop_author_level";

    public $table_column_all = "id,uniacid,levelname,bonus,ordermoney,ordercount,commissionmoney,bonusmoney,downcount,bonus_fg";
