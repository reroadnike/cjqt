...
class Store_SuperdeskShopV2Page extends MerchWebPage
{
    ...
    public function main()
    {
        ...
        foreach ($list as &$row) {
            ...
            $row['salercount'] = pdo_fetchcolumn(
                'select count(*) ' .
    ...
    protected function post()
    {
        ...
        if ($_W['ispost']) {
            ...
            show_json(1, array(
                'url' => merchUrl('shop/verify/store')
            ));
        }
    ...
    public function delete()
    {
        ...
        foreach ($items as $item) {
            pdo_delete('superdesk_shop_merch_store', array('id' => $item['id']));
