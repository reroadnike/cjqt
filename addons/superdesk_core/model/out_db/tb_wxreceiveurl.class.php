...
class tb_wxreceiveurlModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxreceiveurl";

    public $table_column_all = "ID,developId,openId,createTime,title,description,Url,msgId";
    ...
    $insert_data['title'] = '';// 标题 | YES | varchar(45) | 
    $insert_data['description'] = '';// 消息描述 | YES | varchar(128) | 
    $insert_data['Url'] = '';// 消息链接 | YES | varchar(80) | 
