...
class package_goods_optionModel
{

    public $table_name = "superdesk_shop_package_goods_option";

    public $table_column_all = "id,uniacid,goodsid,optionid,pid,title,packageprice,marketprice,commission1,commission2,commission3";
