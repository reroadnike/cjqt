...
class merch_noticeModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_notice";

    public $table_column_all = "id,uniacid,displayorder,title,thumb,link,detail,status,createtime,merchid";
    ...
    $insert_data['thumb'] = '';// 图片 | YES | varchar(255) | 
    $insert_data['link'] = '';// 链接地址 | YES | varchar(255) | 
    $insert_data['detail'] = '';// 详细信息 | YES | text | 
