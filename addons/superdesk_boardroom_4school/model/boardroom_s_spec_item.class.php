...
class boardroom_s_spec_itemModel
{

    public $table_name = "superdesk_boardroom_4school_s_spec_item";

    public $table_column_all = "id,uniacid,specid,title,thumb,show,displayorder,";
