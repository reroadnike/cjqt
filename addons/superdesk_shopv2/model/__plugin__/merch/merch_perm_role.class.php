...
class merch_perm_roleModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_perm_role";

    public $table_column_all = "id,uniacid,merchid,rolename,status,perms,deleted";
    ...
    $insert_data['rolename'] = '';//  | YES | varchar(255) | 
    $insert_data['status'] = '0';//  | YES | tinyint(3) | 0
    $insert_data['perms'] = '';//  | YES | text | 
    $insert_data['deleted'] = '0';//  | YES | tinyint(3) | 0
