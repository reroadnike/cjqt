...
class Create_SuperdeskShopV2Page extends MobileLoginPage
{
...
//            $total                   = count($goods);
    ...
    public function caculatecoupon($couponid, $goodsarr, $totalprice, $discountprice, $isdiscountprice, $isSubmit = 0, $discountprice_array = array(), $merchisdiscountprice = 0)
    {
        ...
        if (is_array($goodsarr)) {
            ...
            $goodsarr = m('goods')->getGoodsCategoryEnterpriseDiscount($goodsarr);
...
//                }
    ...
    public function submit()
    {
        ...
        //2018年11月12日 09:59:55 zjh 原先京东检查所在位置
...
//            show_json(0,$allgoods);
            ...
            if (sizeof($jd_vop_submit_params_sku) > 0) {
                ...
                socket_log(json_encode($jd_vop_submit_params_sku));
                socket_log(json_encode($jd_vop_submit_params_orderPriceSnap));
