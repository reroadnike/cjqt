...
class shop_collectionModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "shop_collection";

    public $table_column_all = "collectionid,goodsid,showPrice,ctime,fansid";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['collectionid'] = '';// id | NO | int(11) | 
    $insert_data['goodsid'] = '';// 商品ID | YES | int(11) | 
    $insert_data['showPrice'] = '';// 展示价格 | YES | float(10,2) | 
    $insert_data['ctime'] = '';// 关注时间 | YES | datetime | 
    $insert_data['fansid'] = '';// 粉丝ID | YES | int(11) | 
