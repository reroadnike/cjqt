...
class tb_provincecityModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_provincecity";

    public $table_column_all = "ID,type,name,provinceCode,cityCode,description,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['type'] = '';// 类型(1-代表省份，2-代表城市) | YES | varchar(2) | 
    $insert_data['name'] = '';// 省份/城市名称 | YES | varchar(200) | 
    $insert_data['provinceCode'] = '';// 省份编码 | YES | varchar(200) | 
    $insert_data['cityCode'] = '';// 城市编码 | YES | varchar(200) | 
    $insert_data['description'] = '';// 名称首字母 | YES | varchar(50) | 
    $insert_data['creator'] = '';// 创建人 | YES | varchar(40) | 
    $insert_data['createTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['modifier'] = '';// 修改人 | YES | varchar(40) | 
