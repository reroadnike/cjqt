...
class commission_applyModel
{

    public $table_name = "superdesk_shop_commission_apply";

    public $table_column_all = "id,uniacid,applyno,mid,type,orderids,commission,commission_pay,content,status,applytime,checktime,paytime,invalidtime,refusetime,realmoney,charge,deductionmoney,beginmoney,endmoney,alipay,bankname,bankcard,realname,repurchase";
