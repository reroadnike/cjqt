...
class goods_commentModel
{

    public $table_name = "superdesk_shop_goods_comment";

    public $table_column_all = "id,uniacid,goodsid,openid,nickname,headimgurl,content,createtime";
