...
class commission_logModel
{

    public $table_name = "superdesk_shop_commission_log";

    public $table_column_all = "id,uniacid,applyid,mid,commission,createtime,commission_pay,realmoney,charge,deductionmoney,type";
