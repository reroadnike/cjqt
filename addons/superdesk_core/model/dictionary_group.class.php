...
class dictionary_groupModel
{

    public $table_name = "superdesk_core_dictionary_group";

    //    对映:/data/wwwroot/default/superdesk/addons/superdesk_core/model/out_db/tb_dictionary_group.class.php
    // createtime_,updatetime,enabled,
    public $table_column_all =
        "id,groupcode,groupname,isenabled,oprateversion,opratetype,createby,createtime,lastupdateby,lastupdatetime,uniacid,";
//      "id,groupcode,groupname,isenabled,oprateversion,opratetype,createby,createtime,lastupdateby,lastupdatetime"
    /**
     * @param $params
     */
