...
class Util_SuperdeskShopV2Page extends WebPage
{
    ...
    public function express()
    {
        ...
        if(empty($express) && !empty($_GPC['id'])){
            $expressid = $_GPC['id'];
            $express = pdo_fetchcolumn(' select express from ' . tablename('superdesk_shop_express') . ' where id=:id',array(':id'=>$expressid));
        }
