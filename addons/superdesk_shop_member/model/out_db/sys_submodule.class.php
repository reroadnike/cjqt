...
class sys_submoduleModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sys_submodule";

    public $table_column_all = "submodule_id,mid,submodule_name,submodule_info,submodule_url,inserttime,stat,orderTag";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['submodule_id'] = '';// 子模块ID | NO | int(9) | 
    $insert_data['mid'] = '';// 模块ID | YES | int(9) | 
    $insert_data['submodule_name'] = '';// 子模块名称 | YES | varchar(100) | 
    $insert_data['submodule_info'] = '';// 子模块描述 | YES | varchar(255) | 
    $insert_data['submodule_url'] = '';// 子模块的连接地址 | YES | varchar(255) | 
    $insert_data['inserttime'] = '';// 子模块创建时间 | YES | datetime | 
    $insert_data['stat'] = '1';// 是否显示子模块；1，显示；0，禁用子模块； | YES | int(2) | 1
    $insert_data['orderTag'] = '0';// 排序I标识 | YES | int(11) | 0
