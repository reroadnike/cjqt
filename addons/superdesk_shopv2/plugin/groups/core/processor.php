...
class GroupsProcessor extends PluginProcessor
{
    public function __construct()
    {
        ...
        $this->sessionkey = SUPERDESK_SHOPV2_PREFIX . 'gorder_wechat_verify_info';
        $this->codekey    = SUPERDESK_SHOPV2_PREFIX . 'gorder_wechat_verify_code';
    }
