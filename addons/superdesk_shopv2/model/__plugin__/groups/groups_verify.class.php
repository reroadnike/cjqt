...
class groups_verifyModel
{

    public $table_name = "superdesk_shop_groups_verify";

    public $table_column_all = "id,uniacid,openid,orderid,verifycode,storeid,verifier,isverify,verifytime";
