...
class Notice_SuperdeskShopV2Page extends PcMobilePage
{
    ...
    public function main()
    {
        ...
        $ice_menu_array = array(array(
            'menu_key'  => 'index',
            'menu_name' => '公告列表',
            'menu_url'  => mobileUrl('pc.shop.notice')
        ));
    ...
    public function detail()
    {
        ...
        $ice_menu_array = array(
            array('menu_key' => 'index', 'menu_name' => '公告列表', 'menu_url' => mobileUrl('pc.shop.notice')),
            array('menu_key' => 'detail', 'menu_name' => '公告详情', 'menu_url' => mobileUrl('pc.shop.notice.detail', array('id' => $id, 'mk' => 'detail')))
        );


        show_json(1, 'notice', 'next', 'pre');
    }
}