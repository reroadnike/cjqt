...
class sll_water_ticket_noModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_water_ticket_no";

    public $table_column_all = "water_ticket_no_id,water_ticket_no_beg,water_ticket_no_end,water_ticket_no_ctime,water_ticket_create_note_pkCode";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['water_ticket_no_id'] = '';// 水票编号ID | NO | int(11) | 
    $insert_data['water_ticket_no_beg'] = '';// 水票编号开始值 | YES | varchar(255) | 
    $insert_data['water_ticket_no_end'] = '';// 水票编号结束值 | YES | varchar(255) | 
    $insert_data['water_ticket_no_ctime'] = '';// 水票编号创建时间 | YES | datetime | 
    $insert_data['water_ticket_create_note_pkCode'] = '';// 水票创建记录主键编码 | YES | varchar(255) | 
