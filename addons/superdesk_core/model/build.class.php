...
class buildModel
{
    ...
    public $table_name = "superdesk_core_build";

//    对映:/data/wwwroot/default/superdesk/addons/superdesk_core/model/out_db/tb_build.class.php

    // 多了三个没用的字 createtime_,updatetime,enabled,
    public $table_column_all =
        "id,name,organizationId,vip,remark,address,lng,lat,createTime,creator,modifier,modifyTime,isEnabled,uniacid,";
//      "id,name,organizationId,vip,remark,address,lng,lat,createTime,creator,modifier,modifyTime,isEnabled";
