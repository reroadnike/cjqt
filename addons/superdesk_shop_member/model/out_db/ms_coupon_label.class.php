...
class ms_coupon_labelModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "ms_coupon_label";

    public $table_column_all = "coupon_label_id,coupon_label_name,coupon_label_number,e_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['coupon_label_id'] = '';//  | NO | int(11) | 
    $insert_data['coupon_label_name'] = '';//  | YES | varchar(255) | 
    $insert_data['coupon_label_number'] = '';//  | YES | int(11) | 
    $insert_data['e_id'] = '';//  | YES | int(22) | 
