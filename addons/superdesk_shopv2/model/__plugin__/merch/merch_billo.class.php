...
class merch_billoModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_billo";

    public $table_column_all = "id,uniacid,billid,orderid,ordermoney";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['billid'] = '0';// 提现申请表ID | NO | int(11) | 0
    $insert_data['orderid'] = '0';// 订单ID | NO | int(11) | 0
    $insert_data['ordermoney'] = '0.00';// 提现金额 | NO | decimal(10,2) | 0.00
