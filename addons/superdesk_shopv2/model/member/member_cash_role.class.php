...
class member_cash_roleModel
{

    public $table_name = "superdesk_shop_member_cash_role";

    public $table_column_all = "id,uniacid,rolename";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['rolename'] = '';//  | YES | varchar(50) | 
