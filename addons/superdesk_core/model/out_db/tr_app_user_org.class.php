...
class tr_app_user_orgModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_app_user_org";

    public $table_column_all = "ID,ORG_ID,ORG_TYPE,USER_ID,REMARK,CREATOR,CREATE_TIME";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['ID'] = '';// 主键 | NO | int(11) | 
    $insert_data['ORG_ID'] = '';// 组织ID | YES | int(11) | 
    $insert_data['ORG_TYPE'] = '';// 组织类型(1-表示小区) | YES | varchar(2) | 
    $insert_data['USER_ID'] = '';// 系统用户ID | YES | int(11) | 
    $insert_data['REMARK'] = '';// 备注 | YES | varchar(20) | 
