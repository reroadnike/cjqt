 ...
 * Time: 5:15 PM
 *
 * http://192.168.1.124/superdesk/web/index.php?c=site&a=entry&m=superdesk_jd_vop&do=api_area_get_city&code=2
...
$province['code'] = $_GPC['code'];


//4.2  获取二级地址
$response_city = $jd_sdk->api_area_get_city($province['code']);
$return_city = $_areaModel->saveOrUpdateByJdVopApiAreaBatch($response_city, $province['code'], 1);

$data = array();
$data['list'] = $return_city;
