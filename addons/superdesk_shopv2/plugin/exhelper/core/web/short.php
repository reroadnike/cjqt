...
class Short_SuperdeskShopV2Page extends PluginWebPage
{
    public function main()
    {
        ...
        $sql =
            'SELECT id,title,shorttitle,status ' .
            ' FROM ' . tablename('superdesk_shop_goods') .
            ' where 1 ' .
            $condition .
            ' ORDER BY  shorttitle desc, status desc, id DESC ' .
    ...
    public function edit()
    {
        ...
        foreach ($goods as $good) {
            ...
            pdo_update('superdesk_shop_goods', array('shorttitle' => $shorttitle), array('id' => $good['id'], 'uniacid' => $_W['uniacid']));
