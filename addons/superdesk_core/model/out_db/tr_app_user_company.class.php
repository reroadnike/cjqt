...
class tr_app_user_companyModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_app_user_company";

    public $table_column_all = "ID,USER_ID,COMP_ID";
    ...
    $insert_data['COMP_ID'] = '';//  | YES | int(11) | 
