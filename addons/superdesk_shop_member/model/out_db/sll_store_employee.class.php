...
class sll_store_employeeModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_store_employee";

    public $table_column_all = "employee_id,employee_name,phone,employee_cardid,cardid_imageUrl1,cardd_imageUrl2,store_imageUrl1,store_imageUrl2,store_imageUrl3,employee_imageUrl,store_id,employee_type,stated,employee_cardimage";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['employee_id'] = '';//  | NO | int(11) | 
    $insert_data['employee_name'] = '';// 姓名 | YES | varchar(255) | 
    $insert_data['phone'] = '';// 电话 | YES | varchar(255) | 
    $insert_data['employee_cardid'] = '';// 身份证 | YES | varchar(255) | 
    $insert_data['cardid_imageUrl1'] = '';// 身份证图片 | YES | varchar(255) | 
    $insert_data['cardd_imageUrl2'] = '';// 身份证图片 | YES | varchar(255) | 
    $insert_data['store_imageUrl1'] = '';// 店面图片 | YES | varchar(255) | 
    $insert_data['store_imageUrl2'] = '';// 店面图片 | YES | varchar(255) | 
    $insert_data['store_imageUrl3'] = '';// 店面图片 | YES | varchar(255) | 
    $insert_data['employee_imageUrl'] = '';// 员工图片 | YES | varchar(255) | 
    $insert_data['store_id'] = '';//  | YES | int(11) | 
    $insert_data['employee_type'] = '';// 1;店主2:员工3:送水工 | YES | varchar(255) | 
    $insert_data['stated'] = '0';// 0:在职1;离职 | YES | int(11) | 0
    $insert_data['employee_cardimage'] = '';//  | YES | varchar(255) | 
