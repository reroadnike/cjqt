define(['core', 'tpl', 'biz/member/cart'],
                ...
                if ($('.diyform-container', modal.container).length > 0) {
                    ...
                    require(['biz/plugin/diyform'],
                        function (diyform) {
                            ...
                            cart.add(modal.goodsid, modal.params.optionid, modal.params.total, diyformdata,
                                function (ret) {
                    ...
                    cart.add(modal.goodsid, modal.params.optionid, modal.params.total, false,
                        function (ret) {
                            FoxUI.toast.show('添加成功');
                            modal.changeCartcount(ret.cartcount);
                        })
