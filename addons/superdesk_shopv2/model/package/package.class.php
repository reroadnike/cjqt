...
class packageModel
{
    ...
    public $table_name = "superdesk_shop_package";

    public $table_column_all = "id,uniacid,title,price,freight,thumb,starttime,endtime,goodsid,cash,share_title,share_icon,share_desc,status,deleted,displayorder";
