        ...
        if ($_W['ispost']) {
            ...
            if (!empty($id)) {
                ...
                if ($id == 'default') {
                    ...
                    pdo_update('superdesk_shop_globonus_level', $data, array('id' => $id, 'uniacid' => $_W['uniacid']));
                ...
                pdo_insert('superdesk_shop_globonus_level', $data);
                $id = pdo_insertid();
