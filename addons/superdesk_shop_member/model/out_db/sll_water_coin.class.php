...
class sll_water_coinModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_water_coin";

    public $table_column_all = "water_coin_id,water_coin_code,water_coin_no,water_coin_pkCode,water_card_create_note_pk_code,water_card_pkCode,water_coin_status,water_coin_ctime,goods_id,user_id,openid,water_coin_usetime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['water_coin_id'] = '';// 水币ID | NO | int(11) | 
    $insert_data['water_coin_code'] = '';// 水币序列码 | YES | varchar(255) | 
    $insert_data['water_coin_no'] = '';// 水币编码 | YES | varchar(255) | 
    $insert_data['water_coin_pkCode'] = '';// 自定义主键标识 | YES | varchar(255) | 
    $insert_data['water_card_create_note_pk_code'] = '';// 水卡创建记录主键编码 | YES | varchar(255) | 
    $insert_data['water_card_pkCode'] = '';// 水卡主键编码 | YES | varchar(255) | 
    $insert_data['water_coin_status'] = '1';// 水币状态0无效1有效 | YES | int(1) | 1
    $insert_data['water_coin_ctime'] = '';// 水币创建时间 | YES | datetime | 
    $insert_data['goods_id'] = '';// 商品ID | YES | int(11) | 
    $insert_data['user_id'] = '';// 市级用户ID | YES | int(11) | 
    $insert_data['openid'] = '';//  | YES | varchar(100) | 
    $insert_data['water_coin_usetime'] = '';// 使用时间 | YES | datetime | 
