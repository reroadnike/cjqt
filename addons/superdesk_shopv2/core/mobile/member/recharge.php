...
class Recharge_SuperdeskShopV2Page extends MobileLoginPage
{
    public function main()
    {
        ...
        if (is_h5app()) {
            $payinfo = array(
                ...
                'mcname' => $sec['app_wechat']['merchname'], 'aliname' => (empty($_W['shopset']['shop']['name']) ? $sec['app_wechat']['merchname'] : $_W['shopset']['shop']['name']),
                'logno'  => NULL,
                'money'  => NULL,
                'attach' => $_W['uniacid'] . ':1',
                'type'   => 1
            ...
            if (!is_error($payquery) || !is_error($payqueryborrow)) {
                ...
                if (empty($log['status'])) {
                    ...
                    m('member')->setCredit($log['openid'], $log['core_user'],
                        'credit2',
                        $log['money'],
                        array(0, $_W['shopset']['shop']['name'] . '会员充值:wechatcomplete:credit2:' . $log['money'])
                    );
