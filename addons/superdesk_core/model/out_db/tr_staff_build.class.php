...
class tr_staff_buildModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_staff_build";

    public $table_column_all = "ID,staffId,buildId";
    ...
    $insert_data['staffId'] = '';// 员工ID | YES | int(11) | 
    $insert_data['buildId'] = '';// 楼栋ID | YES | int(11) | 
