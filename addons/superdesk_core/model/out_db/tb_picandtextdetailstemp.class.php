...
class tb_picandtextdetailstempModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_picandtextdetailstemp";

    public $table_column_all = "PicAndTextDetailsTempId,PicAndTextTempId,ReplyKeywordsId,Title,Description,PicUrl,Url,Sequence";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['PicAndTextDetailsTempId'] = '';//  | NO | int(11) | 
    $insert_data['PicAndTextTempId'] = '';//  | YES | int(11) | 
    $insert_data['ReplyKeywordsId'] = '';// 关键字ID | YES | int(11) | 
    $insert_data['Title'] = '';// 消息标题 | YES | varchar(100) | 
    $insert_data['Description'] = '';// 描述 | YES | varchar(200) | 
    $insert_data['PicUrl'] = '';// 图片URL | YES | varchar(200) | 
    $insert_data['Url'] = '';// 跳转URL | YES | varchar(500) | 
    $insert_data['Sequence'] = '';// 图片顺序 | YES | int(11) | 
