...
class sll_client_baseModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_client_base";

    public $table_column_all = "client_id,client_name,address,x,y,pic,begin_time,end_time,qrcode,user_id";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['client_id'] = '';//  | NO | int(11) | 
    $insert_data['client_name'] = '';// 店铺名称 | YES | varchar(100) | 
    $insert_data['address'] = '';//  | YES | varchar(500) | 
    $insert_data['x'] = '';//  | YES | varchar(50) | 
    $insert_data['y'] = '';//  | YES | varchar(50) | 
    $insert_data['pic'] = '';// 图片 | YES | varchar(500) | 
    $insert_data['begin_time'] = '';// 上班时间 | YES | datetime | 
    $insert_data['end_time'] = '';// 下班时间 | YES | datetime | 
    $insert_data['qrcode'] = '';// 二维码 | YES | varchar(500) | 
