...
class tb_neigouorder_infoModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_neigouorder_info";

    public $table_column_all = "ID,currentmessageid,last_message_id";
    ...
    $insert_data['currentmessageid'] = '';// 当前发送消息ID | YES | int(11) | 
    $insert_data['last_message_id'] = '';// 当前发送消息ID | YES | int(11) | 
