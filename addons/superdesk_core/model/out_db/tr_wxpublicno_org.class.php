...
class tr_wxpublicno_orgModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tr_wxpublicno_org";

    public $table_column_all = "ID,publicNoId,organizationId";
    ...
    $insert_data['publicNoId'] = '';// 公众号ID | YES | int(11) | 
