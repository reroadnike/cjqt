...
class order_refundModel
{

    public $table_name = "superdesk_shop_order_refund";

    public $table_column_all = "id,uniacid,orderid,refundno,price,reason,images,content,createtime,status,reply,refundtype,realprice,refundtime,orderprice,applyprice,imgs,rtype,refundaddress,message,express,expresscom,expresssn,operatetime,sendtime,returntime,rexpress,rexpresscom,rexpresssn,refundaddressid,endtime,merchid";
