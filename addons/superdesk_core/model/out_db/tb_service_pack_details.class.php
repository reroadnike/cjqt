...
class tb_service_pack_detailsModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_service_pack_details";

    public $table_column_all = "ID,typeId,typeCode,name,price,logoPath,orderNo,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['typeId'] = '';// 分类类型ID | YES | int(11) | 
    $insert_data['typeCode'] = '';// 分类类型编码 | YES | varchar(10) | 
    $insert_data['name'] = '';// 商品名称 | YES | varchar(100) | 
    $insert_data['price'] = '0.00';// 价格 | YES | decimal(20,2) | 0.00
    $insert_data['logoPath'] = '';// 图片logo | YES | varchar(200) | 
    $insert_data['orderNo'] = '';// 排序 | YES | int(11) | 
