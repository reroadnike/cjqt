...
class enterprise_perm_logModel
{

    public $table_name = "superdesk_shop_enterprise_perm_log";

    public $table_column_all = "id,uid,uniacid,name,type,op,ip,createtime,enterpriseid";
