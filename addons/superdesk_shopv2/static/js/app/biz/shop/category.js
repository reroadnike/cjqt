    ...
    function(core, tpl) {
        ...
        modal.init = function(cate, cateset) {
            ...
            $("#tab nav").click(function(e) {
                ...
                // console.log("click"+$(this).data("src"));
                        ...
                        $.each(modal.cate.children[pitem.id],
                            function (cindex, citem) {
                                ...
                                if (modal.cate.grandchildren[citem.id] != undefined) {
                                    ...
                                    $.each(modal.cate.grandchildren[citem.id],
                                        function (gindex, gitem) {
