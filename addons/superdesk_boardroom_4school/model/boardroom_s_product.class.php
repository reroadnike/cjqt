...
class boardroom_s_productModel
{

    public $table_name = "superdesk_boardroom_4school_s_product";

    public $table_column_all = "id,goodsid,productsn,title,marketprice,productprice,total,status,spec,";
