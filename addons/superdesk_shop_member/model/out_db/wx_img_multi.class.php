...
class wx_img_multiModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_img_multi";

    public $table_column_all = "id,keywords,imgs,token,keyworduuid,ctime,state";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['keywords'] = '';//  | YES | varchar(100) | 
    $insert_data['imgs'] = '';//  | YES | varchar(100) | 
    $insert_data['token'] = '';//  | YES | char(50) | 
    $insert_data['keyworduuid'] = '';// 关联uuid | YES | varchar(50) | 
    $insert_data['ctime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['state'] = '';//  | YES | int(1) | 
