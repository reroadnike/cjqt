...
class storeModel
{
    ...
    public $table_name = "superdesk_shop_store";

    public $table_column_all = "id,uniacid,storename,address,tel,lat,lng,status,type,realname,mobile,fetchtime,logo,saletime,desc,displayorder,order_printer,order_template,ordertype";
