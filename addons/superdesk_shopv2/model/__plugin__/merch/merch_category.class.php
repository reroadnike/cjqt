...
class merch_categoryModel extends SuperdeskShopv2BaseModel
{

    public $table_name = "superdesk_shop_merch_category";

    public $table_column_all = "id,uniacid,catename,createtime,status,displayorder,thumb,isrecommand";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['catename'] = '';// 商户分类名 | YES | varchar(255) | 
    $insert_data['status'] = '0';// 是否显示 | YES | tinyint(1) | 0
    $insert_data['displayorder'] = '0';// 分类排序 | YES | int(11) | 0
    $insert_data['thumb'] = '';// 分类图片 | YES | varchar(500) | 
    $insert_data['isrecommand'] = '0';// 是否首页推荐 | YES | tinyint(1) | 0
