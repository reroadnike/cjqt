...
class sll_call_recordModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_call_record";

    public $table_column_all = "call_record_id,call_record_mobile,call_record_store_id,call_record_ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['call_record_id'] = '';//  | NO | int(11) | 
    $insert_data['call_record_mobile'] = '';//  | YES | varchar(255) | 
    $insert_data['call_record_store_id'] = '';//  | YES | varchar(255) | 
    $insert_data['call_record_ctime'] = '';//  | YES | datetime | 
