...
class boardroom_s_specModel
{

    public $table_name = "superdesk_boardroom_4school_s_spec";

    public $table_column_all = "id,uniacid,title,description,displaytype,content,goodsid,displayorder,";
