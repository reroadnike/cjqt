...
class wx_invitation_memberModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_invitation_member";

    public $table_column_all = "id,phone,name,remarks,token,visitcode,job,ctime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['phone'] = '';//  | YES | varchar(255) | 
    $insert_data['name'] = '';//  | YES | varchar(255) | 
    $insert_data['remarks'] = '';// 备注 | YES | varchar(255) | 
    $insert_data['token'] = '';//  | YES | varchar(20) | 
    $insert_data['visitcode'] = '';//  | YES | varchar(50) | 
    $insert_data['job'] = '';// 职位 | YES | varchar(100) | 
    $insert_data['ctime'] = '';// 当前时间 | YES | datetime | 
