...
class task_joinModel
{

    public $table_name = "superdesk_shop_task_join";

    public $table_column_all = "join_id,uniacid,join_user,task_id,task_type,needcount,completecount,reward_data,is_reward,failtime,addtime";
