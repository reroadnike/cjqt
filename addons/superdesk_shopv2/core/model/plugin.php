...
class Plugin_SuperdeskShopV2Model
{
    public function exists($pluginName = '')
    {
        $dbplugin = pdo_fetchall(
            'select * ' .
            ' from ' . tablename('superdesk_shop_plugin') .
            ' where ' .
            '       identity=:identyty ' .
            ' limit 1',
            array(
...
//        var_dump($list);
    ...
    public function loadModel($pluginname = '')
    {
        ...
        if (!$_model) {
            ...
            $modelfile = IA_ROOT . '/addons/superdesk_shopv2/plugin/' . $pluginname . '/core/model.php';
