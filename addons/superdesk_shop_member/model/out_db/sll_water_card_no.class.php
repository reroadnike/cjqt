...
class sll_water_card_noModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_water_card_no";

    public $table_column_all = "water_card_no_id,water_card_no_beg,water_card_no_end,water_card_no_ctime,water_card_create_note_pkCode";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['water_card_no_id'] = '';// 水卡编号ID | NO | int(11) | 
    $insert_data['water_card_no_beg'] = '';// 水卡编号开始值 | YES | varchar(255) | 
    $insert_data['water_card_no_end'] = '';// 水卡编号结束值 | YES | varchar(255) | 
    $insert_data['water_card_no_ctime'] = '';// 水卡编号创建时间 | YES | datetime | 
    $insert_data['water_card_create_note_pkCode'] = '';// 水卡创建记录主键编码 | YES | varchar(255) | 
