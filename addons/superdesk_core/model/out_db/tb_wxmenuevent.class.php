...
class tb_wxmenueventModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxmenuevent";

    public $table_column_all = "ID,developId,openId,eventType,createTime,eventKey";
    ...
    $insert_data['eventType'] = '';// 事件类型(CLICK\VIEW) | YES | varchar(20) | 
    $insert_data['createTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['eventKey'] = '';// 事件KEY值 | YES | varchar(600) | 
