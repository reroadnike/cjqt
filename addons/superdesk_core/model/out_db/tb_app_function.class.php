...
class tb_app_functionModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_app_function";

    public $table_column_all = "ID,SYSTEMCODE,FUNCTION_NAME,URL,RIGHT_TYPE,PARENTCODE,TREECODE,LASTUPDATEBY,LASTUPDATETIME,STATUS,ORDER_NUMBER";
    ...
    $insert_data['SYSTEMCODE'] = '';// 系统编码，默认系统为1001 | YES | int(5) | 
    $insert_data['FUNCTION_NAME'] = '';// 功能名称 | YES | varchar(50) | 
    $insert_data['URL'] = '';// URL路径 相对路径，动态配置 | YES | varchar(200) | 
    $insert_data['RIGHT_TYPE'] = '';// 权限标志，0沿用系统权限，1特殊权限 | YES | int(1) | 
    $insert_data['PARENTCODE'] = '';// 分类父，父节点code | YES | varchar(50) | 
    $insert_data['TREECODE'] = '';// 分类子，当前节点code | YES | varchar(50) | 
    $insert_data['LASTUPDATEBY'] = '';// 最后更新人 | YES | int(11) | 
    $insert_data['LASTUPDATETIME'] = '';// 最后更新时间 | YES | date | 
    $insert_data['STATUS'] = '';// 状态 1-启用 0-禁用 | YES | int(1) | 
    $insert_data['ORDER_NUMBER'] = '';//  | YES | int(11) | 
