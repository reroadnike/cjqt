...
class posteraModel
{
    ...
    public $table_name = "superdesk_shop_postera";

    public $table_column_all = "id,uniacid,type,days,title,bg,data,keyword,keyword2,isdefault,resptype,resptext,resptitle,respthumb,createtime,respdesc,respurl,waittext,oktext,subcredit,submoney,reccredit,recmoney,scantext,subtext,beagent,bedown,isopen,opentext,openurl,paytype,subpaycontent,recpaycontent,templateid,entrytext,reccouponid,reccouponnum,subcouponid,subcouponnum,timestart,timeend,status,goodsid,starttext,endtext,testflag,reward_totle";
