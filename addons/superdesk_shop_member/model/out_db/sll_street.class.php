...
class sll_streetModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_street";

    public $table_column_all = "street_id,street_name,pCode,street_code,street_state";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['street_id'] = '';//  | NO | int(50) | 
    $insert_data['street_name'] = '';//  | YES | varchar(255) | 
    $insert_data['pCode'] = '';//  | YES | varchar(255) | 
    $insert_data['street_code'] = '';//  | YES | varchar(255) | 
    $insert_data['street_state'] = '0';// 0:是1:否 | YES | int(11) | 0
