...
class Detail_SuperdeskShopV2Page extends MerchWebPage
{
    private $_orderModel;
...
//            );
        ...
        $goods = pdo_fetchall(
            ...
            //'       and o.merchid=:merchid',      //TODO 因订单转介屏蔽
            array(
                ':orderid' => $id,
                ':uniacid' => $_W['uniacid'],
                //    ':merchid' => $_W['merchid']      //TODO 因订单转介屏蔽
            )
        );
        ...
        //$condition = ' o.uniacid=:uniacid and  o.merchid = :merchid and o.deleted=0';     //无用代码
        //$paras     = array(':uniacid' => $_W['uniacid'], ':merchid' => $_W['merchid']);   //无用代码
        $totals = array();
        $coupon = false;
