...
class Rank_SuperdeskShopV2Page extends WebPage
{
    public function main()
    {
        ...
        if ($_W['ispost']) {
            ...
            $result = pdo_fetchall(
                'SELECT sm.id,sm.uid,m.credit1,sm.nickname,sm.avatar,sm.openid ' .
                ' FROM ' . tablename('superdesk_shop_member') . ' sm ' .
            ...
            $result1 = pdo_fetchall(
                'SELECT ' .
                '       id,uid,credit1,nickname,avatar,openid ' .
