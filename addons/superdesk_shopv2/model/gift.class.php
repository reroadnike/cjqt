...
class giftModel
{
    ...
    public $table_name = "superdesk_shop_gift";

    public $table_column_all = "id,uniacid,title,thumb,activity,orderprice,goodsid,giftgoodsid,starttime,endtime,status,displayorder,share_title,share_icon,share_desc";
