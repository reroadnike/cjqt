...
class wx_custom_menu_classModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "wx_custom_menu_class";

    public $table_column_all = "id,token,pid,title,keyword,url,is_show,sort,wxsys,text,emoji_code";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['token'] = '';//  | YES | varchar(60) | 
    $insert_data['pid'] = '';//  | YES | int(11) | 
    $insert_data['title'] = '';//  | YES | varchar(30) | 
    $insert_data['keyword'] = '';//  | YES | varchar(30) | 
    $insert_data['url'] = '';//  | YES | varchar(300) | 
    $insert_data['is_show'] = '';//  | YES | tinyint(1) | 
    $insert_data['sort'] = '';//  | YES | tinyint(3) | 
    $insert_data['wxsys'] = '';//  | YES | char(40) | 
    $insert_data['text'] = '';//  | YES | varchar(500) | 
    $insert_data['emoji_code'] = '';// 图标码 | YES | varchar(16) | 
