...
class Temp_SuperdeskShopV2Page extends PluginWebPage
{
    ...
    public function setdefault()
    {
        ...
        if (!empty($type) && !empty($id)) {
            ...
            if (!empty($item)) {
                pdo_update('superdesk_shop_exhelper_express', array('isdefault' => 0), array('type' => $type, 'uniacid' => $_W['uniacid'], 'merchid' => 0));
                pdo_update('superdesk_shop_exhelper_express', array('isdefault' => 1), array('id' => $id, 'merchid' => 0));
            }
        }
