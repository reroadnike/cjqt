...
class sale_coupon_dataModel
{

    public $table_name = "superdesk_shop_sale_coupon_data";

    public $table_column_all = "id,uniacid,openid,couponid,gettime,gettype,usedtime,orderid";
