...
class tb_mall_managementModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_mall_management";

    public $table_column_all = "ID,url,urlKey,name,addressCode,organizationId,isEnabled,creator,createTime,modifier,modifyTime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['ID'] = '';// PicAndTextDetailsTempId | NO | int(11) | 
    $insert_data['url'] = '';// 登录url | YES | varchar(300) | 
    $insert_data['urlKey'] = '';// url唯一编号 | YES | varchar(20) | 
    $insert_data['name'] = '';// 名称 | YES | varchar(50) | 
    $insert_data['addressCode'] = '';// 与商城唯一对应的code | YES | varchar(50) | 
    $insert_data['organizationId'] = '';// 项目id | YES | int(11) | 
    $insert_data['isEnabled'] = '';// 是否可用或删除：0 禁用，1 可用 | YES | varchar(2) | 
    $insert_data['creator'] = '';// 创建人 | YES | varchar(45) | 
    $insert_data['createTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['modifier'] = '';// 修改人 | YES | varchar(45) | 
