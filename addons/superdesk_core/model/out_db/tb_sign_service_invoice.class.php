...
class tb_sign_service_invoiceModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_sign_service_invoice";

    public $table_column_all = "ID,organizationId,virtualarchitectureId,type,raise,address,identificationNumber,mobile,bank,bankCard,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    $insert_data['type'] = '';// 发票类型（1-普票、2-专票） | YES | char(1) | 
    $insert_data['raise'] = '';// 发票抬头 | YES | varchar(20) | 
    $insert_data['address'] = '';// 地址 | YES | varchar(200) | 
    $insert_data['identificationNumber'] = '';// 纳税人识别号 | YES | varchar(200) | 
    $insert_data['mobile'] = '';// 电话 | YES | varchar(11) | 
    $insert_data['bank'] = '';// 开户银行 | YES | varchar(100) | 
    $insert_data['bankCard'] = '';// 银行卡号 | YES | varchar(19) | 
