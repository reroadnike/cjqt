...
class tb_sign_basicsModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_sign_basics";

    public $table_column_all = "ID,signid,basicsId,number,totalAmount,createTime,creator,modifyTime,modifier,isEnabled";
    ...
    $insert_data['signid'] = '';// 签约ID | YES | varchar(100) | 
    $insert_data['basicsId'] = '';// 押金项信息ID | YES | int(11) | 
    $insert_data['number'] = '';// 数量 | YES | int(10) | 
    $insert_data['totalAmount'] = '';// 总的金额 | YES | decimal(11,2) | 
    ...
    $insert_data['isEnabled'] = '';//  | YES | varchar(10) | 
