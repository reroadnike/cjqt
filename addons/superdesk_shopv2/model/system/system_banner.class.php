...
class system_bannerModel
{

    public $table_name = "superdesk_shop_system_banner";

    public $table_column_all = "id,title,thumb,url,createtime,displayorder,status,background";
