...
class sign_setModel
{
    ...
    public $table_name = "superdesk_shop_sign_set";

    public $table_column_all = "id,uniacid,iscenter,iscreditshop,keyword,title,thumb,desc,isopen,signold,signold_price,signold_type,textsign,textsignold,textsigned,textsignforget,maincolor,cycle,reward_default_first,reward_default_day,reword_order,reword_sum,reword_special,sign_rule,share";
