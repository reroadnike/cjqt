...
class tb_reserverecordModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_reserverecord";

    public $table_column_all = "ID,telePhone,status,type,remark,createTime,creator,modifyTime,modifier,isEnabled";
    ...
    $insert_data['telePhone'] = '';// 电话号码 | YES | varchar(20) | 
    $insert_data['status'] = '';// 当前状态 | YES | varchar(2) | 
    $insert_data['type'] = '';// 业务类型 | YES | varchar(40) | 
    $insert_data['remark'] = '';// 反馈内容 | YES | varchar(256) | 
    $insert_data['createTime'] = '';// 创建时间 | YES | datetime | 
    $insert_data['creator'] = '';// 创建人 | YES | varchar(50) | 
    $insert_data['modifyTime'] = '';// 修改时间 | YES | datetime | 
    $insert_data['modifier'] = '';// 修改人 | YES | varchar(20) | 
    $insert_data['isEnabled'] = '';// 是否可用 | YES | char(1) | 
