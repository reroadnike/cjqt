...
class sll_store_import_user_noteModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sll_store_import_user_note";

    public $table_column_all = "store_import_user_note_id,store_import_user_note_ctime,store_import_user_note_number,store_import_user_note_status,store_id,store_import_user_note_downurl,store_import_user_note_filename";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['store_import_user_note_id'] = '';// 水店导入用户记录id | NO | int(11) | 
    $insert_data['store_import_user_note_ctime'] = '';// 水店导入用户记录创建时间 | YES | datetime | 
    $insert_data['store_import_user_note_number'] = '';// 操作结果数 | YES | int(11) | 
    $insert_data['store_import_user_note_status'] = '';// 操作结果状态0:失败 1成功 | YES | varchar(255) | 
    $insert_data['store_id'] = '';// 水店id | YES | int(11) | 
    $insert_data['store_import_user_note_downurl'] = '';// 导入数据文件下载地址 | YES | varchar(255) | 
    $insert_data['store_import_user_note_filename'] = '';// 导入数据文件的文件名 | YES | varchar(255) | 
