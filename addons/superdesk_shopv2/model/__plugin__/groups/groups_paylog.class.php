...
class groups_paylogModel
{

    public $table_name = "superdesk_shop_groups_paylog";

    public $table_column_all = "plid,type,uniacid,acid,openid,tid,credit,creditmoney,fee,status,module,tag,is_usecard,card_type,card_id,card_fee,encrypt_code,uniontid";
