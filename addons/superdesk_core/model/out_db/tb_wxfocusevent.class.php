...
class tb_wxfocuseventModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_wxfocusevent";

    public $table_column_all = "ID,developId,openId,eventType,createTime";
    ...
    $insert_data['eventType'] = '';// 事件类型,关注:subscribe，取消关注:unsubscribe | YES | varchar(20) | 
