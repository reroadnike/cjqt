...
class globonus_billpModel
{

    public $table_name = "superdesk_shop_globonus_billp";

    public $table_column_all = "id,uniacid,billid,openid,payno,paytype,bonus,money,realmoney,paymoney,charge,chargemoney,status,reason,paytime";
