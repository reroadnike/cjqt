...
class tb_textpicvoicetempModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_textpicvoicetemp";

    public $table_column_all = "TextPicVoiceTempId,ReplyType,ReplyId,Text,ReplyKeywordsId,CreateTime";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['TextPicVoiceTempId'] = '';//  | NO | int(11) | 
    $insert_data['ReplyType'] = '';// 回复类型1文字，2图片，3语音 | YES | char(1) | 
    $insert_data['ReplyId'] = '';// 回复类型ID 文字为空，图片或语音为媒体ID | YES | varchar(40) | 
    $insert_data['Text'] = '';// 文本消息内容 | YES | varchar(1000) | 
