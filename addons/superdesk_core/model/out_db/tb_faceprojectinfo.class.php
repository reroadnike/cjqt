...
class tb_faceprojectinfoModel extends SuperdeskCoreBaseOutDbModel
{

    public $table_name = "tb_faceprojectinfo";

    public $table_column_all = "id,projectId,type,accountNumber,accountPassword,creator,createTime,modifier,modifyTime,isEnabled";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['projectId'] = '';// 项目或企业ID | YES | int(11) | 
    $insert_data['type'] = '';// 类型(1-项目，2-企业) | YES | varchar(2) | 
    $insert_data['accountNumber'] = '';// 账号 | YES | varchar(40) | 
    $insert_data['accountPassword'] = '';// 密码 | YES | varchar(40) | 
