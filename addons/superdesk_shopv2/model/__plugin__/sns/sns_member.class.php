...
class sns_memberModel
{

    public $table_name = "superdesk_shop_sns_member";

    public $table_column_all = "id,uniacid,openid,level,createtime,credit,sign,isblack,notupgrade";
