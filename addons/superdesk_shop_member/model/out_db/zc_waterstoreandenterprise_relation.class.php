...
class zc_waterstoreandenterprise_relationModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "zc_waterstoreandenterprise_relation";

    public $table_column_all = "w_e_id,w_id,e_id,w_e_ctime,w_e_status";
...
//            $params['createtime'] = strtotime('now');
    ...
    public function saveOrUpdateByJdVop($params, $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
            $insert_data['w_e_id']     = '';//  | NO | int(11) |
            $insert_data['w_id']       = '';// 供销商id | YES | int(11) |
            $insert_data['e_id']       = '';// 企业id | YES | int(11) |
            $insert_data['w_e_ctime']  = '';// 创建时间 | YES | datetime |
            $insert_data['w_e_status'] = '';// 状态（预留字段） | YES | int(11) |
