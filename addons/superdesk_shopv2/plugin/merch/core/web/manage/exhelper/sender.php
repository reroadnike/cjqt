...
class Sender_SuperdeskShopV2Page extends MerchWebPage
{
    ...
    protected function post()
    {
        ...
        if ($_W['ispost']) {
            ...
            $data = array(
                ...
                'sendercity'    => trim($_GPC['sendercity']),
            ...
            if (!empty($id)) {
                ...
                pdo_update(
                    'superdesk_shop_exhelper_senduser',
                    $data,
                    array('id' => $id
                    )
                );
    ...
    public function delete()
    {
        ...
        $items = pdo_fetchall(
            'SELECT id,sendername,sendertel,sendercity,senderaddress ' .
            ' FROM ' . tablename('superdesk_shop_exhelper_senduser') .
            ' WHERE ' .
            '       id in( ' . $id . ' ) ' .
            '       AND uniacid=' . $_W['uniacid'] .
