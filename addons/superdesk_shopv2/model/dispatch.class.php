...
class dispatchModel
{
    ...
    public $table_name = "superdesk_shop_dispatch";

    public $table_column_all = "id,uniacid,dispatchname,dispatchtype,displayorder,firstprice,secondprice,firstweight,secondweight,express,areas,carriers,enabled,calculatetype,firstnum,secondnum,firstnumprice,secondnumprice,isdefault,shopid,merchid,nodispatchareas";
