...
class author_billModel
{

    public $table_name = "superdesk_shop_author_bill";

    public $table_column_all = "id,uniacid,billno,paytype,year,month,week,ordercount,ordermoney,bonusordermoney,bonusrate,bonusmoney,bonusmoney_send,bonusmoney_pay,paytime,partnercount,createtime,status,starttime,endtime,confirmtime";
