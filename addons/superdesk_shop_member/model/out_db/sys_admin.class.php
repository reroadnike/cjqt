...
class sys_adminModel extends SuperdeskShopMemberBaseOutDbModel
{

    public $table_name = "sys_admin";

    public $table_column_all = "admin_id,admin_name,admin_pwd";
    ...
    public function saveOrUpdateByJdVop($params , $sku)
    {
        ...
        if (!$_is_exist) {
            ...
            // TODO
    $insert_data['admin_id'] = '';//  | NO | int(11) | 
    $insert_data['admin_name'] = '';//  | YES | varchar(255) | 
    $insert_data['admin_pwd'] = '';//  | YES | varchar(255) | 
